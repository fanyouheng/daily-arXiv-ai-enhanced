...
### [17] [Luminol-AIDetect: Fast Zero-shot Machine-Generated Text Detection based on Perplexity under Text Shuffling](https://arxiv.org/abs/2604.25860)
...
### [19] [From Chatbots to Confidants: A Cross-Cultural Study of LLM Adoption for Emotional Support](https://arxiv.org/abs/2604.25525)
...
### [21] [MAIC-UI: Making Interactive Courseware with Generative UI](https://arxiv.org/abs/2604.25806)
...
### [22] [FAMA: Failure-Aware Meta-Agentic Framework for Open-Source LLMs in Interactive Tool Use Environments](https://arxiv.org/abs/2604.25135)
...
### [23] [Frictive Policy Optimization for LLMs: Epistemic Intervention, Risk-Sensitive Control, and Reflective Alignment](https://arxiv.org/abs/2604.25136)
...
### [24] [CroSearch-R1: Better Leveraging Cross-lingual Knowledge for Retrieval-Augmented Generation](https://arxiv.org/abs/2604.25182)
...
### [25] [BARRED: Synthetic Training of Custom Policy Guardrails via Asymmetric Debate](https://arxiv.org/abs/2604.25203)
...
### [26] [Below-Chance Blindness: Prompted Underperformance in Small LLMs Produces Positional Bias Rather than Answer Avoidance](https://arxiv.org/abs/2604.25249)
*Jon-Paul Cacioli*
...
### [27] [Learning from Medical Entity Trees: An Entity-Centric Medical Data Engineering Framework for MLLMs](https://arxiv.org/abs/2604.25296)
...
### [28] [LegalMidm: Use-Case-Driven Legal Domain Specialization for Korean Large Language Model](https://arxiv.org/abs/2604.25297)
...
### [29] [Faithfulness-QA: A Counterfactual Entity Substitution Dataset for Training Context-Faithful RAG Models](https://arxiv.org/abs/2604.25313)
...
### [30] [Language corpora for the Dutch medical domain](https://arxiv.org/abs/2604.25374)
*B. van Es*
...
### [31] [Wiki Dumps to Training Corpora: South Slavic Case](https://arxiv.org/abs/2604.25384)
*Mihailo Škorić*
...
### [32] [Benchmarking PyCaret AutoML Against IndoBERT Fine-Tuning for Sentiment Analysis on Indonesian IKN Twitter Data](https://arxiv.org/abs/2604.25392)
...
### [34] [Do LLMs Capture Embodied Cognition and Cultural Variation? Cross-Linguistic Evidence from Demonstratives](https://arxiv.org/abs/2604.25423)
...
### [35] [One Refiner to Unlock Them All: Inference-Time Reasoning Elicitation via Reinforcement Query Refinement](https://arxiv.org/abs/2604.25444)
...
### [36] [Navigating Global AI Regulation: A Multi-Jurisdictional Retrieval-Augmented Generation System](https://arxiv.org/abs/2604.25448)
...
### [37] [Benchmarking Logistic Regression, SVM, and LightGBM Against BiLSTM with Attention for Sentiment Analysis on Indonesian Product Reviews](https://arxiv.org/abs/2604.25452)
...
### [38] [An Investigation of Linguistic Biases in LLM-Based Recommendations](https://arxiv.org/abs/2604.25456)
...
### [52] [Agentic Harness Engineering: Observability-Driven Automatic Evolution of Coding-Agent Harnesses](https://arxiv.org/abs/2604.25850)
...
### [53] [G-Loss: Graph-Guided Fine-Tuning of Language Models](https://arxiv.org/abs/2604.25853)
...
### [58] [From Prototype to Classroom: An Intelligent Tutoring System for Quantum Education](https://arxiv.org/abs/2604.24807)
...
### [59] [Safety Drift After Fine-Tuning: Evidence from High-Stakes Domains](https://arxiv.org/abs/2604.24902)
...
### [60] [Risk Reporting for Developers' Internal AI Model Use](https://arxiv.org/abs/2604.24966)
...
### [61] [Coasting Through Class: Learning Opportunity Loss from Practice Avoidance During Individual Seatwork](https://arxiv.org/abs/2604.25014)
...
### [62] [Barriers and Enablers of Online Instruction in Hospitality Education in the Philippines: An Exploratory Study](https://arxiv.org/abs/2604.25047)
...
### [63] [Adoption of TikTok as a Learning Tool in Physical Education: Evidence from the Philippines](https://arxiv.org/abs/2604.25049)
...
### [64] [Towards the Development of Detection of Learned Helplessness in Mathematics: Design and Data Collection Challenges from a Developing Country Perspective](https://arxiv.org/abs/2604.25054)
...
### [65] [Does This Even Matter in the Real World? Real World Problems in Foundational Theory Courses](https://arxiv.org/abs/2604.25082)
*Anna Kuznetsova*
...
### [66] [A Faceted Proposal for Transparent Attribution of AI-Assisted Text Production](https://arxiv.org/abs/2604.25346)
*Geraldo Xexéo*
...
### [67] [Large language models eroding science understanding: an experimental study](https://arxiv.org/abs/2604.25639)
...
### [68] [Curiosity and Metacognition: Towards a Unified Framework for Learning and Education in the Age of AI](https://arxiv.org/abs/2604.25648)
...
### [69] [Hands-on PDC in Undergraduate Computing Education](https://arxiv.org/abs/2604.25812)
...
### [70] [Three Models of RLHF Annotation: Extension, Evidence, and Authority](https://arxiv.org/abs/2604.25895)
*Steve Coyne*
...
### [71] [Vega-Video: Integrating Video into the Grammar of Graphics](https://arxiv.org/abs/2604.24958)
...
### [72] [What If We Work Together? Fostering Reflections on Designer Inclusion in Open Source Software Through Speculative Design](https://arxiv.org/abs/2604.24981)
...
### [73] ["We Wanted to Do Better Than the Law": Exploring UI/UX Designers' Privacy Advocacy in Practice](https://arxiv.org/abs/2604.24982)
...
### [74] [AFA: Identity-Aware Memory for Preventing Persona Confusion in Multi-User Dialogue](https://arxiv.org/abs/2604.25022)
...
### [75] [Feature Anchors for Time-Series Sensor-Based Human Activity Recognition](https://arxiv.org/abs/2604.25092)
...
### [85] [ClayScape: A GenAI-Supported Workflow for Designing Chinese Style Ceramics with Clay 3D Printing](https://arxiv.org/abs/2604.25657)
...
### [86] [Designing and Evaluating Next-Generation Learning Interfaces: Linking AI, HCI, and the Learning Sciences](https://arxiv.org/abs/2604.25721)
...
### [87] [Lexical Anthropomorphization Influences on Moral Judgments of AI Bad Behavior](https://arxiv.org/abs/2604.25814)
...
### [88] ["The Worst Weather In America": Augmenting the Information Design of Extreme Cold Weather Forecasts](https://arxiv.org/abs/2604.25818)
...
### [89] [Generating Synthetic Citation Networks with Communities](https://arxiv.org/abs/2604.25597)
