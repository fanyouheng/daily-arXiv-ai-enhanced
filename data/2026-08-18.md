...
### [6] [Amplified Does Not Mean Predictive: Reasoning Behaviors in Thinking Models](https://arxiv.org/abs/2608.13760)
...
### [7] [Scaling Creative Writing Beyond Story-Centric Data with Attribute-Guided Genre Expansion](https://arxiv.org/abs/2608.13947)
...
### [8] [The conditional superiority of fast silicon sampling](https://arxiv.org/abs/2608.14079)
...
### [9] [Whose Posts Get Ranked: Identical-Text Exposure Gaps in Bluesky Custom Feeds](https://arxiv.org/abs/2608.13879)
...
### [11] [Asymmetric Discourse Homogenization and Shared Language Technology: Evidence from Reddit](https://arxiv.org/abs/2608.13674)
*Fengming Liu*
...
### [12] [Reading Between The Lines: Modeling and Evaluating Behavioral Realism in Legal Simulation](https://arxiv.org/abs/2608.13712)
...
### [13] [Designing Inclusive Crypto-Asset Dispute Resolution A Hybrid AI and Smart Contract Online Dispute Resolution Framework for Vulnerable Users](https://arxiv.org/abs/2608.14356)
...
### [14] [Proxy-Validated LLM UX Micro-Simulations: An Artifact-First Protocol for Early-Stage Decision Support](https://arxiv.org/abs/2608.13563)
...
### [16] [From Prediction to Intervention: Personalized Meal-Level Glucose Regulation via an LLM Agent](https://arxiv.org/abs/2608.13581)
...
### [17] [UltraArUco: A Lightweight Multilingual Library And Framework With Low-Latency Real-Time Marker-Based Tracking System For Mobile AR Interaction](https://arxiv.org/abs/2608.13584)
...
### [18] [FactorFlow: A Visual Analytics Workspace with Large Language Model-Assisted Interpretation for Factor Analysis](https://arxiv.org/abs/2608.13585)
...
### [20] [DepressionAgent: Reading, Listening, Seeing, and Deliberating Multimodal Evidence for Depression Risk Assessment](https://arxiv.org/abs/2608.13891)
