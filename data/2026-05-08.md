...
### [15] [Decomposing the Basic Abilities of Large Language Models: Mitigating Cross-Task Interference in Multi-Task Instruct-Tuning](https://arxiv.org/abs/2605.05676)
...
### [17] [BioTool: A Comprehensive Tool-Calling Dataset for Enhancing Biomedical Capabilities of Large Language Models](https://arxiv.org/abs/2605.05758)
...
### [18] [Estimating the Black-box LLM Uncertainty with Distribution-Aligned Adversarial Distillation](https://arxiv.org/abs/2605.05777)
...
### [19] [Evaluation Awareness in Language Models Has Limited Effect on Behaviour](https://arxiv.org/abs/2605.05835)
...
### [74] [Predicting civil litigation outcomes and the evolution of case complexity and settlement dynamics](https://arxiv.org/abs/2605.06151)
...
### [75] [Making AI Drafts Count: A Quality Threshold in Audio Description Workflows](https://arxiv.org/abs/2605.05348)
...
### [76] [Designing with Tensions: Older Adults' Emotional Support-Seeking Under System-Level Constraints in Conversational AI](https://arxiv.org/abs/2605.05552)
...
### [77] [UX in the Age of AI: Rethinking Evaluation Metrics Through a Statistical Lens](https://arxiv.org/abs/2605.05600)
*Harish Vijayakumar*
...
### [78] [The Capacity to Care: Designing Social Technology for Sustained Engagement With Societal Challenges](https://arxiv.org/abs/2605.05651)
...
### [79] [PersonaTeaming: Supporting Persona-Driven Red-Teaming for Generative AI](https://arxiv.org/abs/2605.05682)
...
### [80] [GazeMind: A Gaze-Guided LLM Agent for Personalized Cognitive Load Assessment](https://arxiv.org/abs/2605.05790)
...
### [81] [Can providing feedback on gaze and mental-effort synchrony improve pair programming performance?](https://arxiv.org/abs/2605.05836)
...
### [82] [I see artifacts: ICA-based EEG artifact removal does not improve deep network decoding across three BCI tasks](https://arxiv.org/abs/2605.06018)
...
### [83] [EventColumn: Integrating Event Sequences into Tabular Visualizations](https://arxiv.org/abs/2605.06065)
...
### [84] [AffectGPT-RL: Revealing Roles of Reinforcement Learning in Open-Vocabulary Emotion Recognition](https://arxiv.org/abs/2605.06126)
...
### [85] [LearnMate^2: Design and Evaluation of an LLM-powered Personalized and Adaptive Support System for Online Learning](https://arxiv.org/abs/2605.06257)
...
### [86] [LLM-Based Educational Simulation: Evaluating Temporal Student Persona Stability Across ADHD Profiles](https://arxiv.org/abs/2605.06307)
...
### [87] [Human-AI Co-Evolution and Epistemic Collapse: A Dynamical Systems Perspective](https://arxiv.org/abs/2605.06347)
...
### [88] [SIGMA-ASL: Sensor-Integrated Multimodal Dataset for Sign Language Recognition](https://arxiv.org/abs/2605.06351)
...
### [89] [Priming, Path-dependence, and Plasticity: Understanding the molding of user-LLM interaction and its implications from (many) chat logs in the wild](https://arxiv.org/abs/2605.05767)
