...
### [7] [Stan: An LLM-based thermodynamics course assistant](https://arxiv.org/abs/2603.04657)
...
### [9] [Autoscoring Anticlimax: A Meta-analytic Understanding of AI's Short-answer Shortcomings and Wording Weaknesses](https://arxiv.org/abs/2603.04820)
*Michael Hardy*
...
### [21] [Oral to Web: Digitizing 'Zero Resource'Languages of Bangladesh](https://arxiv.org/abs/2603.05272)
...
### [24] [iAgentBench: Benchmarking Sensemaking Capabilities of Information-Seeking Agents on High-Traffic Topics](https://arxiv.org/abs/2603.04656)
...
### [27] [Detection of Illicit Content on Online Marketplaces using Large Language Models](https://arxiv.org/abs/2603.04707)
...
### [28] [AI-Assisted Moot Courts: Simulating Justice-Specific Questioning in Oral Arguments](https://arxiv.org/abs/2603.04718)
...
### [29] [IF-RewardBench: Benchmarking Judge Models for Instruction-Following Evaluation](https://arxiv.org/abs/2603.04738)
...
### [30] [Stacked from One: Multi-Scale Self-Injection for Context Window Extension](https://arxiv.org/abs/2603.04759)
...
### [31] [TSEmbed: Unlocking Task Scaling in Universal Multimodal Embeddings](https://arxiv.org/abs/2603.04772)
...
### [32] [Attention's Gravitational Field:A Power-Law Interpretation of Positional Correlation](https://arxiv.org/abs/2603.04805)
*Edward Zhang*
...
### [33] [Beyond the Context Window: A Cost-Performance Analysis of Fact-Based Memory vs. Long-Context LLMs for Persistent Agents](https://arxiv.org/abs/2603.04814)
...
### [34] [From Unfamiliar to Familiar: Detecting Pre-training Data via Gradient Deviations in Large Language Models](https://arxiv.org/abs/2603.04828)
...
### [35] [SinhaLegal: A Benchmark Corpus for Information Extraction and Analysis in Sinhala Legislative Texts](https://arxiv.org/abs/2603.04854)
...
### [36] [HACHIMI: Scalable and Controllable Student Persona Generation via Orchestrated Agents](https://arxiv.org/abs/2603.04855)
...
### [37] [FireBench: Evaluating Instruction Following in Enterprise and API-Driven LLM Applications](https://arxiv.org/abs/2603.04857)
...
### [38] [Can LLMs Capture Expert Uncertainty? A Comparative Analysis of Value Alignment in Ethnographic Qualitative Research](https://arxiv.org/abs/2603.04897)
...
### [39] [AILS-NTUA at SemEval-2026 Task 10: Agentic LLMs for Psycholinguistic Marker Extraction and Conspiracy Endorsement Detection](https://arxiv.org/abs/2603.04921)
...
### [40] [AILS-NTUA at SemEval-2026 Task 3: Efficient Dimensional Aspect-Based Sentiment Analysis](https://arxiv.org/abs/2603.04933)
...
### [41] [Federated Heterogeneous Language Model Optimization for Hybrid Automatic Speech Recognition](https://arxiv.org/abs/2603.04945)
...
### [42] [LocalSUG: Geography-Aware LLM for Query Suggestion in Local-Life Services](https://arxiv.org/abs/2603.04946)
...
### [43] [Replaying pre-training data improves fine-tuning](https://arxiv.org/abs/2603.04964)
...
### [44] [When Weak LLMs Speak with Confidence, Preference Alignment Gets Stronger](https://arxiv.org/abs/2603.04968)
...
### [45] [MPCEval: A Benchmark for Multi-Party Conversation Generation](https://arxiv.org/abs/2603.04969)
...
### [46] [VRM: Teaching Reward Models to Understand Authentic Human Preferences](https://arxiv.org/abs/2603.04974)
...
### [47] [ThaiSafetyBench: Assessing Language Model Safety in Thai Cultural Contexts](https://arxiv.org/abs/2603.04992)
...
### [48] [HiFlow: Hierarchical Feedback-Driven Optimization for Constrained Long-Form Text Generation](https://arxiv.org/abs/2603.04996)
...
### [49] [NeuronMoE: Neuron-Guided Mixture-of-Experts for Efficient Multilingual LLM Extension](https://arxiv.org/abs/2603.05046)
...
### [50] [MUTEX: Leveraging Multilingual Transformers and Conditional Random Fields for Enhanced Urdu Toxic Span Detection](https://arxiv.org/abs/2603.05057)
...
### [51] [ARC-TGI: Human-Validated Task Generators with Reasoning Chain Templates for ARC-AGI](https://arxiv.org/abs/2603.05099)
...
### [52] [Measuring the Redundancy of Decoder Layers in SpeechLLMs](https://arxiv.org/abs/2603.05121)
...
### [53] [LBM: Hierarchical Large Auto-Bidding Model via Reasoning and Acting](https://arxiv.org/abs/2603.05134)
...
### [54] [Representation Fidelity:Auditing Algorithmic Decisions About Humans Using Self-Descriptions](https://arxiv.org/abs/2603.05136)
...
### [55] [Feature Resemblance: On the Theoretical Understanding of Analogical Reasoning in Transformers](https://arxiv.org/abs/2603.05143)
...
### [56] [C2-Faith: Benchmarking LLM Judges for Causal and Coverage Faithfulness in Chain-of-Thought Reasoning](https://arxiv.org/abs/2603.05167)
...
### [57] [Sparse-BitNet: 1.58-bit LLMs are Naturally Friendly to Semi-Structured Sparsity](https://arxiv.org/abs/2603.05168)
...
### [58] [Guidelines for the Annotation and Visualization of Legal Argumentation Structures in Chinese Judicial Decisions](https://arxiv.org/abs/2603.05171)
...
### [59] [Transducing Language Models](https://arxiv.org/abs/2603.05193)
...
### [60] [Diffusion LLMs can think EoS-by-EoS](https://arxiv.org/abs/2603.05197)
...
### [61] [Distilling Formal Logic into Neural Spaces: A Kernel Alignment Approach for Signal Temporal Logic](https://arxiv.org/abs/2603.05198)
...
### [62] [Balancing Coverage and Draft Latency in Vocabulary Trimming for Faster Speculative Decoding](https://arxiv.org/abs/2603.05210)
*Ofir Ben Shoham*
...
### [63] [VietJobs: A Vietnamese Job Advertisement Dataset](https://arxiv.org/abs/2603.05262)
...
### [76] [Cognitive Warfare: Definition, Framework, and Case Study](https://arxiv.org/abs/2603.05222)
...
### [77] [How Professional Visual Artists are Negotiating Generative AI in the Workplace](https://arxiv.org/abs/2603.04537)
...
### [78] [Beyond the Interface: Redefining UX for Society-in-the-Loop AI Systems](https://arxiv.org/abs/2603.04552)
...
### [79] [Beyond Anthropomorphism: a Spectrum of Interface Metaphors for LLMs](https://arxiv.org/abs/2603.04613)
...
### [80] [Gamified Informed Decision-Making for Performance-Aware Design by Non-Experts: An Exoskeleton Design Case Study](https://arxiv.org/abs/2603.04643)
...
### [81] [VizCrit: Exploring Strategies for Displaying Computational Feedback in a Visual Design Tool](https://arxiv.org/abs/2603.04754)
...
### [82] [Can LLMs Synthesize Court-Ready Statistical Evidence? Evaluating AI-Assisted Sentencing Bias Analysis for California Racial Justice Act Claims](https://arxiv.org/abs/2603.04804)
*Aparna Komarla*
...
### [83] [SparkTales: Facilitating Cross-Language Collaborative Storytelling through Coordinator-AI Collaboration](https://arxiv.org/abs/2603.04806)
...
### [84] [Roomify: Spatially-Grounded Style Transformation for Immersive Virtual Environments](https://arxiv.org/abs/2603.04917)
...
### [85] [Mind the Gap: Mapping Wearer-Bystander Privacy Tensions and Context-Adaptive Pathways for Camera Glasses](https://arxiv.org/abs/2603.04930)
...
### [86] [Beyond Advocacy: A Design Space for Replication-Related Studies](https://arxiv.org/abs/2603.04959)
...
### [87] [Auto-Generating Personas from User Reviews in VR App Stores](https://arxiv.org/abs/2603.04985)
...
### [88] [Haptics in Cognition: Disruptor or Enabler of Memory?](https://arxiv.org/abs/2603.05019)
...
### [89] [Wire Your Way: Hardware-Contextualized Guidance and In-situ Tests for Personalized Circuit Prototyping](https://arxiv.org/abs/2603.05085)
...
### [90] [Not All Trust is the Same: Effects of Decision Workflow and Explanations in Human-AI Decision Making](https://arxiv.org/abs/2603.05229)
...
### [91] [Designing for Adolescent Voice in Health Decisions: Embodied Conversational Agents for HPV Vaccination](https://arxiv.org/abs/2603.05321)
...
### [92] [AttentiveLearn: Personalized Post-Lecture Support for Gaze-Aware Immersive Learning](https://arxiv.org/abs/2603.05324)
...
### [93] [Token Taxes: mitigating AGI's economic risks](https://arxiv.org/abs/2603.04555)
...
### [94] [A Case Study in Responsible AI-Assisted Video Solutions: Multi-Metric Behavioral Insights in a Public Market Setting](https://arxiv.org/abs/2603.04607)
...
### [95] [Analysis of Terms of Service on Social Media Platforms: Consent Challenges and Assessment Metrics](https://arxiv.org/abs/2603.04701)
...
### [96] [Training for Technology: Adoption and Productive Use of Generative AI in Legal Analysis](https://arxiv.org/abs/2603.04982)
...
### [97] [Small Changes, Big Impact: Demographic Bias in LLM-Based Hiring Through Subtle Sociocultural Markers in Anonymised Resumes](https://arxiv.org/abs/2603.05189)
