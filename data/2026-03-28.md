...
### [6] [Navigating the Prompt Space: Improving LLM Classification of Social Science Texts Through Prompt Engineering](https://arxiv.org/abs/2603.25422)
...
### [9] [LogSigma at SemEval-2026 Task 3: Uncertainty-Weighted Multitask Learning for Dimensional Aspect-Based Sentiment Analysis](https://arxiv.org/abs/2603.24896)
...
### [11] [Estimating near-verbatim extraction risk in language models with decoding-constrained beam search](https://arxiv.org/abs/2603.24917)
...
### [12] [Measuring What Matters -- or What's Convenient?: Robustness of LLM-Based Scoring Systems to Construct-Irrelevant Factors](https://arxiv.org/abs/2603.25674)
...
### [13] [Toward domain-specific machine translation and quality estimation systems](https://arxiv.org/abs/2603.24955)
...
### [14] [LLM-Driven Reasoning for Constraint-Aware Feature Selection in Industrial Systems](https://arxiv.org/abs/2603.24979)
...
### [15] [Exons-Detect: Identifying and Amplifying Exonic Tokens via Hidden-State Discrepancy for Robust AI-Generated Text Detection](https://arxiv.org/abs/2603.24981)
...
### [16] [Imperative Interference: Social Register Shapes Instruction Topology in Large Language Models](https://arxiv.org/abs/2603.25015)
*Tony Mason*
...
### [17] [Approaches to Analysing Historical Newspapers Using LLMs](https://arxiv.org/abs/2603.25051)
...
### [22] [To Write or to Automate Linguistic Prompts, That Is the Question](https://arxiv.org/abs/2603.25169)
...
### [23] [Prompt Attack Detection with LLM-as-a-Judge and Mixture-of-Models](https://arxiv.org/abs/2603.25176)
...
### [24] [Cross-Preference Learning for Sentence-Level and Context-Aware Machine Translation](https://arxiv.org/abs/2603.25183)
...
### [25] [Probing the Lack of Stable Internal Beliefs in LLMs](https://arxiv.org/abs/2603.25187)
...
### [26] [A Catalog of Basque Dialectal Resources: Online Collections and Standard-to-Dialectal Adaptations](https://arxiv.org/abs/2603.25189)
...
### [28] [Translation or Recitation? Calibrating Evaluation Scores for Machine Translation of Extremely Low-Resource Languages](https://arxiv.org/abs/2603.25222)
...
### [29] [Comparing Natural and Synthetic Structured Data: A Study of the Passive Verb Alternation in French and Italian](https://arxiv.org/abs/2603.25227)
...
### [30] [MolQuest: A Benchmark for Agentic Evaluation of Abductive Reasoning in Chemical Structure Elucidation](https://arxiv.org/abs/2603.25253)
...
### [31] [CRAFT: Grounded Multi-Agent Coordination Under Partial Information](https://arxiv.org/abs/2603.25268)
...
### [32] [When Hate Meets Facts: LLMs-in-the-Loop for Check-worthiness Detection in Hate Speech](https://arxiv.org/abs/2603.25269)
...
### [33] [Separate Before You Compress: The WWHO Tokenization Architecture](https://arxiv.org/abs/2603.25309)
*Kusal Darshana*
...
### [34] [Beyond Detection: Rethinking Education in the Age of AI-writing](https://arxiv.org/abs/2603.25329)
...
### [35] [Adaptive Chunking: Optimizing Chunking-Method Selection for RAG](https://arxiv.org/abs/2603.25333)
...
### [36] [Large Language Model as Token Compressor and Decompressor](https://arxiv.org/abs/2603.25340)
...
### [37] [TAPO: Translation Augmented Policy Optimization for Multilingual Mathematical Reasoning](https://arxiv.org/abs/2603.25419)
...
### [38] [Translation Asymmetry in LLMs as a Data Augmentation Factor: A Case Study for 6 Romansh Language Varieties](https://arxiv.org/abs/2603.25489)
...
### [39] [An Experimental Comparison of the Most Popular Approaches to Fake News Detection](https://arxiv.org/abs/2603.25501)
...
### [40] [Humans vs Vision-Language Models: A Unified Measure of Narrative Coherence](https://arxiv.org/abs/2603.25537)
...
### [41] [PICon: A Multi-Turn Interrogation Framework for Evaluating Persona Agent Consistency](https://arxiv.org/abs/2603.25620)
...
### [45] [Examining the Effect of Explanations of AI Privacy Redaction in AI-mediated Interactions](https://arxiv.org/abs/2603.24735)
...
### [46] [SABER: Spatial Attention, Brain, Extended Reality](https://arxiv.org/abs/2603.24830)
...
### [47] [Gaze patterns predict preference and confidence in pairwise AI image evaluation](https://arxiv.org/abs/2603.24849)
...
### [48] [Context-Mediated Domain Adaptation in Multi-Agent Sensemaking Systems](https://arxiv.org/abs/2603.24858)
...
### [49] [More Than "Means to an End": Supporting Reasoning with Transparently Designed AI Data Science Processes](https://arxiv.org/abs/2603.24877)
...
### [50] [PII Shield: A Browser-Level Overlay for User-Controlled Personal Identifiable Information (PII) Management in AI Interactions](https://arxiv.org/abs/2603.24895)
...
### [51] [Rethinking Health Agents: From Siloed AI to Collaborative Decision Mediators](https://arxiv.org/abs/2603.24986)
...
### [52] [Co-designing for the Triad: Design Considerations for Collaborative Decision-Making Technologies in Pediatric Chronic Care](https://arxiv.org/abs/2603.24993)
...
### [53] [Framing Data Choices: How Pre-Donation Exploration Design Influence Data Donation Behavior and Decision-Making](https://arxiv.org/abs/2603.24995)
...
### [54] [TopoPilot: Reliable Conversational Workflow Automation for Topological Data Analysis and Visualization](https://arxiv.org/abs/2603.25063)
...
### [55] [Visual or Textual: Effects of Explanation Format and Personal Characteristics on the Perception of Explanations in an Educational Recommender System](https://arxiv.org/abs/2603.25624)
...
### [56] [On-Demand Instructional Material Providing Agent Based on MLLM for Tutoring Support](https://arxiv.org/abs/2603.25195)
...
### [57] [Clinician Perspectives on Type 1 Diabetes Guidelines and Glucose Data Interpretation](https://arxiv.org/abs/2603.25631)
...
### [58] [Beyond Benchmarks: How Users Evaluate AI Chat Assistants](https://arxiv.org/abs/2603.25220)
...
### [59] [Understanding Newcomer Persistence in Social VR: A Case Study of VRChat](https://arxiv.org/abs/2603.25223)
...
### [60] [Does Explanation Correctness Matter? Linking Computational XAI Evaluation to Human Understanding](https://arxiv.org/abs/2603.25251)
...
### [61] [Auditing Algorithmic Personalization in TikTok Comment Sections](https://arxiv.org/abs/2603.25061)
*Yueru Yan,Siqi Wu*
...
### [62] [From Manipulation to Mistrust: Explaining Diverse Micro-Video Misinformation for Robust Debunking in the Wild](https://arxiv.org/abs/2603.25423)
...
### [63] [Group-Differentiated Discourse on Generative AI in High School Education: A Case Study of Reddit Communities](https://arxiv.org/abs/2603.24972)
...
### [64] [Auditing the Impact of Cross-Site Web Tracking on YouTube Political and Misinformation Recommendations](https://arxiv.org/abs/2603.25302)
...
### [65] [Assessing Age Assurance Technologies: Effectiveness, Side-Effects, and Acceptance](https://arxiv.org/abs/2603.25695)
...
### [66] [Online Advertising is a Regrettable Necessity: On the Dangers of Pay-Walling the Web](https://arxiv.org/abs/2409.00026)
*Yonas Kassa*
...
### [67] [Malicious LLM-Based Conversational AI Makes Users Reveal Personal Information](https://arxiv.org/abs/2506.11680)
