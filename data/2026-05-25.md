...
### [15] [Brain-LLM Alignment Tracks Training Data, Not Typology](https://arxiv.org/abs/2605.23032)
...
### [16] [Sparse Autoencoders Map Brain-LLM Alignment onto Cortical Semantic Topography](https://arxiv.org/abs/2605.23035)
*Dongxin Guo,Jikun Wu,Siu Ming Yiu*
...
### [19] [Do Language Models Know What Not to Say? Causal Evidence for Statistical Preemption in LLMs](https://arxiv.org/abs/2605.23039)
*Dongxin Guo,Jikun Wu,Siu Ming Yiu*
...
### [23] [DreamerNLplus: Interpretable Modeling of Mental Health Dynamics from Social Media Timelines using Hybrid Rule-Based and RAG Methods](https://arxiv.org/abs/2605.23052)
...
### [24] [Model Collapse as Cultural Evolution](https://arxiv.org/abs/2605.23054)
*Dongxin Guo,Jikun Wu,Siu Ming Yiu*
...
### [25] [What Training Data Teaches RL Memory Agents: An Empirical Study of Curriculum Effects in Memory-Augmented QA](https://arxiv.org/abs/2605.23067)
...
### [26] [DFKI-MLT at SemEval-2026 TASK 7: Steering Multilingual Models Towards Cultural Knowledge](https://arxiv.org/abs/2605.23069)
...
### [30] [Self-Improving In-Context Learning](https://arxiv.org/abs/2605.23180)
...
### [31] [Hidden Human-Like Nature of Machine-Generated Texts: Theory and Detection Enhancement](https://arxiv.org/abs/2605.23190)
...
### [32] [When Is Next-Token Prediction Useful? Marginalization, Ergodicity, Mixture Identifiability, Local Sufficiency, RAG, Tools, and Programming](https://arxiv.org/abs/2605.23278)
*Francesco Corielli*
...
### [33] [Convergence Without Understanding: When Language Models Agree on Representations but Disagree on Reasoning](https://arxiv.org/abs/2605.23315)
...
### [34] [AraHopeCorpus: Annotation Guidelines and Dataset for Hope Speech in Arabic Social Media Crisis Discourse](https://arxiv.org/abs/2605.23325)
...
### [35] [ClimateChat-300K: A Multi-Modal Facebook Dataset for Understanding Diverse Perspectives in Climate Communication](https://arxiv.org/abs/2605.23326)
...
### [36] [Cultural Adaptation in Large Language Models for Political Discourse](https://arxiv.org/abs/2605.23332)
*Wajdi Zaghouani*
...
### [37] [From Correctness to Preference: A Framework for Personalized Agentic Reinforcement Learning](https://arxiv.org/abs/2605.23382)
...
### [38] [Metacognition as Reward: Reinforcing LLM Reasoning via Knowledge and Regulation Signals](https://arxiv.org/abs/2605.23384)
...
### [39] [EquiSumm : A Gender Bias-Aware Framework for Inclusive Tweet Summarization](https://arxiv.org/abs/2605.23412)
...
### [40] [Articulatory strategy as a source of variation in acoustic vowel dynamics](https://arxiv.org/abs/2605.23416)
...
### [41] [Naturalistic measure of social norms alignment](https://arxiv.org/abs/2605.23420)
...
### [42] [SSDAU: Structured Semantic Data Augmentation for Joint Entity and Relation Extraction](https://arxiv.org/abs/2605.23440)
...
### [43] [ARES: Automated Rubric Synthesis for Scalable LLM Reinforcement Learning](https://arxiv.org/abs/2605.23454)
...
### [49] [OnePred: Next-Query Prediction via Recursive Intent Memory in Multi-Turn Conversations](https://arxiv.org/abs/2605.23668)
...
### [50] [ChartFI: Benchmarking Faithfulness and Insightfulness of Chart Descriptions from Multimodal Large Language Models](https://arxiv.org/abs/2605.23694)
...
### [51] [Metadata Predictability Is Not Evidence Dependence: An Intervention-Based Audit for Weak-Label Benchmarks](https://arxiv.org/abs/2605.23701)
*Kan Shao*
...
### [52] [A graph-based analysis of semantic types and coercion in contextualized word embeddings](https://arxiv.org/abs/2605.23710)
...
### [53] [NLG Evaluation: Past, Present, Future](https://arxiv.org/abs/2605.23715)
*Ehud Reiter*
...
### [54] [Is a Document Educational or Just Wikipedia-Style? -- Pitfalls of Classifier-Based Quality Filtering](https://arxiv.org/abs/2605.23721)
...
### [55] [Hierarchical Concept Geometry in Language Models Emerges from Word Co-occurrence](https://arxiv.org/abs/2605.23821)
...
### [56] [Multilingual Knowledge Transfer under Data Constraints via Lexical Interventions](https://arxiv.org/abs/2605.23885)
...
### [57] [Inferential Privacy Leakage in Anonymized Conversational AI Logs](https://arxiv.org/abs/2605.23820)
...
### [58] [Whose Good, Whose Place? The Moral Geography of Agentic AI for Social Good](https://arxiv.org/abs/2605.22995)
...
### [59] [Opportunities and Risks of Generative AI through the Health Information Journey](https://arxiv.org/abs/2605.23026)
...
### [60] [Defining AI Fatigue in Academic Contexts: Dimensions, Indicators, and a Stage-Based Model Using Grounded Theory](https://arxiv.org/abs/2605.23123)
...
### [61] [SolarChain: Bridging Physical Law, Verifiable Trust, and Sustainable Markets for Urban Energy Resilience](https://arxiv.org/abs/2605.23162)
...
### [62] [Cognitive offloading and the speedup illusion in human-AI interaction](https://arxiv.org/abs/2605.23177)
...
### [63] [IyàwóBench: A Benchmark for Evaluating Large Language Model Clinical Triage Accuracy on Undifferentiated Febrile Illness in Nigerian Primary Health Settings](https://arxiv.org/abs/2605.23465)
...
### [64] [Strategic Stalemates: The Paradox of Export Controls in the U.S.-China AI Race](https://arxiv.org/abs/2605.23475)
...
### [65] [Unjust Enrichment as a Remedy for AI's Unauthorised Use of Protected Data](https://arxiv.org/abs/2605.23503)
...
### [66] [Benchmarking LLMs for Community Governance Simulation with Life-history Narratives](https://arxiv.org/abs/2605.23783)
...
### [67] [Engagement-Optimized Care: When LLMs become Mental Health Infrastructure](https://arxiv.org/abs/2605.23787)
...
### [68] [Divergent Paths to Depolarization: Dialogue Design Determines the Prosocial Benefits of AI-Assisted Political Argumentation](https://arxiv.org/abs/2605.23890)
...
### [69] [StanBKT: Rethinking Parameter Estimation in Bayesian Knowledge Tracing](https://arxiv.org/abs/2605.23048)
...
### [70] [Remind Me To Check The Stove Before I Leave The House: Authoring Personalized Context-Aware Smart Home Reminders Using Everyday Language](https://arxiv.org/abs/2605.23085)
...
### [71] [From Preventive to Reactive: How AI Coding Assistants Transform Developers' Security Awareness](https://arxiv.org/abs/2605.23130)
...
### [72] [CultivAgents: Cultivating Relationship-Centered Multi-Agent Systems for Personalized Gardening](https://arxiv.org/abs/2605.23193)
...
### [73] [Cogniscope: A Synthetic Longitudinal Benchmark and Browser-Based Evaluation Framework for Early-Risk Cognitive AI Systems](https://arxiv.org/abs/2605.23242)
...
### [74] [Socially fluent AI decouples conversational signals from source identity in online interaction](https://arxiv.org/abs/2605.23426)
...
### [75] [MindCopilot: Towards Formalizing and Evaluating Granular Human-LLM Co-Writing](https://arxiv.org/abs/2605.23535)
...
### [76] [Detecting Drunk Driving Using Off-the-Shelf Smartwatches](https://arxiv.org/abs/2605.23663)
...
### [77] [AI at the Front Lines of Platform Governance: Using LLMs to Support Illegal Content Reporting under the Digital Services Act](https://arxiv.org/abs/2605.23676)
...
### [78] [Perceptually Lossless Tactile Texture Synthesis with Compact Spectral Envelope Models](https://arxiv.org/abs/2605.23804)
...
### [79] ["I can't read your mind": A Study of Neurodivergent Computing Students' Experiences with Collaborative Active Learning](https://arxiv.org/abs/2605.23823)
...
### [80] [Human Decision-Making with Persuasive and Narrative LLM Explanations](https://arxiv.org/abs/2605.23867)
