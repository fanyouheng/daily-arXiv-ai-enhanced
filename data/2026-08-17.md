...
### [34] [From Informal Addresses to Reliable Places: Participatory Data Governance of Civic Addressing in Puerto Rico](https://arxiv.org/abs/2605.02924)
*Juan A. Padilla*
...
### [35] [A Two-Validator Web Interface for Structured Geometry Figure Annotation](https://arxiv.org/abs/2608.13569)
...
### [36] [The Architect: Interactive Visualization of Deep Learning Mathematics Directly in Microsoft Excel](https://arxiv.org/abs/2608.13572)
...
### [37] [Interactive Analysis of Global Explanations using Aggregated Class Activation Maps for Network Data](https://arxiv.org/abs/2608.13575)
...
### [38] [BCIJelly: An integrated ecosystem for brain-computer interface research](https://arxiv.org/abs/2608.13576)
...
### [39] [From Prediction to Intervention: Personalized Meal-Level Glucose Regulation via an LLM Agent](https://arxiv.org/abs/2608.13581)
...
### [40] [Regulation, Power, and the Compliance 1 Paradox: A Longitudinal Study of Smart Homes](https://arxiv.org/abs/2608.13582)
...
### [41] [Beyond Simplification: DFT-GEN for Fidelity-Preserving Visual Accessibility in Dyslexia-Friendly Educational Texts](https://arxiv.org/abs/2608.13583)
...
### [42] [The Tool-to-Entity Threshold: Parasocial Dynamics of Personalised AI Agents in Shared Social Spaces](https://arxiv.org/abs/2608.13586)
...
### [43] [UltraArUco: A Lightweight Multilingual Library And Framework With Low-Latency Real-Time Marker-Based Tracking System For Mobile AR Interaction](https://arxiv.org/abs/2608.13584)
...
### [44] [FactorFlow: A Visual Analytics Workspace with Large Language Model-Assisted Interpretation for Factor Analysis](https://arxiv.org/abs/2608.13585)
...
### [45] [Epistemic Tensions: Reframing A Visualization Co-Design through Entanglement Theory](https://arxiv.org/abs/2608.14364)
...
### [46] [Student-ChatGPT Interaction Visible: Designing a Teacher Dashboard for EFL Writing Education](https://arxiv.org/abs/2608.13587)
...
### [47] [Context Aware AI Assistant and AR Interface for Lunar Extravehicular Activity (EVA) Procedural Guidance](https://arxiv.org/abs/2608.13589)
...
### [48] [FabDreamer: Exploring the Image-to-Physical Workflow Through AI-Assisted Layered Fabrication](https://arxiv.org/abs/2608.13665)
...
### [49] [The Capturing and Logging Ecological Virtual Experiences and Reality (CLEVER) - Job Simulator Dataset](https://arxiv.org/abs/2608.13715)
...
### [50] [DepressionAgent: Reading, Listening, Seeing, and Deliberating Multimodal Evidence for Depression Risk Assessment](https://arxiv.org/abs/2608.13891)
...
### [51] [Musical Mirrors: The LLM as Sounding Board in Songwriting](https://arxiv.org/abs/2608.13944)
*Xiao Xiao*
...
### [52] [AppLooper: An Agentic Application Engineering Loop for Accountable Release with Virtual-User Feedback](https://arxiv.org/abs/2608.14093)
...
### [53] [Search or Chat? Comparing How We Learn About Debated Topics](https://arxiv.org/abs/2608.14113)
...
### [54] [Act2Intention: A Benchmark For Developing Active Mobile Agents Through Inferring User Intention from GUI Actions](https://arxiv.org/abs/2608.14132)
...
### [55] [Physics-Bounded mmWave Sensing for Schedulable, Privacy-Preserving Human Pose Estimation](https://arxiv.org/abs/2608.14176)
...
### [56] [Designing Mobile and Wearable Sensor-Fused Conversational Agents for Health and Wellbeing](https://arxiv.org/abs/2608.14273)
...
### [57] [Human and Artificial Intelligence - Promoting Trustworthy and Understandable Collaboration](https://arxiv.org/abs/2608.14291)
*Gilbert Drzyzga*
...
### [58] [From Style Replication to Style Exploration: Enabling Art Style Exploration with Analyze-Experiment-Resituate Framework](https://arxiv.org/abs/2608.14405)
...
### [59] [Visualizing Uncertainty in Non-linear Projections with Ensembles](https://arxiv.org/abs/2608.14513)
...
### [60] [Audience capture, selective exposure, affective assimilation or ideological sorting? Polarisation of climate politics under low media-party parallelism](https://arxiv.org/abs/2608.13864)
...
### [61] [Whose Posts Get Ranked: Identical-Text Exposure Gaps in Bluesky Custom Feeds](https://arxiv.org/abs/2608.13879)
...
### [62] [Spectral Efficiency Centrality: An Efficient Spectral Approach for Influential Node Identification in Temporal Networks](https://arxiv.org/abs/2608.13960)
...
### [63] [RegRole: Regularized Role Detection and Prediction in Temporal Dynamic Networks](https://arxiv.org/abs/2608.14504)
...
### [64] [Asymmetric Discourse Homogenization and Shared Language Technology: Evidence from Reddit](https://arxiv.org/abs/2608.13674)
*Fengming Liu*
...
### [65] [Language-Specific Gaps in AI Safety Training Datasets](https://arxiv.org/abs/2608.13695)
...
### [66] [Reading Between The Lines: Modeling and Evaluating Behavioral Realism in Legal Simulation](https://arxiv.org/abs/2608.13712)
...
### [67] [Meteorology-driven Causal Nowcasting of Fugitive Landfill Emissions Enables Proactive Public Health Response](https://arxiv.org/abs/2608.14254)
...
### [68] [Designing Inclusive Crypto-Asset Dispute Resolution A Hybrid AI and Smart Contract Online Dispute Resolution Framework for Vulnerable Users](https://arxiv.org/abs/2608.14356)
...
### [69] [Whose doctor does the AI recommend? An algorithm audit of reputation and demographic signals in large language model-assisted physician choice](https://arxiv.org/abs/2608.14399)
...
### [70] [Estimating the growth in emissions from AI data centres](https://arxiv.org/abs/2608.14421)
*Wim Vanderbauwhede*
