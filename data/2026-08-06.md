...
### [62] [Reading Between the Frames: Interpreting Implicit and Non-literal Meaning in Social Media Videos](https://arxiv.org/abs/2608.04939)
...
### [63] [Protoreasoning in Tiny Transformers](https://arxiv.org/abs/2608.04980)
...
### [64] [DelusionEval: Measuring Delusion-Linked Behaviors in AI Chatbots](https://arxiv.org/abs/2608.05004)
...
### [73] [Forced Displacement of People Experiencing Homelessness: Housing and Movement Outcomes after Encampment Clearances](https://arxiv.org/abs/2608.04076)
...
### [74] [Link prediction on multi-relational graphs from an influence propagation perspective](https://arxiv.org/abs/2608.05016)
...
### [75] [Towards a New Grammar of Reasoning for Artificial Legal Intelligence and the Mecelle as Its Semantic Protocol](https://arxiv.org/abs/2608.04011)
...
### [76] [AI-driven Multimodal Representation Learning for Latent Mediation Structure Discovery of Socioeconomic Disadvantage, Psychosocial Factors, and Cardiometabolic Multimorbidity: Insights from the All of Us Research Program](https://arxiv.org/abs/2608.04016)
...
### [77] [A Qualitative Comparative Study of Communication in Higher Distance Education](https://arxiv.org/abs/2608.04017)
*Vasileios Mellos,Petros Trantas,Kleanthi Santamouri,Christos Douvlos,Alexandros Gazis,Theodoros Vavouras*
...
### [79] [Hidden Underbelly of the Silicon Valley: Algorithmic Exploitation and Health in Data Work Value Chains](https://arxiv.org/abs/2608.04019)
...
### [81] [Decentralization of Agenda-Setting Power and Domain-Selective Bridging: Algorithm Design Beyond the Echo Chamber Debate](https://arxiv.org/abs/2608.04774)
*Masahiro Fujita*
...
### [82] [Scarcity and Predictive Uncertainty: Implications for Societal Resource Allocation](https://arxiv.org/abs/2608.04251)
...
Abstract: Artificial intelligence is moving the technology sector into domains social work has long served, including crisis response, mental health care, benefits administration, vocational rehabilitation, and child welfare. Social workers meet technology teams as users of their tools, as subjects in their datasets, and as first responders to what those systems deploy, yet they study these systems from outside the settings where the decisions are made. This paper introduces the standard roles on a technology product team and the decisions each one controls, reviews the disciplines around AI-era technology together with the social work scholarship that meets each, and identifies five groups of technology decision roles social workers can hold across the technology industry, human service organizations, and policy institutions, spanning product, governance, organizational technology leadership, grantee collaboration, and policy work. Product management is our primary example. We set the nine competencies of the 2022 Educational Policy and Accreditation Standards against the tasks that role performs to show where MSW training already teaches the method the job asks for. We then specify the technical understanding these roles require, extend the profession's technology ethics from use to deployment, and close with a research agenda for the profession's technology workforce.

</details>


### [84] [Large-Scale Analysis of Discussions by CS Educators Across the Stack Exchange Network](https://arxiv.org/abs/2608.04352)
...
### [85] [Exploring Fraction Comprehension and Interest in Elementary Education Through AI-Powered Personalized Learning](https://arxiv.org/abs/2608.04892)
*Kenneth Holman*
...
### [86] [The Beginning of ChatGPT Ads](https://arxiv.org/abs/2608.05008)
...
### [87] [The Effect of Perceived Race and Gender on Police Language Use: Experimental Evidence from VR Simulations](https://arxiv.org/abs/2608.05050)
...
### [88] [Echoes in the Sky: Computational Thematic Analysis of Online Public Discourse on Bluesky Across Trump's Reelection](https://arxiv.org/abs/2608.04120)
...
### [89] [Enacting Constructive Conflicts with AI Agents to Enhance Reconsideration among Novice Interaction Designers](https://arxiv.org/abs/2608.04166)
...
### [90] [Compass: Continuously Aligning Social Media Feeds via In-Situ Reflections](https://arxiv.org/abs/2608.04274)
...
### [91] [LEGOUI: Designing with UI-DSL Bricks to Balance Transparency and Controllability](https://arxiv.org/abs/2608.04293)
...
### [92] [An immersive micro-manipulation system using real-time 3D imaging microscope and 3D operation interface for high-speed and accurate micro-manipulation](https://arxiv.org/abs/2608.04300)
...
### [93] [IntentLint: Supporting Intent Scaffolding and Prompt-time Linting in Human-AI Collaborative Data Analysis](https://arxiv.org/abs/2608.04331)
...
### [94] [Preference-Driven Online Adaptation for Personalized Interaction Initiation in Proactive AI Assistants](https://arxiv.org/abs/2608.04416)
...
### [95] [Revisiting Channel Effectiveness: A Multi-Dimensional Evaluation with Primitive Visual Stimuli](https://arxiv.org/abs/2608.04435)
...
### [96] [Super-Gaussian: Interactive Scene Editing for 3D Gaussian Splatting and NLI-Based Volume Visualization in Virtual Reality](https://arxiv.org/abs/2608.04475)
...
### [97] [Emotion Dynamics in Social Deception Games: Analysis of Professional and Nonprofessional Players through Electrodermal Activity in Werewolf Games](https://arxiv.org/abs/2608.04605)
...
### [98] [LiverPlan: A Stage-Adaptive Immersive Visual Analytics Framework for Anatomical Liver Surgical Planning](https://arxiv.org/abs/2608.04707)
...
### [99] [Reference-Based Manipulation: A Framework and Pipeline for Multimodal Spatial Reasoning](https://arxiv.org/abs/2608.04798)
...
### [100] [Investigating Click Behaviors On Google Search Result Pages That Produce an AI Overview](https://arxiv.org/abs/2608.04831)
...
### [101] [AutoCue: Multimodal LLM-Assisted Externalization of Implicit Inputs as Instructional Visual Cues in Screencast Tutorials](https://arxiv.org/abs/2608.04910)
...
### [102] [Transition Techniques for Externally-Guided Multi-Scale Viewpoint Changes](https://arxiv.org/abs/2608.04912)
...
### [103] [Reply, Delete, or Ignore? Examining How Content Creators Perceive and Select Comment Moderation Strategies](https://arxiv.org/abs/2608.04951)
...
### [104] [Exploring Cross-Reality Transitions between Projections and Head-Mounted Displays for Immersive Digital Art](https://arxiv.org/abs/2608.04971)
...
### [105] [ArtAnno: Annotating Implicit Semantics in Artworks through LLM Agent-Driven Bidirectional Human-AI Augmentation](https://arxiv.org/abs/2608.05026)
...
### [106] [DeepConnect: A Visual Analytics System for Bridging Interdisciplinary Research Collaborations](https://arxiv.org/abs/2608.05134)
