...
### [3] [Polistemics: Evaluating LLMs as Information Mediators in Politics & Elections](https://arxiv.org/abs/2607.25953)
*Baran Peters*
...
### [27] [Evaluation of forced alignment of code-mixed speech: the case of Hindi-English](https://arxiv.org/abs/2607.25581)
...
### [28] [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology II: Project Planning and Proposal Evaluation](https://arxiv.org/abs/2607.25881)
...
### [29] [PILA: Plug-and-Play Insertion for LLM-native Advertising](https://arxiv.org/abs/2607.25590)
...
### [30] [Construction-Driven Injection: Linguistically-Grounded Edit-Based Code-Mixing Fingerprints for Large Language Models](https://arxiv.org/abs/2607.25633)
...
### [31] [MyMentorLLM: A psychotherapy GenAI environment with multimodal voice/text patients, trainees and experts for deliberate practice](https://arxiv.org/abs/2607.25667)
...
### [32] [SpeechLLM Meets Federated Learning for End-to-End ASR: English and Italian Case Studies](https://arxiv.org/abs/2607.25716)
...
### [33] [WorkSurface-Bench: Benchmarking Enterprise Agents on Multi-Surface Knowledge Routing](https://arxiv.org/abs/2607.25765)
...
### [34] [Evaluation of Adversarial Robustness in Arabic Language Models](https://arxiv.org/abs/2607.25814)
...
### [35] [AngelSpec: Towards Real-World High Performance Inference with Speculative Decoding](https://arxiv.org/abs/2607.25852)
...
### [36] [Shieldstral](https://arxiv.org/abs/2607.25857)
...
### [42] [Resilience: Understand Breakdown, Foster Recovery, and Choose the Right Perspective](https://arxiv.org/abs/2607.25458)
*Frank Schweitzer*
...
### [43] [Game AI Not Fun? A Scoping Review and Meta-Analysis on the Differences in Enjoyment between Human and Computer Opponents](https://arxiv.org/abs/2607.24749)
*Ray Ito*
...
### [44] [Human-Humanoid Collaboration and Ergonomic Risk: An Anthropometric Perspective](https://arxiv.org/abs/2607.24746)
*He Wen*
...
### [45] [Patterns of Learner-AI Interaction and Academic Performance in an Object-Oriented Programming Course](https://arxiv.org/abs/2607.24755)
*Marina Lepp*
...
### [46] [From Idea to Classroom in Days: Using "Vibe Coding" to Create a Programming Process Visualizer from IDE Activity Logs](https://arxiv.org/abs/2607.24757)
...
### [47] [Stop Writing for Me: Generative Refusal in AI Tools for Thought](https://arxiv.org/abs/2607.24751)
*Sora Kang*
...
### [48] [Empathy and the Human-Moment Gaps of AI Chatbots: Insights from Empathy Displacement Theory](https://arxiv.org/abs/2607.24775)
*Victor Frimpong*
...
### [49] [Development and applications of Generative AI in architectural design studios](https://arxiv.org/abs/2607.24752)
...
### [50] [The AI Wave and the Reinvention of Game Discovery: Oversupply, Structural Correction, and Agentic Player-Game Matching](https://arxiv.org/abs/2607.25010)
...
### [51] [Language as a Material Interface for Creative LLM Interaction](https://arxiv.org/abs/2607.24753)
...
### [52] [CARE-MH: Towards Unified, Reproducible, and Comparable Evaluation of Mental Health LLMs](https://arxiv.org/abs/2607.24754)
...
### [53] [What Gets Lost When Memory Becomes Media? Evaluating AI-Generated Oral History Visualization](https://arxiv.org/abs/2607.24756)
...
### [54] [Verification Without Distrust: Reframing User-Side Oversight as Routine Epistemic Governance in Everyday Human-Chatbot Interaction](https://arxiv.org/abs/2607.24761)
*Aung Pyae*
...
### [55] [Extended Reality as a Mediation Layer for Situated Human Control in Human-Robot Teaming](https://arxiv.org/abs/2607.25047)
...
### [56] [ObjectEMS: Electrical Muscle Stimulation Without Electrodes on the User](https://arxiv.org/abs/2607.25084)
...
### [57] [Memdora: Designing Cognitively-Grounded Flashcard Interactions for AI-Powered Spaced Repetition](https://arxiv.org/abs/2607.25096)
*Ruiyang Zhang*
...
### [58] [UrbanTrace: LLM-Assisted Discovery and Semantics-Aware Integration of Spatial Data](https://arxiv.org/abs/2607.25124)
...
### [59] [Beyond the Post Hoc User Study: Modeling Visual Decision-Making with Active Inference](https://arxiv.org/abs/2607.25131)
...
### [60] [TailVis: Expressive Chart Refinement Preserving Data-Binding Integrity](https://arxiv.org/abs/2607.25386)
...
### [61] [Agentic AI Autonomy Assessment: A Decision-Support Framework Towards Governed Supply Chain Systems](https://arxiv.org/abs/2607.25405)
...
### [62] [From Dyad to Triad: Eliciting XAI Requirements in Stroke Rehabilitation](https://arxiv.org/abs/2607.25423)
...
### [63] ["Dragon Slayer Becomes the Dragon": How Players Perceive and Respond to Inequality in the Game World of Whiteout Survival](https://arxiv.org/abs/2607.25574)
...
### [64] [BioDisclose: An Actionability-Aware Benchmark for Biomedical Safety under Adversarial Elicitation](https://arxiv.org/abs/2607.25700)
...
### [65] [AnnoBench: A Benchmark for Visualization Annotation Generation](https://arxiv.org/abs/2607.25911)
...
### [66] [Faster, Higher, Stronger? The Impact of GenAI on Knowledge Work Productivity - Evidence from the Field](https://arxiv.org/abs/2607.25922)
...
### [67] [Who is scientific code for? Maintaining human-readable landmarks in agent-written code](https://arxiv.org/abs/2607.25975)
*Elle O'Brien*
...
### [68] [LLM4OSC: Profile-Bound Natural Language Control with Deterministic Validation for Open Sound Control](https://arxiv.org/abs/2607.26024)
*Yuan-Yi Fan*
...
### [69] [Simulating Single Transferable Voting for the Colorado House of Representatives](https://arxiv.org/abs/2607.25105)
...
### [70] [From Compressing Complexity to Accommodating Complexity: How AI Transforms Standardization and Individualization](https://arxiv.org/abs/2607.25240)
*Li Li,Yu Cao*
...
### [71] [Passive wearable physiology tracks a state-level material-hardship gradient in resting heart rate](https://arxiv.org/abs/2607.25301)
...
### [72] [Estimating the Geopolitical Preferences of Large Language Models from United Nations Voting Data](https://arxiv.org/abs/2607.25526)
*Maxim Chupilkin*
...
### [73] [Why Public Service AI Governance Frameworks Risk Failing in the Age of General-Purpose AI: Lessons from Policing](https://arxiv.org/abs/2607.25648)
