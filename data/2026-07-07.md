...
### [16] [Rating the Pitch, Not the Product: User Evaluations of LLMs Reflect Expectations More Than Performance](https://arxiv.org/abs/2607.05113)
...
### [17] [The Role of Prompt Language and Translation-Theory-Driven Prompts in Large Language Models: A Case Study on Spanish-Chinese Journalistic Translation](https://arxiv.org/abs/2607.03160)
...
### [18] [KARMA: Knowledge graph-based Automated Reasoning Materialization and Alignment](https://arxiv.org/abs/2607.03166)
...
### [19] [S-DiverSe: Spanish Diverse Speech](https://arxiv.org/abs/2607.03207)
...
### [20] [TACG: Trajectory-Aware Commit Gating for Diffusion Language Model Decoding](https://arxiv.org/abs/2607.03236)
...
### [24] [Spectral Signatures of Large Language Models](https://arxiv.org/abs/2607.03377)
...
### [26] [CaresAI at SMM4H-HeaRD 2026: Predicting TNM Staging](https://arxiv.org/abs/2607.03466)
...
### [27] [Learning from Lost Provenance: Multiple Instance Learning for Cancer Registry Tumor Group Classification](https://arxiv.org/abs/2607.03481)
...
### [28] [Lacuna Inc. at SemEval-2026 Task 4: Structurally Gated State-Space Models for Disentangling Narrative Similarity](https://arxiv.org/abs/2607.03482)
...
### [29] [Reading Between the Dots: Decoding Hidden Computation across Filler Tokens](https://arxiv.org/abs/2607.03502)
...
### [30] [Mental Health Disorder Detection Beyond Social Media: A Systematic Review of Available Datasets](https://arxiv.org/abs/2607.03540)
...
### [31] [Transplanting, inverting, and preventing a misalignment persona: method-conditional emergent misalignment in Qwen2.5](https://arxiv.org/abs/2607.04510)
...
### [32] [They Infer What You Meant: Models Represent Communicative Intent More Reliably Than They Act On It](https://arxiv.org/abs/2607.03598)
*Alex Kwon*
...
### [33] [Progressive Disclosure for LLM-Maintained Wiki Knowledge Bases: a Preregistered Ablation](https://arxiv.org/abs/2607.04576)
*Theodore O. Cochran*
...
### [35] [Beyond Independent Labels: Schwartz-Geometry Decoding for Human Value Detection](https://arxiv.org/abs/2607.05052)
...
### [36] [Annotating Korean adnominal ending constructions in corpus data: Beyond relative-clause identification](https://arxiv.org/abs/2607.03681)
...
### [37] [Optimizing Large Language Models for Causality Assessment in Pharmacovigilance: Developing a Performance Metric as Objective for Bayesian Hyperparameter Optimization](https://arxiv.org/abs/2607.03704)
...
### [38] [GRASP: Graph-Reasoning Aided Survey Planning for High-Fidelity Related Work Generation](https://arxiv.org/abs/2607.03709)
...
### [39] [SelfMem: Self-Optimizing Memory for AI Agents](https://arxiv.org/abs/2607.03726)
...
### [40] [ProACT: Towards Breakdown-Aware Proactive Agent in Multi-User Collaboration](https://arxiv.org/abs/2607.03730)
...
### [41] [Beyond Static Rules: Automated Discovery of Latent Vulnerabilities in Text-to-SQL](https://arxiv.org/abs/2607.03833)
...
### [42] [Rethinking Scientific Discovery in an Agentic Era](https://arxiv.org/abs/2607.03863)
...
### [43] [Consistent but Miscalibrated: Evaluating LLM Limitations for Risk Communication in Natural Language](https://arxiv.org/abs/2607.03882)
...
### [44] [Probe, Don't Prompt: A Hidden-State Probe for Metadata Filtering in Multi-Meta-RAG](https://arxiv.org/abs/2607.03929)
...
### [45] [Can Dialects Be Steered Like Languages? Sparse Neurons and Distributed Directions in Arabic LLMs](https://arxiv.org/abs/2607.03936)
...
### [46] [The Remarkable Effectiveness of Providing AI Agents with Natural Language Tools: A Replication Study Validating NLT Performance Across 14 Models](https://arxiv.org/abs/2607.03953)
...
### [47] [NormWorlds-CF: Solver-Verified Counterfactual Normative Reasoning with Metamorphic-Relation GRPO](https://arxiv.org/abs/2607.03957)
*Xinqi Zhang*
...
### [48] [TRACER: Early Failure Detection for Task-Oriented Dialogue](https://arxiv.org/abs/2607.03974)
...
### [49] [BanglaMemeEvidence: A Multimodal Benchmark Dataset for Explanatory Evidence Detection in Bengali Memes](https://arxiv.org/abs/2607.03981)
...
### [50] [Candidate-Constrained Retrieval-Augmented Generation for LongEval-RAG: System Design and Empirical Analysis](https://arxiv.org/abs/2607.04008)
...
### [51] [Separating Representation from Reconstruction Enables Scalable Text Encoders](https://arxiv.org/abs/2607.04011)
...
### [52] [CrossHallu: Do Hallucination Signals Generalize Across Languages and Domains in Large Language Model's Internals?](https://arxiv.org/abs/2607.04029)
...
### [53] [Telescope: Improving Zero Shot Detection of LLM Generated Content By Measuring Token Repetition Probability](https://arxiv.org/abs/2607.04061)
...
### [54] [Speaker-Disentangled Chunk-Wise Regression for Syllabic Tokenization](https://arxiv.org/abs/2607.04064)
...
### [55] [Beyond Multilingual Averages: MTEB-PT, a Benchmark for Portuguese Sentence Encoders](https://arxiv.org/abs/2607.04071)
...
### [56] [Semantic Integration and Lexical Expectation Shape N400 and P600 Dynamics During Naturalistic Reading](https://arxiv.org/abs/2607.04107)
*Kun Sun,Rong Wang*
...
### [57] [Detecting Hallucinations in Retrieval-Augmented Generation through Grounding-Aware Sensitivity by Perturbation (GASP)](https://arxiv.org/abs/2607.04223)
*Mohamed Aly Bouke*
...
### [58] [Spinning Straw into Gold: Relabeling LLM Agent Trajectories in Hindsight for Successful Demonstrations](https://arxiv.org/abs/2607.04235)
...
### [59] [Risk-Constrained Freshness-Aware Semantic Caching for Open-Web Retrieval-Augmented LLMs](https://arxiv.org/abs/2607.04281)
...
### [60] [CausalGame: Benchmarking Causal Thinking of LLM Agents in Games](https://arxiv.org/abs/2607.04293)
...
### [61] [Legible-by-Construction: Attention and End-to-End Transformers](https://arxiv.org/abs/2607.04319)
*Mark Oskin*
...
### [62] [WPG-MoE: Weak-Prior-Guided Dense Mixture-of-Experts for User-Level Social Media Depression Detection](https://arxiv.org/abs/2607.04350)
...
### [63] [Memory-Orchestrated Semantic System (MOSS): An Auditable Agentic Memory Architecture](https://arxiv.org/abs/2607.04391)
...
### [64] [AI Wizards at EXIST 2026: Hierarchical Soft-Label Learning for Multimodal Sexism Identification in Memes](https://arxiv.org/abs/2607.04410)
...
### [65] [UI-MOPD: Multi-Platform On-Policy Distillation for Continual GUI Agent Learning](https://arxiv.org/abs/2607.04425)
...
### [66] [dOPSD: On-Policy Self-Distillation for Diffusion Language Models](https://arxiv.org/abs/2607.04428)
...
### [67] [evalci: A Python Library for Statistically Rigorous Comparison of Language Model Evaluations](https://arxiv.org/abs/2607.04429)
...
### [68] [Uncertainty-Aware Abstention in Large Language Models with Provable Alignment Guarantees](https://arxiv.org/abs/2607.04430)
...
### [69] [Don't Commit Alone: Joint Token Commitment in Diffusion Large Language Models](https://arxiv.org/abs/2607.04469)
*Lin Yao*
...
### [70] [Towards Digital Preservation of Efik: TTS for a Low-Resource African Language](https://arxiv.org/abs/2607.04515)
...
### [71] [Failures and Successes to Learn a Core Conceptual Distinction from the Statistics of Language](https://arxiv.org/abs/2607.04523)
...
### [72] [Language Models Represent and Transform Concepts with Shared Geometry](https://arxiv.org/abs/2607.04525)
...
### [73] [Mechanism-level routing failure in LLMs over Lean-verified algebraic structures](https://arxiv.org/abs/2607.04534)
...
### [74] [EEG-SpikeAgent: Agentic Closed-Loop Program Synthesis for Automated EEG Spike Detection](https://arxiv.org/abs/2607.04558)
...
### [75] [Can temporal article-level credibility signals improve domain-level credibility prediction?](https://arxiv.org/abs/2607.04560)
...
### [76] [Fidelity-Diversity Metrics for Text](https://arxiv.org/abs/2607.04563)
...
### [77] [Characterizing the Temporal, Emotional, and Social Patterns of Adolescent Substance Use Discussions on Reddit](https://arxiv.org/abs/2607.04566)
...
### [78] [MTEB-PT: A Text Embedding Benchmark for Brazilian Portuguese](https://arxiv.org/abs/2607.04581)
...
### [79] [Wrong Before Right: Late Rescue and Interface Failure in Aligned Language Models](https://arxiv.org/abs/2607.04640)
*Jiaqi Deng*
...
### [80] [Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations](https://arxiv.org/abs/2607.04645)
*Samira Hajizadeh*
...
### [81] [FormalRx: Rectify and eXamine Semantic Failures in Autoformalization](https://arxiv.org/abs/2607.04655)
...
### [82] [ToolFailBench: Diagnosing Tool-Use Failures in LLM Agents](https://arxiv.org/abs/2607.04686)
*Harsh Soni*
...
### [83] [PAST-TIDE: Prototype-Anchored Statement Tuning with Topic-Invariant Normalization for Stance Detection](https://arxiv.org/abs/2607.04690)
...
### [84] [What You See Is What You Get: Observation-Aligned Supervision for Chart-to-Code Generation](https://arxiv.org/abs/2607.04726)
...
### [85] [Turning Off-Policy Tokens On-Policy: A Plug-in Approach for Improving LLM Alignment](https://arxiv.org/abs/2607.04728)
...
### [86] [LP-SFT: Local-Preserving Supervised Fine-Tuning via Multimodal Entropy Structure](https://arxiv.org/abs/2607.04733)
...
### [87] [Evaluating the Effect of Linguistic Relatedness on Cross-Lingual Transfer in Large Multilingual Automatic Speech Recognition](https://arxiv.org/abs/2607.04814)
...
### [88] [Semantic Homogenization in Italian Popular Music: A Diachronic Analysis](https://arxiv.org/abs/2607.04832)
...
### [89] [Evaluating Large Language Models for Antisemitic Incident Classification](https://arxiv.org/abs/2607.04890)
...
### [90] [Ossetic-COT: Designing a morphologically annotated corpus and morphological analyzer for Ossetic](https://arxiv.org/abs/2607.04895)
...
### [91] [DuplexChat: Constructing Speaker-Separated Full-Duplex Dialogue Speech at Scale for Spoken Dialogue Language Modeling](https://arxiv.org/abs/2607.04941)
...
### [92] [You Frame It: How Conceptual Representations Shape LLM Detection and Reasoning about Antisemitism](https://arxiv.org/abs/2607.04945)
...
### [93] [Who's Behind It? Annotating and Extracting Conspiratorial Actors from German Telegram Posts](https://arxiv.org/abs/2607.04962)
...
### [94] [The syntax of wh-agreement in Yemeni Ibbi Arabic](https://arxiv.org/abs/2607.04986)
...
### [95] [Knowledge Knows, Verbalization Tells: Disentangling Latent Directions for Mathematical Solvability in LLMs](https://arxiv.org/abs/2607.05013)
...
### [96] [Multi-Large Language Model Orchestrated Severity Assessment of Clinical Records (MOSAIC)](https://arxiv.org/abs/2607.05032)
...
### [108] [Beyond Satisfaction: Learning Associations Between Content, Reviews, and Well-Being](https://arxiv.org/abs/2607.02539)
...
### [109] [Gendered Pixels: Exploring Gender Differences in Computer-Mediated Self-Presentation among Douyu Live Streamers](https://arxiv.org/abs/2607.02760)
...
### [110] [Angry but Accurate: Detecting and Profiling the Counter-Misinformation Ecosystem on Twitter](https://arxiv.org/abs/2607.02900)
...
### [111] [An Exploratory Study of Malicious Link Posting on Social Media Applications](https://arxiv.org/abs/2607.04042)
...
### [112] [Dynamic Interest Rate Discovery in Decentralized Finance: A Reverse Kelly Automated Market Maker for Risk-Adjusted Lending](https://arxiv.org/abs/2607.04178)
...
### [113] [The Politics Attention Makes: Platform Media Logic and the Mediatization of Politics](https://arxiv.org/abs/2607.04220)
*Petter Törnberg*
...
### [114] [Finfluencers on TikTok: A Longitudinal Analysis of Content, Engagement, and Disclaimer Practices](https://arxiv.org/abs/2607.05203)
...
### [115] [Doom Researching: A Conceptual Framework for Repetitive AI-Assisted Information Seeking, Cognitive Offloading, and the Illusion of Knowing](https://arxiv.org/abs/2607.02723)
...
### [116] [A Comparative Study of Static, Scrollytelling, and Chatbot Visualization Onboarding Techniques for UX Designers](https://arxiv.org/abs/2607.03023)
...
### [117] [Regulating AI: Where U.S. State Policy and HCI (Mis)align](https://arxiv.org/abs/2607.03292)
...
### [118] [Evaluating Affective Objectives: Statistical Numbing in Data Visualization](https://arxiv.org/abs/2607.03445)
...
### [119] [Between Knowledge and Care: A Mixed-Methods Evaluation of Generative AI for T2DM Self-Management from Patient and Physician Perspectives](https://arxiv.org/abs/2607.03720)
...
### [120] [CoGen3D: An Agentic Human-AI Co-Design Pipeline for 3D Asset Generation for Virtual Reality](https://arxiv.org/abs/2607.03731)
...
### [121] [Enactive Drift Regulation and the Emergence Machine: A Framework for Coherent Adaptation Through Regulated Interaction](https://arxiv.org/abs/2607.03834)
*Nicholas Davis*
...
### [122] [Post-Lecture Interactive Environments for Conceptual Learning: A Randomized Comparison of Mixed Reality and Tangible Instruction in Undergraduate STEM Education](https://arxiv.org/abs/2607.03896)
...
### [123] [Scalable Semantic Steering of Embedding Projections](https://arxiv.org/abs/2607.03978)
...
### [124] [The New Shape of Search: How Conversational AI Recomposes Information Seeking](https://arxiv.org/abs/2607.04282)
...
### [125] [The ABC of digital health: A framework for translating digital health interventions into real-world applications](https://arxiv.org/abs/2607.04381)
...
### [126] [From Interaction to Intent: Inferring User Objectives from Provenance Logs](https://arxiv.org/abs/2607.04501)
...
### [127] [The User-In-Context Framework: Understanding Variation in How Users Respond to AI Chatbots](https://arxiv.org/abs/2607.04547)
...
### [128] [Identifying Deceptive Patterns Across Three Age Groups: A Heuristic-Based Cognitive Walkthrough Study of Mobile Apps](https://arxiv.org/abs/2607.04573)
...
### [129] [Who Responds When the Driver Is Gone? A Framework for Human Intent Understanding](https://arxiv.org/abs/2607.04670)
...
### [130] [Toward Personalized Social Robots for Child Well-being: Data Requirement Principles from a Recommender-System Perspective](https://arxiv.org/abs/2607.05110)
...
### [131] [AutoResearch: An Execution-Grounded Multi-Agent Framework for Reliable Research Workflow Automation](https://arxiv.org/abs/2607.02520)
...
### [132] [Cybercrime Victimization Among Young Adult Males Aged 18--20: A Post-Pandemic Analysis of Converging Risk Factors](https://arxiv.org/abs/2607.02530)
*Anveeksh Mahesh Rao*
...
### [133] [The Hidden Water Geography of U.S. Hyperscale Data Centers in the AI Era](https://arxiv.org/abs/2607.02531)
...
### [134] [The Foreign Policy AI Evaluation Gap](https://arxiv.org/abs/2607.02955)
...
### [135] [A Scalable Approach to Evaluating Moral Sensitivity in LLMs](https://arxiv.org/abs/2607.02972)
...
### [136] [Analyzing the Difficulty of Programming Assignments with Interpretable Knowledge Component Metrics](https://arxiv.org/abs/2607.03419)
...
### [137] [AI Systems as Digital Public Goods -- Evidence and Recommendations from a Multi-Stakeholder Assessment](https://arxiv.org/abs/2607.03427)
...
Abstract: AI systems are increasingly being positioned as potential Digital Public Goods (DPGs) to accelerate progress towards the Sustainable Development Goals (SDGs). Yet, despite major global commitments, most notably the Global Digital Compact's call to "develop, disseminate and maintain safe and secure open-source software, open data, open artificial intelligence models and open standards that benefit society as a whole", very few AI systems currently meet the DPG Standard in practice. This report explains why, and what must change for "AI as Digital Public Goods" (AIDPGs) to become a credible, implementable pathway rather than an aspirational label.
  Commissioned by the Asian Development Bank (ADB) and produced by United Nations University (UNU) in partnership with UN Office of Digital and Emergent Technologies (UN ODET), this assessment combines: (i) a structured desk review of policy, legal, and technical frameworks on DPGs, openness, and AI governance; (ii) key informant interviews with cross sector experts spanning the UN system, governments, civil society, academia, and the private sector; and (iii) a global survey to test whether interview themes hold across a broader sample and to surface where perspectives diverge by region, sector, and AI readiness.

</details>


### [138] [Macro-Prudential AI Governance: A Two-Layer Early Warning and Response System for Frontier AI](https://arxiv.org/abs/2607.03542)
*Pranav Mehta*
...
### [139] [Development of a Bio-Inspired Routing Algorithm According to Values of Solidarity and a Freirean Perspective of Engineering](https://arxiv.org/abs/2607.03607)
*Gustavo N. Gonçalves,Cristiano C. Cruz,Romis Attux*
...
### [141] [The Case for Globally Beneficial Technology](https://arxiv.org/abs/2607.03906)
...
### [143] [Government AI Use as a Monitoring Primitive: A Public Document Pilot Study](https://arxiv.org/abs/2607.04543)
...
### [145] [Psychological features of dispute content and public acceptance of AI in legal adjudication: evidence for systematic variation beyond individual differences](https://arxiv.org/abs/2607.04838)
...
### [146] [Understanding Student Perceptions, Mistakes, and Debugging Approaches when Solving Natural Language Programming Tasks](https://arxiv.org/abs/2607.05034)
...
### [148] [Open Problems in AI Incident Governance](https://arxiv.org/abs/2607.05163)
...
### [149] [Curated retrieval versus open web search in public AI information services: a coverage-trust trade-off](https://arxiv.org/abs/2607.05217)
