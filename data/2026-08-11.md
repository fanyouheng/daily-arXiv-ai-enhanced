...
### [7] [Build it, Break it, Repeat: Benchmarking and improving LLM-manipulated disinformation detection in social media posts](https://arxiv.org/abs/2608.09510)
...
### [22] [Wisdom in Unity: The Role of Multilingual Training in Figurative Language Identification in Proverbs](https://arxiv.org/abs/2608.08090)
...
### [30] [Measuring the Tokenization Premium: A Cost Audit for Underserved Language Communities](https://arxiv.org/abs/2608.09046)
...
### [32] [ELBench: A Multi-Dimensional Benchmark for Education-Facing Large Language Models](https://arxiv.org/abs/2608.09548)
...
### [34] [How Do Large Language Models Judge Social Attraction? Evidence from Theory-Grounded Persona Ratings Across Multiple LLMs and Humans](https://arxiv.org/abs/2608.09717)
...
### [35] [Hidden Language Consistency Phenomena in Reasoning LLMs](https://arxiv.org/abs/2608.08447)
...
### [36] [Calling the Bluff: Detecting Ever-Shifting Harmful Chat Dialogue via Ordered Reasoning Chain Regularization](https://arxiv.org/abs/2608.08451)
...
### [37] [Beyond Tables: Doc2DB-Bench for Relationally Faithful Document-to-Database Construction](https://arxiv.org/abs/2608.08459)
...
### [38] [VectraYX-Vision-1B: A Sub-2B Spanish/LATAM Cybersecurity Vision-Language Model with Structured Visual Reasoning and Native Tool Use](https://arxiv.org/abs/2608.08477)
*Juan S. Santillana*
...
### [39] [From Speech to Interaction: Analyzing Multimodal Systems in Cocktail-Party Scenarios](https://arxiv.org/abs/2608.08510)
...
### [40] [OpenVisTool: An Open Recipe for Synthesizing Instructive Visual Tool-Use Trajectories](https://arxiv.org/abs/2608.08557)
...
### [41] [Mitigating Gender Bias in English to Romanian Machine Translation](https://arxiv.org/abs/2608.08606)
...
### [42] [North Africa's Missing Framework: NLP-Driven Mental Healthcare in Algeria and Implications for Low-resource Settings](https://arxiv.org/abs/2608.08607)
...
### [43] [Enhancing Scientific Named Entity Recognition via Large Language Models: A Type-driven Multi-task Learning Approach](https://arxiv.org/abs/2608.08636)
...
### [44] [The Evolution of Mixture-of-Experts Architectures in Large Language Models: Routing, Topology, Load Balancing, and Expert Parallelism](https://arxiv.org/abs/2608.08650)
*Jiguo Li*
...
### [45] [LibraSpec: Dynamic Diffusion-Based Speculative Decoding via Marginal-Gain-Driven Optimization](https://arxiv.org/abs/2608.08721)
...
### [46] [Can We Optimize the Performance-Carbon Emission Break-Even Point?: The Quest for Greener LLMs](https://arxiv.org/abs/2608.08744)
...
### [47] [Multilingual Emotion Neurons in Large Audio-Language Models](https://arxiv.org/abs/2608.08772)
...
### [48] [OmnilingualGAIA2: Evaluating the Multilingual Gap in Frontier AI Agents](https://arxiv.org/abs/2608.08775)
...
### [49] [Unsure but Certain: Uncovering the Representation-Confidence Gap in Diffusion Language Models](https://arxiv.org/abs/2608.08791)
...
### [50] [Evidence-Calibrated Runtime Reconstruction for Agent Skills Across Heterogeneous Coding Agents](https://arxiv.org/abs/2608.08793)
*Xueping Gao*
...
### [51] [Instability of LLM Pre-Pretraining: It Doesn't Always Help. An Investigation on Multiple Languages](https://arxiv.org/abs/2608.08800)
...
### [52] [IDRAAK: From Multi-Agent NLP to Few-Shot Prompting for Semantic Drift Detection in Technical Requirements](https://arxiv.org/abs/2608.08801)
*Shiva Ahir*
...
### [53] [Tevatron-Elastic: A Unified Abstraction for Training Elastic Retrievers and Rerankers](https://arxiv.org/abs/2608.08809)
...
### [54] [Deployable Per-Instance Multi-Layer Activation Steering for Large Language Models](https://arxiv.org/abs/2608.08829)
...
### [55] [Explicit Boundary Markers for Subword Vocabularies](https://arxiv.org/abs/2608.08847)
...
### [56] [Conversation as Measurement in Clinical Encounters: Observable Phase Structure, Partially Observable Patient State](https://arxiv.org/abs/2608.08868)
...
### [57] [Position Bias in Ordinal Classification: A Systematic Evaluation](https://arxiv.org/abs/2608.08869)
...
### [58] [Tied Trit-Planes: Constraining PTQTP to a Uniform Nine-Level Quantizer, with a Persistent Folded Format for Disk-Streamed Mixture-of-Experts Serving](https://arxiv.org/abs/2608.08910)
*Matteo Grella*
...
### [59] [Investigating Multimodal Informativity under Different Partner Visibility Conditions in Video-Mediated Dialogue](https://arxiv.org/abs/2608.08915)
...
### [60] [Same Question, Different Answer? Measuring and Mitigating Prompt Privilege for Equitable AI Access](https://arxiv.org/abs/2608.08942)
...
### [61] [How Can Rhetoric Reward-Hack AI Reviewers? Dissecting Rhetorical Sensitivity in AI-Based Peer Review](https://arxiv.org/abs/2608.08975)
...
### [62] [How Far Do Foundation Models Transfer to Infant Signals? A Cross-Dataset Transfer Audit with a Unified Need Ontology](https://arxiv.org/abs/2608.08989)
*Wu Hangyu*
...
### [63] [ELICITED: EHR-grounded Longitudinal Interactive Conversations for Information-seeking Triage Evaluation and Decision-making](https://arxiv.org/abs/2608.09024)
...
### [64] [Don't Scroll Back: Missing-Evidence Memory for Streaming Dialogue Summarization](https://arxiv.org/abs/2608.09043)
...
### [65] [Tree-of-Experience: Hierarchical Experience Management for Self-Evolving Agents](https://arxiv.org/abs/2608.09044)
...
### [66] [Bridging the Gap Between Semantics and Reconstruction:Unifying Sign Language Translation and Production](https://arxiv.org/abs/2608.09045)
...
### [67] [Security and Privacy Taxonomy Generation from Mobile App Reviews](https://arxiv.org/abs/2608.09049)
...
### [68] [When Confidence Fails: Overconfidence in LLMs under Uncertainty and Missing Clinical Information](https://arxiv.org/abs/2608.09080)
...
### [69] [The Announcement Carries the Cue: Markup, Boundaries, and the Notation of Pre-Training Corpora](https://arxiv.org/abs/2608.09093)
*E. M. Freeburg*
...
### [70] [Evo-Bench: Can Language Models Improve Agent Harness?](https://arxiv.org/abs/2608.09096)
...
### [71] [LexKairos: Benchmarking Legal Temporal Capabilities in LLMs](https://arxiv.org/abs/2608.09106)
...
### [72] [Subjective Multi-Bias Detection with Large Language Models](https://arxiv.org/abs/2608.09126)
...
### [74] [An Agentic Generative Large Language Model for Treatment Planning of Colorectal Cancer](https://arxiv.org/abs/2608.09142)
...
### [75] [UNSPECIFIC: General Constraint Synthesis for Breaking Copy-and-Paste Shortcut in LLM Instruction Following](https://arxiv.org/abs/2608.09154)
...
### [76] [Failure-Aware Long-Form Translation: Design and Implementation of a Recoverable LLM Translation System](https://arxiv.org/abs/2608.09187)
*Yanlin Yu*
...
### [77] [EmoS: A Theory-Grounded Framework for Evaluating and Aligning Emotional Intelligence in Spoken Language Models](https://arxiv.org/abs/2608.09189)
...
### [78] [UNMASK: Discovering and Causally Verifying Spurious Shortcuts in Text Classifiers](https://arxiv.org/abs/2608.09209)
...
### [79] [Reading Cognition as Decisions Unfold in Words: A Factorized Inverse Decision Model](https://arxiv.org/abs/2608.09222)
...
### [80] [Verifiably grounded machine interpretation of lunar geology](https://arxiv.org/abs/2608.09276)
...
### [81] [Is the ACL Responsible NLP Checklist a Box-Ticking Exercise? A Large-Scale Analysis of EMNLP 2025](https://arxiv.org/abs/2608.09280)
...
### [82] [Accurate but Natural? Diagnosing Grammatical and Idiomatic Gaps in Japanese EFL Writing](https://arxiv.org/abs/2608.09289)
...
### [83] [Universal or Language-Family-Specific Script Unification for Cross-Lingual Transfer? A Case Study on Turkic Languages](https://arxiv.org/abs/2608.09356)
*Zijie Zhang*
...
### [84] [Temporal Misgrounding in Legal RAG: A Versioned-Corpus Benchmark for French Tax Law](https://arxiv.org/abs/2608.09393)
...
### [85] [Intent Speaks Louder: Controllable User Simulation Beyond Response Imitation](https://arxiv.org/abs/2608.09420)
...
### [86] [Reducing Pretraining-Generation Mismatch in Diffusion Language Models](https://arxiv.org/abs/2608.09424)
...
### [87] [ZetaGPT: A Reference Implementation of Positional--Encoding--Free State--Space--Attention Language Models](https://arxiv.org/abs/2608.09432)
*Róisín Luo*
...
### [88] [Learning Preference Adaptation for Large Language Model Personalization via Verbal Reinforcement Learning](https://arxiv.org/abs/2608.09507)
...
### [89] [TCS-BENCH: Benchmarking State-of-the-Art Generative AI Theoretical Computer Science Research Ability](https://arxiv.org/abs/2608.09538)
...
### [90] [Mawqif-v2: An Arabic Benchmark Dataset for Cross-Target Stance Detection](https://arxiv.org/abs/2608.09539)
...
### [94] [Measuring the Wrong Thing: Internal Harmfulness Scores Anti-Rank Successful Jailbreaks](https://arxiv.org/abs/2608.09624)
...
### [107] [Positioning Generative Artificial Intelligence in STEM Assessment: When to Require, Scaffold, or Restrict Its Use](https://arxiv.org/abs/2608.07475)
...
### [108] [Position: We Need Large Language Models Optimized For Our Well-Being](https://arxiv.org/abs/2608.07505)
...
### [110] [Bridging AI Risk Frameworks: Reconciling ISO/IEC 42001, the NIST AI Risk Management Framework, and the EU AI Act into a Uni ed Governance Taxonomy](https://arxiv.org/abs/2608.07515)
*Vinod Dhiman*
...
### [112] [KumbhDoot: A Scale-Ready, LLM-Bounded Architecture for Mass-Gathering Public-Service Assistants](https://arxiv.org/abs/2608.07520)
...
### [113] [Explainable Machine Learning in Healthcare: Methods, Interpretation, and Applications for Clinical Research](https://arxiv.org/abs/2608.07522)
...
### [114] [From Evaluated Models to Evaluation Aids: A Multi-Evidence Study of LLM-Based Difficulty Calibration for Programming Examinations](https://arxiv.org/abs/2608.07523)
...
### [115] [AI as a Democratizing Force in Indie Game Development](https://arxiv.org/abs/2608.07825)
...
### [117] [Beyond "I Can't Help With That": How Child Safety Experts Evaluate AI Chatbot Safety](https://arxiv.org/abs/2608.07902)
...
### [118] [Representational Equality in Cross-country Value Simulation: A Systematic Analysis of Large Language Models](https://arxiv.org/abs/2608.08058)
...
### [119] [Abstracted Away: Resisting Alienation and Ungrounded Abstraction in AI Research Communities](https://arxiv.org/abs/2608.08408)
...
### [120] [Rethinking Higher Education: From Fixed Curricula to Learnity Graphs](https://arxiv.org/abs/2608.08543)
...
### [121] [Qualifying and Quantifying Risk under the EU AI Act](https://arxiv.org/abs/2608.08564)
...
Abstract: The EU AI Act uses a risk-based approach to regulate AI systems, calibrating the intensity of regulation according to the risks they pose. While the AI Act's definition of 'risk' (as the combination of the probability and severity of harm) implies quantification, the AI Act focuses on risks to fundamental rights, thereby engaging a typically qualitative perspective. In this piece, we address this tension using a two-step framework under which the EU AI Act balances the protection of fundamental rights, the legitimate purposes of providers and deployers, and the impacts of regulatory measures on providers, deployers, and regulators. We discuss this framework against the backdrop of potential approaches to quantifying risks, with a specific focus on defining and measuring the main components of the concept of risk: 'probability', 'severity', and their 'combination'. We suggest that the protection of fundamental rights and risk quantification can be aligned within the proposed framework. In particular, the AI Act implies a balancing analysis that uses what we call a 'severity-first' approach in which the severity of a harm is considered before the harm's probability of occurring. The integrated framework not only helps to clarify the AI Act's risk-based approach, but can also inform technical and implementation choices. Finally, we discuss the potential for 'risk hacking' if risk quantification is left to AI providers and deployers, who may manipulate the approach, which could lead to the underclassification of AI systems and subsequent regulatory shortcuts.

</details>


### [122] [Automating Freshman Course Placement and Registration: A Case Study](https://arxiv.org/abs/2608.08776)
...
### [123] [Data Findability, Governance, and Community Engagement for Māori Research Data Sovereignty](https://arxiv.org/abs/2608.08905)
*Paul T. Brown,Kiri West,Maree Sheehan,Hana Rapata,Te Taka Keegan*
...
### [126] [TopoBudget: Persistent-Connectivity-Preserving Web Graph Sparsification for Reusable Community Analytics](https://arxiv.org/abs/2608.07903)
*Jianru Shen*
...
### [127] [WhichTok? Comparing Three TikTok Data Acquisition Tools](https://arxiv.org/abs/2608.09917)
...
### [128] [Designing for Ethical AI: HCI Feature Considerations to Improve Fairness and User Experience in AutoML use for Human Resources](https://arxiv.org/abs/2608.07477)
...
### [129] [Cross-Model Humor Preference Modeling with Cards Against Humanity](https://arxiv.org/abs/2608.07481)
...
### [130] [From Human-Centered Design to Human-AI Collaboration: Why the Future of HCI Still Starts With People](https://arxiv.org/abs/2608.07482)
*Issam Alzouby*
...
### [131] [Generative AI as Support, Not Replacement, in Human-Centered Design](https://arxiv.org/abs/2608.07483)
*Amir Talakoob*
...
### [132] [Using the gameplay and user data to predict and identify causes of cybersickness manifestation in virtual reality games](https://arxiv.org/abs/2608.07484)
...
### [133] [Humour as Resistance: Visceralizing the Environmental and Social Impact of AI through Humour-based Creative Practices](https://arxiv.org/abs/2608.07485)
...
### [134] [SocialFiVis: A Visual Analytics Sandbox for LLM-Grounded Multi-Agent Simulation in Social Finance](https://arxiv.org/abs/2608.08497)
...
### [135] [A Symbolic Machine Learning Approach for Cybersickness Potential-Cause Estimation](https://arxiv.org/abs/2608.07486)
...
### [136] [How People Evaluate AI-, Expert-, and Peer-Style Financial Advice](https://arxiv.org/abs/2608.09019)
...
### [137] [SafeStudent Driving: A Multimodal Driver-Safety System to Support Teen Drivers Using Computer Vision and Mobile Sensing](https://arxiv.org/abs/2608.07487)
*Max Liu,Yu Sun*
...
### [138] [Large Language Models Explain Experts Better Than Experts Themselves](https://arxiv.org/abs/2608.07488)
...
### [139] [Uncovering the Associations between Human Big Five Personality Traits and Built Environment Characteristics from Street View Imagery](https://arxiv.org/abs/2608.07489)
...
### [140] [Experience-Sensitive Game Learning: A Behavioral Study of Humans and Language Agents](https://arxiv.org/abs/2608.07490)
...
### [141] [Initial Evaluation of the Usability of Front-End Ontology Tooling](https://arxiv.org/abs/2608.07491)
...
### [142] [A Survey On Digital Reading Materials and Personal Study of Christian Religious Texts](https://arxiv.org/abs/2608.07492)
...
### [143] [The Transparency Trap: How AI Disclaimers Create Overconfidence in High-Stakes Decisions](https://arxiv.org/abs/2608.07493)
*Neil Todkar*
...
### [144] [How to Ask the AI: A User Perspective Survey for Large Language Model Prompting](https://arxiv.org/abs/2608.07494)
...
### [145] [EmoPatient: An Emotion-Directed Patient Simulator for Realistic Palliative Care Communication Training](https://arxiv.org/abs/2608.07495)
...
### [146] [Human-Simulation Interaction: From Prediction to Exploration in LLM Agent Simulations for Policy](https://arxiv.org/abs/2608.07496)
*Huanxing Chen*
...
### [147] [EvalConvoLearn: An Open-Source Framework for Evaluating Grounded Learner Simulations in Tutoring Conversations](https://arxiv.org/abs/2608.07497)
...
### [148] [Knowing You Is Everything: LLM Agents Achieve Near-Perfect Profile-Consistent Reaction Prediction in Social Media Simulation](https://arxiv.org/abs/2608.07498)
...
### [149] [Evaluation of Motivational Interviewing Counsellors with Task-Aware Multi-Stage LLM-Based Simulated Clients](https://arxiv.org/abs/2608.07499)
...
### [150] [Harnessing Abundance: A Generativity Perspective on Human-GenAI Collaboration](https://arxiv.org/abs/2608.07500)
...
### [151] [Customized Tourist Navigation in Urban Contexts Following General Trends and Individual Preferences](https://arxiv.org/abs/2608.07501)
...
### [152] [An IMU Dataset for Human Activity Recognition to Support Independent Living in Smart Homes (IMU-HAR-IL)](https://arxiv.org/abs/2608.07502)
...
### [153] [Exploring AI-Supported Disciplinary Mediation in Student Project Teams' Text-Based Communication](https://arxiv.org/abs/2608.07503)
...
### [154] [Innovating with Generative AI: A Human Bottleneck Framework](https://arxiv.org/abs/2608.07504)
...
### [155] [What We Risk Losing When Creating Gets Easy: Friction, Judgment, and Critical Reflective Practice with Generative AI in Creative Work](https://arxiv.org/abs/2608.07506)
...
### [156] [How sensitive do we want AI to be? Socio-communicative competencies of large language models in healthcare](https://arxiv.org/abs/2608.07511)
...
### [157] [Visual Reconstruction as Memory Negotiation: An Iterative Generative AI-Mediated Framework for Oral History](https://arxiv.org/abs/2608.07507)
*Yigeng Zhang*
...
### [158] [Democratizing Ski Safety: Real-Time Turn Segmentation with Smartphone IMU and Causal LSTM Networks](https://arxiv.org/abs/2608.07513)
...
### [159] [JaleesBench: Are AI Assistants Good Spiritual Company?](https://arxiv.org/abs/2608.07508)
...
### [160] ["Always Want to Use it for Everything": Understanding Young Adults' Perceptions of AI Dependence](https://arxiv.org/abs/2608.07592)
...
### [161] [PIVOT: Preference-based Intervention Vectors for Pedagogical Tutor Steering](https://arxiv.org/abs/2608.07509)
...
### [162] [EMMR: Emotion-Mediated Multimodal Reasoning for Personality Assessment in Asynchronous Video Interviews](https://arxiv.org/abs/2608.07512)
...
### [163] [Catch the Patient, Not the AI: Collective Sensemaking in an Online Health Community](https://arxiv.org/abs/2608.07516)
*Feng He*
...
### [164] [The Judge Knows When It Knows: Calibrated Abstention for LLM-Based A/B-Test Prediction](https://arxiv.org/abs/2608.07517)
...
### [165] [Representation Matters in Longitudinal Affective Computing](https://arxiv.org/abs/2608.07518)
...
### [166] [CyberSelf: Embodied Self-Distancing for Emotional Support in Virtual Reality](https://arxiv.org/abs/2608.07521)
...
### [167] [Weather- and Location-Aware Agentic Dining Recommendation: Leveraging LLM World Knowledge for Region-Sensitive Contextual Reasoning](https://arxiv.org/abs/2608.07593)
...
### [168] [Exploring a Real-time Feedback Display of Non-Verbal Cues in Online Work Meetings to Support Self-Presentation](https://arxiv.org/abs/2608.07766)
...
### [169] [Marks, Channels, and Dead Ends: Stop Running Graphical Perception Studies and Start Modeling Visualizations as Images](https://arxiv.org/abs/2608.07834)
...
### [170] [The Missing Link of XR: Empathy-Driven Reality for XR and Beyond](https://arxiv.org/abs/2608.08034)
...
### [171] [Understanding Security and Privacy Perceptions of Content Creators Regarding AI Labels of AI-Generated Content](https://arxiv.org/abs/2608.08129)
...
### [172] [Underwater MMG-Based Muscle State Monitoring with Integrated Emergency Buoyancy Assistance](https://arxiv.org/abs/2608.08263)
...
### [173] [Design Knowledge in Data Visualization: Mapping the Epistemic Landscape](https://arxiv.org/abs/2608.08270)
...
### [174] [Situatedness in Visualization Design: Making Unresolved Work Actionable](https://arxiv.org/abs/2608.08274)
...
### [175] [A Decision Framework for Selecting Technology Acceptance and Use Models: TAM, TAM2, TAM3, UTAUT, and UTAUT2](https://arxiv.org/abs/2608.08333)
...
### [176] [Dramarrator: Object-Based Audio Editing for Audio Drama Production from Books](https://arxiv.org/abs/2608.08349)
...
### [177] [FZ-VIS: A Visual Analytics Framework for Quantities-of-Interest-Aware Scientific Lossy Compression](https://arxiv.org/abs/2608.08386)
...
### [178] [Human-Guided Causal Knowledge Injection for Virtual Cells](https://arxiv.org/abs/2608.08430)
...
### [180] [TeachUp: Facilitating Early-Stage Teachers to Learn Instructional Strategies from Classroom Videos with Reflective Support](https://arxiv.org/abs/2608.08535)
...
### [181] [Charting Public Health: A Taxonomic Study of Visualization Practices in the Public Health Field](https://arxiv.org/abs/2608.08657)
...
### [182] [A Dynamic-Semantics Framework for Grounding Human Referring Expressions in Visual Perceptual Data](https://arxiv.org/abs/2608.08663)
*Joseph Bingham*
...
### [183] [FOX: Visual Exploration of Data Fact Outliers](https://arxiv.org/abs/2608.08671)
*Yikai Li,Yong Wang*
...
### [184] [From Scaffolding to Internalization: Enhancing CPR Training with In-Situ Visualization and Kinesthetic Feedback](https://arxiv.org/abs/2608.08729)
...
### [185] [Wearing Trust: How Older Adults Calibrate Reliance on Health Wearables Through Bodily Experience and Everyday Use](https://arxiv.org/abs/2608.08856)
...
### [186] [Inductive Graph Layout with Implicit Neural Fields](https://arxiv.org/abs/2608.08876)
...
### [187] [Epistemic Transfer in AI-Assisted Verification: A Framework and Evaluation Protocol](https://arxiv.org/abs/2608.08882)
*Christoph Trattner*
...
### [188] [Imagining the Musical Metaverse: a study on the needs and creative practices of composers and musicians](https://arxiv.org/abs/2608.08938)
...
### [189] [Generative Proxy: Synthesizing Proxy-Based Interfaces for Real-World Interaction Across AR Glasses](https://arxiv.org/abs/2608.08971)
...
### [190] [AI-Guided Learning: Research on Knowledge and Skill Acquisition Support Methods Using Deep Learning Audio-Video Processing Techniques](https://arxiv.org/abs/2608.08990)
*Kazuki Kawamura*
...
### [191] [ITO: Real-time Browser Tab Orchestration Through Intent Detection](https://arxiv.org/abs/2608.09107)
...
### [192] [CatPAL: Task-Aware Learning for Categorical Palette Recommendation](https://arxiv.org/abs/2608.09108)
...
### [193] [Diagnosing Performance in Invasion-Based Esports: The Esports Performance Screening (EPS) Framework](https://arxiv.org/abs/2608.09156)
...
### [194] [Intuitive Hand Positional Guidance Using McKibben-Based Surface Tactile Sensations to Shoulder and Elbow](https://arxiv.org/abs/2608.09167)
...
### [195] [Intuitive Directional Sense Presentation to the Torso Using McKibben-Based Surface Haptic Sensation in Immersive Space](https://arxiv.org/abs/2608.09177)
...
### [196] [Can Coding Agents Solve Repository-Level Issues with Rendered Code? An Exploratory Study of Visual Representations](https://arxiv.org/abs/2608.09268)
...
### [197] [Graphing the Everyday: A Neurosymbolic Approach to Eliciting Routines for Just-In-Time Adaptive Interventions](https://arxiv.org/abs/2608.09294)
...
### [198] [VeriForge: Mitigating Latent Knowledge Gaps in Narrative Drafting via Mixed-Initiative Scaffolding](https://arxiv.org/abs/2608.09698)
...
### [199] [Designing PULSE: A Realtime Annotation Tool to Support Simulation Debriefing](https://arxiv.org/abs/2608.09715)
...
### [200] [Mirroring the Past: Exploring How Ancestral Digital Self Influences History Learning](https://arxiv.org/abs/2608.09719)
