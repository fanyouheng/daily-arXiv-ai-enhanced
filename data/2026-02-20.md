...
### [18] [Using LLMs for Knowledge Component-level Correctness Labeling in Open-ended Coding Problems](https://arxiv.org/abs/2602.17542)
...
### [29] [Modeling Distinct Human Interaction in Web Agents](https://arxiv.org/abs/2602.17588)
...
### [30] [Fine-Grained Uncertainty Quantification for Long-Form Language Model Outputs: A Comparative Study](https://arxiv.org/abs/2602.17431)
...
### [31] [AIDG: Evaluating Asymmetry Between Information Extraction and Containment in Multi-Turn Dialogue](https://arxiv.org/abs/2602.17443)
...
### [32] [ABCD: All Biases Come Disguised](https://arxiv.org/abs/2602.17445)
...
### [33] [Entropy-Based Data Selection for Language Models](https://arxiv.org/abs/2602.17465)
...
### [34] [PEACE 2.0: Grounded Explanations and Counter-Speech for Combating Hate Expressions](https://arxiv.org/abs/2602.17467)
...
### [35] [Small LLMs for Medical NLP: a Systematic Analysis of Few-Shot, Constraint Decoding, Fine-Tuning and Continual Pre-Training in Italian](https://arxiv.org/abs/2602.17475)
...
### [36] [Bridging the Domain Divide: Supervised vs. Zero-Shot Clinical Section Segmentation from MIMIC-III to Obstetrics](https://arxiv.org/abs/2602.17513)
...
### [43] [Exploring the Design and Impact of Interactive Worked Examples for Learners with Varying Prior Knowledge](https://arxiv.org/abs/2602.16806)
...
### [44] [AI-Mediated Feedback Improves Student Revisions: A Randomized Trial with FeedbackWriter in a Large Undergraduate Course](https://arxiv.org/abs/2602.16820)
...
### [45] [Overseeing Agents Without Constant Oversight: Challenges and Opportunities](https://arxiv.org/abs/2602.16844)
...
### [46] ["My body is not your Porn": Identifying Trends of Harm and Oppression through a Sociotechnical Genealogy of Digital Sexual Violence in South Korea](https://arxiv.org/abs/2602.16853)
...
### [47] [CalmReminder: A Design Probe for Parental Engagement with Children with Hyperactivity, Augmented by Real-Time Motion Sensing with a Watch](https://arxiv.org/abs/2602.16893)
...
### [48] [Connecting the Dots: Surfacing Structure in Documents through AI-Generated Cross-Modal Links](https://arxiv.org/abs/2602.16895)
...
### [49] [Evidotes: Integrating Scientific Evidence and Anecdotes to Support Uncertainties Triggered by Peer Health Posts](https://arxiv.org/abs/2602.16900)
...
### [50] [Say It My Way: Exploring Control in Conversational Visual Question Answering with Blind Users](https://arxiv.org/abs/2602.16930)
...
### [51] [Nudging Attention to Workplace Meeting Goals: A Large-Scale, Preregistered Field Experiment](https://arxiv.org/abs/2602.16939)
...
### [52] ["It's like a pet...but my pet doesn't collect data about me": Multi-person Households' Privacy Design Preferences for Household Robots](https://arxiv.org/abs/2602.16975)
...
### [53] [StoryLensEdu: Personalized Learning Report Generation through Narrative-Driven Multi-Agent Systems](https://arxiv.org/abs/2602.17067)
...
### [54] [Rememo: A Research-through-Design Inquiry Towards an AI-in-the-loop Therapist's Tool for Dementia Reminiscence](https://arxiv.org/abs/2602.17083)
...
### [55] [Understanding Nature Engagement Experiences of Blind People](https://arxiv.org/abs/2602.17093)
...
### [56] [The Bots of Persuasion: Examining How Conversational Agents' Linguistic Expressions of Personality Affect User Perceptions and Decisions](https://arxiv.org/abs/2602.17185)
...
### [57] [What Do LLMs Associate with Your Name? A Human-Centered Black-Box Audit of Personal Data](https://arxiv.org/abs/2602.17483)
...
### [58] [NotebookRAG: Retrieving Multiple Notebooks to Augment the Generation of EDA Notebooks for Crowd-Wisdom](https://arxiv.org/abs/2602.17215)
...
### [59] [PersonaMail: Learning and Adapting Personal Communication Preferences for Context-Aware Email Writing](https://arxiv.org/abs/2602.17340)
...
### [60] [Do Hackers Dream of Electric Teachers?: A Large-Scale, In-Situ Evaluation of Cybersecurity Student Behaviors and Performance with AI Tutors](https://arxiv.org/abs/2602.17448)
...
### [61] [ShadAR: LLM-driven shader generation to transform visual perception in Augmented Reality](https://arxiv.org/abs/2602.17481)
...
### [62] [The Effectiveness of a Virtual Reality-Based Training Program for Improving Body Awareness in Children with Attention Deficit and Hyperactivity Disorder](https://arxiv.org/abs/2602.17649)
...
### [63] [CreateAI Insights from an NSF Workshop on K12 Students, Teachers, and Families as Designers of Artificial Intelligence and Machine Learning Applications](https://arxiv.org/abs/2602.16894)
...
### [64] [Beyond the Flag: A Framework for Integrating Cybersecurity Competitions into K-12 Education for Cognitive Apprenticeship and Ethical Skill Development](https://arxiv.org/abs/2602.16921)
...
### [65] [How should AI knowledge be governed? Epistemic authority, structural transparency, and the case for open cognitive graphs](https://arxiv.org/abs/2602.16949)
...
### [66] [A testable framework for AI alignment: Simulation Theology as an engineered worldview for silicon-based agents](https://arxiv.org/abs/2602.16987)
*Josef A. Habdank*
...
### [67] [Archetypes and gender in fiction: A data-driven mapping of gender stereotypes in stories](https://arxiv.org/abs/2602.17005)
...
### [68] [Security at the Border? The Lived Experiences of Refugees and Asylum Seekers in the UK](https://arxiv.org/abs/2602.17280)
...
### [69] [Non-Invasive Anemia Detection: A Multichannel PPG-Based Hemoglobin Estimation with Explainable Artificial Intelligence](https://arxiv.org/abs/2602.17290)
...
### [70] [Human attribution of empathic behaviour to AI systems](https://arxiv.org/abs/2602.17293)
...
### [71] [Open Datasets in Learning Analytics: Trends, Challenges, and Best PRACTICE](https://arxiv.org/abs/2602.17314)
...
### [72] [Astra: AI Safety, Trust, & Risk Assessment](https://arxiv.org/abs/2602.17357)
...
### [73] [Insidious Imaginaries: A Critical Overview of AI Speculations](https://arxiv.org/abs/2602.17383)
*Dejan Grba*
...
### [74] [Preserving Historical Truth: Detecting Historical Revisionism in Large Language Models](https://arxiv.org/abs/2602.17433)
...
### [75] [Expanding the Scope of Computational Thinking in Artificial Intelligence for K-12 Education](https://arxiv.org/abs/2602.16890)
...
### [76] [Simplify to Amplify: Achieving Information-Theoretic Bounds with Fewer Steps in Spectral Community Detection](https://arxiv.org/abs/2602.17104)
...
### [77] [NTLRAG: Narrative Topic Labels derived with Retrieval Augmented Generation](https://arxiv.org/abs/2602.17216)
