...
### [21] [PatientHub: A Unified Framework for Patient Simulation](https://arxiv.org/abs/2602.11684)
...
### [23] [A technical curriculum on language-oriented artificial intelligence in translation and specialised communication](https://arxiv.org/abs/2602.12251)
*Ralph Krüger*
...
### [24] [When and What to Ask: AskBench and Rubric-Guided RLVR for LLM Clarification](https://arxiv.org/abs/2602.11199)
...
### [25] [Mechanistic Evidence for Faithfulness Decay in Chain-of-Thought Reasoning](https://arxiv.org/abs/2602.11201)
...
### [26] [The Automatic Verification of Image-Text Claims (AVerImaTeC) Shared Task](https://arxiv.org/abs/2602.11221)
...
### [27] [SurveyLens: A Research Discipline-Aware Benchmark for Automatic Survey Generation](https://arxiv.org/abs/2602.11238)
...
### [28] [Are Aligned Large Language Models Still Misaligned?](https://arxiv.org/abs/2602.11305)
...
### [29] [Evaluating Alignment of Behavioral Dispositions in LLMs](https://arxiv.org/abs/2602.11328)
...
### [30] [When Models Examine Themselves: Vocabulary-Activation Correspondence in Self-Referential Processing](https://arxiv.org/abs/2602.11358)
...
### [31] [Finding the Cracks: Improving LLMs Reasoning with Paraphrastic Probing and Consistency Verification](https://arxiv.org/abs/2602.11361)
...
### [32] [The Energy of Falsehood: Detecting Hallucinations via Diffusion Model Likelihoods](https://arxiv.org/abs/2602.11364)
...
### [33] [Advancing AI Trustworthiness Through Patient Simulation: Risk Assessment of Conversational Agents for Antidepressant Selection](https://arxiv.org/abs/2602.11391)
...
### [34] [Gradients Must Earn Their Influence: Unifying SFT with Generalized Entropic Objectives](https://arxiv.org/abs/2602.11424)
...
### [35] [Towards Reliable Machine Translation: Scaling LLMs for Critical Error Detection and Safety](https://arxiv.org/abs/2602.11444)
...
### [36] [LoopFormer: Elastic-Depth Looped Transformers for Latent Reasoning via Shortcut Modulation](https://arxiv.org/abs/2602.11451)
...
### [37] [ADRD-Bench: A Preliminary LLM Benchmark for Alzheimer's Disease and Related Dementias](https://arxiv.org/abs/2602.11460)
...
### [38] [When Audio-LLMs Don't Listen: A Cross-Linguistic Study of Modality Arbitration](https://arxiv.org/abs/2602.11488)
*Jayadev Billa*
...
### [39] [Multimodal Fact-Level Attribution for Verifiable Reasoning](https://arxiv.org/abs/2602.11509)
...
### [40] [Pretraining A Large Language Model using Distributed GPUs: A Memory-Efficient Decentralized Paradigm](https://arxiv.org/abs/2602.11543)
...
### [41] [SIGHT: Reinforcement Learning with Self-Evidence and Information-Gain Diverse Branching for Search Agent](https://arxiv.org/abs/2602.11551)
...
### [42] [PRIME: A Process-Outcome Alignment Benchmark for Verifiable Reasoning in Mathematics and Engineering](https://arxiv.org/abs/2602.11570)
...
### [43] [Scene-Aware Memory Discrimination: Deciding Which Personal Knowledge Stays](https://arxiv.org/abs/2602.11607)
...
### [44] [PACE: Prefix-Protected and Difficulty-Aware Compression for Efficient Reasoning](https://arxiv.org/abs/2602.11639)
...
### [45] [Which Feedback Works for Whom? Differential Effects of LLM-Generated Feedback Elements Across Learner Profiles](https://arxiv.org/abs/2602.11650)
...
### [70] [Query-focused and Memory-aware Reranker for Long Context Processing](https://arxiv.org/abs/2602.12192)
...
### [71] [Visual Reasoning Benchmark: Evaluating Multimodal LLMs on Classroom-Authentic Visual Problems from Primary Education](https://arxiv.org/abs/2602.12196)
...
### [72] [ExStrucTiny: A Benchmark for Schema-Variable Structured Information Extraction from Document Images](https://arxiv.org/abs/2602.12203)
...
### [73] [Detecting Overflow in Compressed Token Representations for Retrieval-Augmented Generation](https://arxiv.org/abs/2602.12235)
...
### [74] [Moonshine v2: Ergodic Streaming Encoder ASR for Latency-Critical Speech Applications](https://arxiv.org/abs/2602.12241)
...
### [77] [Grok in the Wild: Characterizing the Roles and Uses of Large Language Models on Social Media](https://arxiv.org/abs/2602.11286)
...
### [78] [Reconstructing Network Outbreaks under Group Surveillance](https://arxiv.org/abs/2602.11419)
...
### [79] [Optimizing edge weights in the inverse eigenvector centrality problem](https://arxiv.org/abs/2602.11772)
...
### [80] [Making the complete OpenAIRE citation graph easily accessible through compact data representation](https://arxiv.org/abs/2602.12206)
...
### [81] [Methodological Variation in Studying Staff and Student Perceptions of AI](https://arxiv.org/abs/2602.11158)
...
### [82] [BIRD: A Museum Open Dataset Combining Behavior Patterns and Identity Types to Better Model Visitors' Experience](https://arxiv.org/abs/2602.11160)
...
### [83] [Althea: Human-AI Collaboration for Fact-Checking and Critical Reasoning](https://arxiv.org/abs/2602.11161)
...
### [84] [DiSCoKit: An Open-Source Toolkit for Deploying Live LLM Experiences in Survey Research](https://arxiv.org/abs/2602.11230)
...
### [86] [Situated, Dynamic, and Subjective: Envisioning the Design of Theory-of-Mind-Enabled Everyday AI with Industry Practitioners](https://arxiv.org/abs/2602.11342)
...
### [87] [Interpretive Cultures: Resonance, randomness, and negotiated meaning for AI-assisted tarot divination](https://arxiv.org/abs/2602.11367)
...
### [88] [Understanding Persuasive Interactions between Generative Social Agents and Humans: The Knowledge-based Persuasion Model (KPM)](https://arxiv.org/abs/2602.11483)
...
### [89] [VIRENA: Virtual Arena for Research, Education, and Democratic Innovation](https://arxiv.org/abs/2602.12207)
...
### [90] [Data-driven modelling of low-dimensional dynamical structures underlying complex full-body human movement](https://arxiv.org/abs/2602.11492)
...
### [91] [An Educational Human Machine Interface Providing Request-to-Intervene Trigger and Reason Explanation for Enhancing the Driver's Comprehension of ADS's System Limitations](https://arxiv.org/abs/2602.11507)
...
### [92] [Implications of AI Involvement for Trust in Expert Advisory Workflows Under Epistemic Dependence](https://arxiv.org/abs/2602.11522)
...
### [93] [Behavioral Indicators of Overreliance During Interaction with Conversational Language Models](https://arxiv.org/abs/2602.11567)
...
### [94] [Wisdom of the LLM Crowd: A Large Scale Benchmark of Multi-Label U.S. Election-Related Harmful Social Media Content](https://arxiv.org/abs/2602.11962)
...
### [95] ["I Was Told to Come Back and Share This": Social Media-Based Near-Death Experience Disclosures as Expressions of Spiritual Beliefs](https://arxiv.org/abs/2602.11663)
...
### [96] [Mapping the Landscape of Affective Extended Reality: A Scoping Review of Biodata-Driven Systems for Understanding and Sharing Emotions](https://arxiv.org/abs/2602.11710)
...
### [97] [Building Intelligent User Interfaces for Human-AI Alignment](https://arxiv.org/abs/2602.11753)
*Danqing Shi*
...
### [98] [V-SHiNE: A Virtual Smart Home Framework for Explainability Evaluation](https://arxiv.org/abs/2602.11775)
...
### [99] [Decision Support System for Technology Opportunity Discovery: An Application of the Schwartz Theory of Basic Values](https://arxiv.org/abs/2602.11855)
...
### [100] [Who Does What? Archetypes of Roles Assigned to LLMs During Human-AI Decision-Making](https://arxiv.org/abs/2602.11924)
...
### [101] [Embodied AI Agents for Team Collaboration in Co-located Blue-Collar Work](https://arxiv.org/abs/2602.12136)
...
### [102] [How to check in continually over 4,000 days on an online learning platform? An empirical experience and a practical solution](https://arxiv.org/abs/2602.11249)
*Jialiang Lin*
...
### [103] [Bizarre Love Triangle: Generative AI, Art, and Kitsch](https://arxiv.org/abs/2602.11353)
*Dejan Grba*
...
### [104] [The Manifold of the Absolute: Religious Perennialism as Generative Inference](https://arxiv.org/abs/2602.11368)
*Arthur Juliani*
...
### [105] [When Visibility Outpaces Verification: Delayed Verification and Narrative Lock-in in Agentic AI Discourse](https://arxiv.org/abs/2602.11412)
...
### [106] [Digital Ecosystems: Enabling Collaboration in a Fragmented World](https://arxiv.org/abs/2602.11707)
*Marc Schmitt*
...
### [107] [Artificial intelligence is creating a new global linguistic hierarchy](https://arxiv.org/abs/2602.12018)
