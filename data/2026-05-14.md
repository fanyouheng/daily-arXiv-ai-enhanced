...
### [19] [The Cost of Perfect English: Pragmatic Flattening and the Erasure of Authorial Voice in L2 Writing Supported by GenAI](https://arxiv.org/abs/2605.13055)
*Ao Liu,Shanhua Zhu*
...
### [21] [Fine-tuning with Hierarchical Prompting for Robust Propaganda Classification Across Annotation Schemas](https://arxiv.org/abs/2605.13663)
...
### [32] [GAGPO: Generalized Advantage Grouped Policy Optimization](https://arxiv.org/abs/2605.13217)
...
### [33] [A Hybrid Framework for Natural Language Querying of IFC Models with Relational and Graph Representations](https://arxiv.org/abs/2605.13236)
...
### [34] [Utility-Oriented Visual Evidence Selection for Multimodal Retrieval-Augmented Generation](https://arxiv.org/abs/2605.13277)
...
### [35] [IndicMedDialog: A Parallel Multi-Turn Medical Dialogue Dataset for Accessible Healthcare in Indic Languages](https://arxiv.org/abs/2605.13292)
...
### [36] [Tracing Persona Vectors Through LLM Pretraining](https://arxiv.org/abs/2605.13329)
...
### [37] [FIND: Toward Multimodal Financial Reasoning and Question Answering for Indic Languages](https://arxiv.org/abs/2605.13330)
...
### [38] [LLM-Based Persuasion Enables Guardrail Override in Frontier LLMs](https://arxiv.org/abs/2605.13334)
...
### [39] [Probing Persona-Dependent Preferences in Language Models](https://arxiv.org/abs/2605.13339)
...
### [40] [What Does LLM Refinement Actually Improve? A Systematic Study on Document-Level Literary Translation](https://arxiv.org/abs/2605.13368)
...
### [41] [Query-Conditioned Test-Time Self-Training for Large Language Models](https://arxiv.org/abs/2605.13369)
...
### [42] [Exploiting Pre-trained Encoder-Decoder Transformers for Sequence-to-Sequence Constituent Parsing](https://arxiv.org/abs/2605.13373)
...
### [43] [From Rosetta to Match-Up: A Paired Corpus of Linguistic Puzzles with Human and LLM Benchmarks](https://arxiv.org/abs/2605.13408)
...
### [44] [LLMs as annotators of credibility assessment in Danish asylum decisions: evaluating classification performance and errors beyond aggregated metrics](https://arxiv.org/abs/2605.13412)
...
### [45] [TokAlign++: Advancing Vocabulary Adaptation via Better Token Alignment](https://arxiv.org/abs/2605.13429)
...
### [46] [Pretraining Language Models with Subword Regularization: An Empirical Study of BPE Dropout in Low-Resource NLP](https://arxiv.org/abs/2605.13436)
...
### [47] [LongBEL: Long-Context and Document-Consistent Biomedical Entity Linking](https://arxiv.org/abs/2605.13451)
...
### [48] [PDCR: Perception-Decomposed Confidence Reward for Vision-Language Reasoning](https://arxiv.org/abs/2605.13467)
...
### [51] [Many-Shot CoT-ICL: Making In-Context Learning Truly Learn](https://arxiv.org/abs/2605.13511)
...
### [52] [Locale-Conditioned Few-Shot Prompting Mitigates Demonstration Regurgitation in On-Device PII Substitution with Small Language Models](https://arxiv.org/abs/2605.13538)
...
### [53] [Inducing Artificial Uncertainty in Language Models](https://arxiv.org/abs/2605.13595)
...
### [54] [Creativity Bias: How Machine Evaluation Struggles with Creativity in Literary Translations](https://arxiv.org/abs/2605.13596)
...
### [55] [Edit-level Majority Voting Mitigates Over-Correction in LLM-based Grammatical Error Correction](https://arxiv.org/abs/2605.13624)
...
### [56] [Prefix Teach, Suffix Fade: Local Teachability Collapse in Strong-to-Weak On-Policy Distillation](https://arxiv.org/abs/2605.13643)
...
### [57] [FlowCompile: An Optimizing Compiler for Structured LLM Workflows](https://arxiv.org/abs/2605.13647)
...
### [66] [Creating Group Rules with AI: Human-AI Collaboration in WhatsApp Moderation](https://arxiv.org/abs/2605.12613)
...
### [67] [Co-Designing Organizational Justice Indicators for Algorithmic Systems](https://arxiv.org/abs/2605.12643)
...
### [68] [Quieting the Cobwebs: Browser Interaction for Visual Floaters](https://arxiv.org/abs/2605.12739)
...
### [69] [What Do You Think I Think? Accounting for Human Beliefs Using Second-Order Theory of Mind](https://arxiv.org/abs/2605.12745)
...
### [70] [Seed Bank, Co-op, Stoop Swap: Metaphors for Governing Language Model Data for Creative Writing](https://arxiv.org/abs/2605.12888)
...
### [71] [Magical Touch: Transforming Raw Capacitive Streams into Expressive Hand-Touchscreen Interaction](https://arxiv.org/abs/2605.12902)
...
### [72] [Discovery-Oriented Faceting: From Coverage to Blind-Spot Discovery](https://arxiv.org/abs/2605.12956)
*Youdi Li*
...
### [73] [Doppler Prompting for Stable mmWave-based Human Pose Estimation](https://arxiv.org/abs/2605.13233)
...
### [74] ["It became a self-fulfilling prophecy": How Lived Experiences are Entangled with AI Predictions in Menstrual Cycle Tracking Apps](https://arxiv.org/abs/2605.13261)
...
### [75] [Beyond VMAF: Towards Application-Specific Metrics for Teleoperation Video](https://arxiv.org/abs/2605.13525)
...
### [76] [Beyond Anthropomorphism: Exploring the Roles of Perceived Non-humanity and Structural Similarity in Deep Self-Disclosure Toward Generative AI](https://arxiv.org/abs/2605.13574)
*Satoru Shibuya*
...
### [77] [Humanwashing -- It Should Leave You Feeling Dirty](https://arxiv.org/abs/2605.13723)
...
### [78] ["Like Taking the Path of Least Resistance": Exploring the Impact of LLM Interaction on the Creative Process of Programming](https://arxiv.org/abs/2605.13776)
...
### [79] [Precautionary Governance of Autonomous AI: Legal Personhood as Functional Instrument](https://arxiv.org/abs/2605.12505)
*Karsten Brensing*
...
### [80] [Career Mobility of Planning Alumni in the United States: Evidence from Professional Profile Data using Large Language Models](https://arxiv.org/abs/2605.12618)
...
### [81] [MIRACLE_Multi-Agent Intelligent Regulation to Advance Collaborative Learning Environment](https://arxiv.org/abs/2605.12923)
...
### [82] [An Activity-Theoretical Approach to Teacher Professional Development in Pedagogical AI Agent Design](https://arxiv.org/abs/2605.12934)
...
### [83] [Not All Anquan Is the Same: A Terminological Proposal for Chinese Computer Science and Engineering](https://arxiv.org/abs/2605.13069)
*Xingyu Zhao*
...
### [84] [Context Matters: Auditing Gender Bias in T2I Generation through Risk-Tiered Use-Case Profiles](https://arxiv.org/abs/2605.13113)
...
### [85] [3C: Competition, Competence, and Collaboration for Women in Computing](https://arxiv.org/abs/2605.13251)
...
### [86] [Europe and the Geopolitics of AGI: The Need for a Preparedness Plan](https://arxiv.org/abs/2605.13634)
...
### [87] [Amplification to Synthesis: A Comparative Analysis of Cognitive Operations Before and After Generative AI](https://arxiv.org/abs/2605.13785)
...
### [88] [Can LLM Agents Simulate Dynamic Networks? A Case Study on Email Networks with Phishing Synthesis](https://arxiv.org/abs/2605.12507)
...
### [89] [Interoperability Effects: Extending DeFi Lending Risk Models to Multi-Chain Environments](https://arxiv.org/abs/2605.12508)
*Hasret Ozan Sevim*
...
### [90] [Representing Higher-Order Networks: A Survey of Graph-Based Frameworks](https://arxiv.org/abs/2605.12509)
...
### [91] [WhatsApp Vaccine Discourse (WhaVax): An Expert-Annotated Dataset and Benchmark for Health Misinformation Detection](https://arxiv.org/abs/2605.12510)
...
### [92] [Real-World Challenges in Fake News Detection: Dealing with Posts by Cold Users](https://arxiv.org/abs/2605.12511)
...
### [93] [Beyond Individual Mimicry: Constructing Human-Like Social network with Graph-Augmented LLM Agents](https://arxiv.org/abs/2605.12512)
...
### [94] [SP-GCRL: Influence Maximization on Incomplete Social Graphs](https://arxiv.org/abs/2605.12513)
...
### [95] [Structural Diversity Drives Disruptive Scientific Innovation](https://arxiv.org/abs/2605.12514)
...
### [96] [PERCEIVE: A Benchmark for Personalized Emotion and Communication Behavior Understanding on Social Media](https://arxiv.org/abs/2605.12525)
...
### [97] ["F*** You Biden": Cross-Partisan Electoral Toxicity on X](https://arxiv.org/abs/2605.12526)
...
### [98] [Linking Extreme Discourse to Structural Polarization in Signed Interaction Networks](https://arxiv.org/abs/2605.12814)
...
### [99] [When Do LLMs Generate Realistic Social Networks? A Multi-Dimensional Study of Culture, Language, Scale, and Method](https://arxiv.org/abs/2605.12898)
