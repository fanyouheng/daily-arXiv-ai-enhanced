...
### [7] [Gender Bias in LLMs: Preliminary Evidence from Shared Parenting Scenario in Czech Family Law](https://arxiv.org/abs/2601.05879)
...
### [8] [Tracing Moral Foundations in Large Language Models](https://arxiv.org/abs/2601.05437)
...
### [10] [Towards Valid Student Simulation with Large Language Models](https://arxiv.org/abs/2601.05473)
...
### [11] [The Facade of Truth: Uncovering and Mitigating LLM Susceptibility to Deceptive Evidence](https://arxiv.org/abs/2601.05478)
...
### [15] [Illusions of Confidence? Diagnosing LLM Truthfulness via Neighborhood Consistency](https://arxiv.org/abs/2601.05905)
...
### [19] [Generation-Based and Emotion-Reflected Memory Update: Creating the KEEM Dataset for Better Long-Term Conversation](https://arxiv.org/abs/2601.05548)
...
### [20] [ReasonAny: Incorporating Reasoning Capability to Any Model via Simple and Effective Model Merging](https://arxiv.org/abs/2601.05560)
...
### [21] [Can large language models interpret unstructured chat data on dynamic group decision-making processes? Evidence on joint destination choice](https://arxiv.org/abs/2601.05582)
...
### [22] [ACR: Adaptive Context Refactoring via Context Refactoring Operators for Multi-Turn Dialogue](https://arxiv.org/abs/2601.05589)
...
### [23] [Data Augmented Pipeline for Legal Information Extraction and Reasoning](https://arxiv.org/abs/2601.05609)
...
### [24] [Text Detoxification in isiXhosa and Yorùbá: A Cross-Lingual Machine Learning Approach for Low-Resource African Languages](https://arxiv.org/abs/2601.05624)
*Abayomi O. Agbeyangi*
...
### [25] [GIFT: Games as Informal Training for Generalizable LLMs](https://arxiv.org/abs/2601.05633)
...
### [26] [Multilingual Amnesia: On the Transferability of Unlearning in Multilingual LLMs](https://arxiv.org/abs/2601.05641)
...
### [27] [A Framework for Personalized Persuasiveness Prediction via Context-Aware User Profiling](https://arxiv.org/abs/2601.05654)
...
### [28] [Stephanie2: Thinking, Waiting, and Making Decisions Like Humans in Step-by-Step AI Social Chat](https://arxiv.org/abs/2601.05657)
...
### [29] [Afri-MCQA: Multimodal Cultural Question Answering for African Languages](https://arxiv.org/abs/2601.05699)
...
### [30] [Multimodal In-context Learning for ASR of Low-resource Languages](https://arxiv.org/abs/2601.05707)
...
### [31] [Visualising Information Flow in Word Embeddings with Diffusion Tensor Imaging](https://arxiv.org/abs/2601.05713)
*Thomas Fabian*
...
### [32] [Analysing Differences in Persuasive Language in LLM-Generated Text: Uncovering Stereotypical Gender Patterns](https://arxiv.org/abs/2601.05751)
...
### [33] [AutoMonitor-Bench: Evaluating the Reliability of LLM-Based Misbehavior Monitor](https://arxiv.org/abs/2601.05752)
...
### [47] [An Empirical Study on Preference Tuning Generalization and Diversity Under Domain Shift](https://arxiv.org/abs/2601.05882)
...
### [48] [HAPS: Hierarchical LLM Routing with Joint Architecture and Parameter Search](https://arxiv.org/abs/2601.05903)
...
### [56] [Protosampling: Enabling Free-Form Convergence of Sampling and Prototyping through Canvas-Driven Visual AI Generation](https://arxiv.org/abs/2601.05401)
...
### [57] [Feedback Effects on Cognitive Dynamics: Network-Based Insights from EEG Patterns and Behavioral Performance](https://arxiv.org/abs/2601.05450)
...
### [58] [Secure Text Entry using a Virtual Radial Keyboard with Dynamically Resized Keys and Non-Intrusive Randomization](https://arxiv.org/abs/2601.05516)
...
### [59] [Productive Discussion Moves in Groups Addressing Controversial Issues](https://arxiv.org/abs/2601.05651)
...
### [60] [Advancing credit mobility through stakeholder-informed AI design and adoption](https://arxiv.org/abs/2601.05666)
...
### [61] [SAFE: Secure and Accurate Federated Learning for Privacy-Preserving Brain-Computer Interfaces](https://arxiv.org/abs/2601.05789)
...
### [62] [Decoding Workload and Agreement From EEG During Spoken Dialogue With Conversational AI](https://arxiv.org/abs/2601.05825)
...
### [63] [How to Analyse Interviews: A Documentary Method of Interpretation](https://arxiv.org/abs/2601.05871)
*Andy Crabtree*
...
### [64] [A Framework for Optimizing Human-Machine Interaction in Classification Systems](https://arxiv.org/abs/2601.05974)
...
### [65] [The LLM Mirage: Economic Interests and the Subversion of Weaponization Controls](https://arxiv.org/abs/2601.05307)
...
### [66] [Research Integrity and Academic Authority in the Age of Artificial Intelligence: From Discovery to Curation?](https://arxiv.org/abs/2601.05574)
...
### [67] [Cross-National Evidence of Disproportionate Media Visibility for the Radical Right in the 2024 European Elections](https://arxiv.org/abs/2601.05826)
...
### [68] [Can AI mediation improve democratic deliberation?](https://arxiv.org/abs/2601.05904)
...
### [69] [Navigating the Sociotechnical Imaginaries of Brazilian Tech Workers](https://arxiv.org/abs/2601.05961)
*Kenzo Soares Seto*
...
### [70] [The Causal Effect of First-Time Academic Failure on University Dropout: Evidence from a Regression Discontinuity Design](https://arxiv.org/abs/2601.05987)
*H. R. Paz*
...
### [71] [Optimizing Digital Adjudication through Social Network Analysis: An Empirical Study of Credit Card Disputes in Beijing](https://arxiv.org/abs/2601.05299)
...
### [72] [Mobility Trajectories from Network-Driven Markov Dynamics](https://arxiv.org/abs/2601.06020)
