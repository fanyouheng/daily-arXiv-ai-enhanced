...
### [7] [Aligning with Lived Experience: Heterogeneous Benefits of Fine Tuning in Mental Health Support Generation](https://arxiv.org/abs/2609.21075)
...
### [10] [Recursive Language Models Generalize Out of Domain](https://arxiv.org/abs/2609.20831)
...
### [11] [Moral Entropy: Auditing Bias and Uncertainty in Moral Judgment](https://arxiv.org/abs/2609.21992)
*Maciej Skorski*
...
### [12] [TatBLiMP: A Benchmark of Linguistic Minimal Pairs for Tatar](https://arxiv.org/abs/2609.20832)
...
### [13] [Transsion's Speaker-Attributed Multilingual ASR System for the MLC-SLM 2026 Challenge](https://arxiv.org/abs/2609.20833)
...
### [14] [Towards Secure Cloud-Native Computing: Unveiling Kubernetes Misconfigurations with Large Language Models](https://arxiv.org/abs/2609.20834)
...
### [16] [PhysioBench: A Unified Benchmark for Physiological Signal Question Answering](https://arxiv.org/abs/2609.20836)
...
### [24] [From Task Success to Productive Success: Evaluating Human-AI Collaboration by Quality and Cost](https://arxiv.org/abs/2609.21117)
...
### [25] [Reading Anxiety or Reading the Label? Comparing Fine-Tuned and Frontier Models for Anxiety Detection on Social Media](https://arxiv.org/abs/2609.20847)
...
### [26] [Enhancing Audio Reasoning via Semantic Summary Prediction](https://arxiv.org/abs/2609.20849)
...
### [27] [MME-Safety: A Fine-grained Benchmark for Safety Evaluation of MLLMs](https://arxiv.org/abs/2609.20850)
...
### [28] [Generative Artificial Intelligence Chatbots for Motivational Interviewing: A Scoping Review From System Design to Intervention Outcomes](https://arxiv.org/abs/2609.20902)
...
### [29] [$μ^2$-Bench: A Multilingual Machine Unlearning Benchmark](https://arxiv.org/abs/2609.20945)
...
### [30] [Geometry of Values: Task Vector Composition for Ethical Preference Alignment in Language Models](https://arxiv.org/abs/2609.21094)
...
### [71] [Two Fault Lines: Latent Polarity Geometry in X Community Notes](https://arxiv.org/abs/2609.21496)
...
### [72] [Setting the clock: Evaluating temporal window parameters for coordinated behavior detection](https://arxiv.org/abs/2609.21959)
...
### [73] [Auditing bipartite motif interpretations: a worked example with conservation checks and open-path decomposition](https://arxiv.org/abs/2609.22014)
*Tengfei Shao*
...
### [74] [Trustworthy FinAInce: Unpacking How AI-Mediated Financial Advice is Judged](https://arxiv.org/abs/2609.20989)
...
### [75] [Understanding How Educators Configure GenAI Support for Open-Ended Learning -- An Exploratory Study of K-12 Career Exploration](https://arxiv.org/abs/2609.21019)
...
### [76] [Decoding the Dashboard: Data Comics to Support Students' Understanding of Learning Analytics Visualisations](https://arxiv.org/abs/2609.21141)
...
### [77] [Exploring Text Classification Models with Sparse Autoencoders](https://arxiv.org/abs/2609.21142)
...
### [78] [Human Driver Temperament and the Safety Impact of a C-V2X Denial-of-Service Flooding Attack in Mixed-Autonomy Traffic](https://arxiv.org/abs/2609.21206)
...
### [79] [Self-Care and Mental Health: Mapping Over A Decade of HCI Interventions](https://arxiv.org/abs/2609.21239)
...
### [80] [Two's a Crowd: Human and AI-Based Copresence for Developers with ADHD](https://arxiv.org/abs/2609.21254)
...
### [81] [GUIDE: Designer-in-the-loop Authoring of Conformant Generative User Interfaces](https://arxiv.org/abs/2609.21285)
...
### [82] [AESSI: An Around-Ear Silent Speech Interface for Cross-Day Online Reuse without Test-Day Calibration](https://arxiv.org/abs/2609.21436)
...
### [83] [People escalate against a competitor labelled human and hold back against one labelled an optimising machine](https://arxiv.org/abs/2609.21439)
...
### [84] [Do We Care About Personalization and Explainability? An Interview Study with News Recommendation Engineers](https://arxiv.org/abs/2609.21547)
...
### [85] [Notrix: Understanding Machine Learning Solutions Across Computational Notebooks at Scale](https://arxiv.org/abs/2609.21775)
...
### [86] [Comparing Hand and Controller Avatars with Hand Tracking and Controller-Based Interaction](https://arxiv.org/abs/2609.21799)
...
### [87] [An Agentic Just-in-Time Adaptive Intervention System for Personalized Sleep Support: Proof-of-Concept Study with N of 1 Data](https://arxiv.org/abs/2609.21805)
...
### [88] [Touvigation: Embodied Adaptive Object Acquisition for Blind and Low-Vision Users in Unfamiliar Indoor Environments](https://arxiv.org/abs/2609.21828)
...
### [89] [Beyond Counting Blessings: Tracing the Evolution of Gratitude Practices and Technology Needs](https://arxiv.org/abs/2609.21853)
...
### [90] [Comparing Haptic Feedback Across Hand Tracking and Controllers in VR Object Interaction Tasks](https://arxiv.org/abs/2609.21869)
...
### [91] [Depressive symptoms are reflected differently across digital contexts](https://arxiv.org/abs/2609.21919)
...
### [92] [Can I Trust My Body? A Three-Year Autoethnography of ChatGPT's Place in My Support System for Panic Attacks](https://arxiv.org/abs/2609.21925)
...
### [93] [Beyond Reactive Assistance: PV-Care Using Low-Density EEG and AI to Provide Proactive, Context-Aware Help for MCI](https://arxiv.org/abs/2609.22024)
...
### [94] [Gricea: An Open Science Platform for Conversational AI Research](https://arxiv.org/abs/2609.22039)
...
### [95] [Value-Sensitive Delegation in Everyday AI Agent Use: Evidence from OpenClaw](https://arxiv.org/abs/2609.22067)
...
### [96] [A Sociotechnical Review of Algorithms in Health Systems: Technical, Cost, and Human-Centered Considerations](https://arxiv.org/abs/2609.22070)
