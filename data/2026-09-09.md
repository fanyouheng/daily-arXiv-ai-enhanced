...
### [17] [Reliability, validity, and diagnostic evidence for multi-model LLM short-answer scoring](https://arxiv.org/abs/2609.06315)
*Chunyi Zhao,Chao Li*
...
### [18] [From Narrative to Auditable Forecasts: A Structured Scaffold for Agentic Forecasting](https://arxiv.org/abs/2609.05905)
...
### [19] [UniRRM: Unified Reasoning Reward Models Across Languages and Evaluation Paradigms](https://arxiv.org/abs/2609.05910)
...
### [20] [Neuron-Guided Fine-Tuning: Unlocking Efficient Alignment Mechanisms for Large Language Models](https://arxiv.org/abs/2609.05913)
...
### [21] [Navigating the digital spectrum: Assessing political bias, stability, and downstream fairness in Large Language Models](https://arxiv.org/abs/2609.08637)
...
### [22] [Solving versus Verifying: Catching Contradictions in Tax Reasoning Systems](https://arxiv.org/abs/2609.05928)
...
### [23] [The Audit Decides the Verdict: Instrument Effects Rival Demographic Bias in LLM Decision Audits](https://arxiv.org/abs/2609.09048)
...
### [24] [SurveyAgent-HKA: A multi-agent framework for scientific survey generation with LLMs and human knowledge augmentation](https://arxiv.org/abs/2609.05938)
...
### [25] [The Blindness of Document-Level Translation Evaluation](https://arxiv.org/abs/2609.05949)
...
### [26] [Beyond Cross-Lingual Transfer: Benchmarking Propagation Boundaries in Multilingual LLM Unlearning](https://arxiv.org/abs/2609.05976)
...
### [27] [Alignment by Stereotyping: How LLMs Sacrifice Individual Distinctiveness for Cultural Adaptation](https://arxiv.org/abs/2609.05993)
...
### [28] [ModularPhaseNet: Finite-Cyclic Phase Geometry for Computable Semantic Hierarchy, Direction, and Context Consistency in Standard Transformers](https://arxiv.org/abs/2609.06000)
...
### [29] [Tri-PvP: Exposing Modality Bias in Omni-Modal Large Language Models through Perceptual-Propositional Evidence Conflicts](https://arxiv.org/abs/2609.06011)
...
### [30] [Factors Influencing the Emergence of Dependency Length Minimization in Neural Agent Simulations](https://arxiv.org/abs/2609.06025)
...
### [31] [Generating Adversarial Texts for Machine Translation via GRPO](https://arxiv.org/abs/2609.06048)
...
### [32] [Don't Lose Entities from Retrieval to Generation: Dual Entity Recovery RAG for multi-hop QA](https://arxiv.org/abs/2609.06065)
...
### [33] [DPH Parser: A Bottom-Up Grammar-Driven Parser for Joint Constituency and Dependency Analysis](https://arxiv.org/abs/2609.06070)
*Hussein Ghaly*
...
### [34] [From Two Passes to One: Compact and Efficient Target-Stance Extraction](https://arxiv.org/abs/2609.06108)
...
### [42] [InsightChain: Optimized Chain-of-Insight Analytics for LLM-driven Data Visualization](https://arxiv.org/abs/2609.06438)
...
### [44] [Marginal Fidelity Does Not Establish User Simulation in Demographic Synthetic Survey Panels: Response Contracts, Support Collapse and Conditioning Failure](https://arxiv.org/abs/2609.07305)
*Alexander Doudkin*
...
### [45] [Cross-Lingual Representation Alignment by Token-Level Optimal Transport in a Language-Agnostic Space](https://arxiv.org/abs/2609.06381)
...
### [46] [How AI Models Manage Epistemic Authority: A Taxonomy and Comparative Analysis of Responses to User Disagreement](https://arxiv.org/abs/2609.07662)
...
### [47] [Hierarchical Wasserstein Merging for Multi-Domain Multi-Task Learning: From Specialists to a Generalist](https://arxiv.org/abs/2609.06406)
...
### [48] [Performance of Clinical AI System and Physicians and Frontier Language Models in primary care diagnostics](https://arxiv.org/abs/2609.09070)
...
### [49] [Visual Search Augmented Chain-of-Thought Reasoning for Attribute Value Extraction from Product Videos](https://arxiv.org/abs/2609.06410)
...
### [50] [Decomposing LLM-Judge Uncertainty to Target Expert Labels](https://arxiv.org/abs/2609.06444)
*Ryan Lail*
...
### [51] [DFlow: Enabling Verifier Information Flow in Block Diffusion Speculative Decoding](https://arxiv.org/abs/2609.06498)
...
### [52] [ProcArena: A Multi-Scenario Benchmark for LLMs on Direct and Interactive PL/SQL Development from Natural Language](https://arxiv.org/abs/2609.06527)
...
### [53] [LLMs Mirror Country-Specific Gender Patterns If Asked, but Skew Male When Generating Media in Local Languages](https://arxiv.org/abs/2609.06545)
...
### [54] [Discovering Translation-Worthy Languages with E-Values](https://arxiv.org/abs/2609.06593)
...
### [55] [SAGE: A Hierarchical Framework for Evaluating Interpretive Literary Quality in Narratives](https://arxiv.org/abs/2609.06611)
...
### [56] [Mind the Gap: Exposing LLM Translation Blind Spots Using the AlphaMWE Multilingual Parallel Corpus](https://arxiv.org/abs/2609.06634)
...
### [57] [ECOKV: Geometry-Aware KV Cache Eviction via Complementary Diversity Metrics](https://arxiv.org/abs/2609.06663)
...
### [58] [A Grapheme-Aware Indic Tokenizer for Tamil: Large-Scale Training and Intrinsic Evaluation](https://arxiv.org/abs/2609.06690)
...
### [59] [PARSER: Read in Parallel, Reason in Depth for Long-Context LLM Agents](https://arxiv.org/abs/2609.06702)
...
### [60] [DianShi-RxnDB: A Large-Scale, Fine-Grained Organic Reaction Data Platform Built via a Fully Automated Pipeline for Researchers and AI Agents](https://arxiv.org/abs/2609.06703)
...
### [62] [AuthBench: A Large-Scale Multilingual Benchmark for Authorship Representation across Genres and Lengths](https://arxiv.org/abs/2609.06771)
...
### [63] [Typed Federated Artifacts for the Agentic Web:Sharing Tool-Routing Knowledge Across Frozen,Heterogeneous LLM Agents](https://arxiv.org/abs/2609.06815)
...
### [64] [XYBench: Can LLMs Respond Pragmatically to Queries with Misconceptions?](https://arxiv.org/abs/2609.06842)
...
### [65] [You Are What You Read: Misalignment via In-Context Persona Induction](https://arxiv.org/abs/2609.06851)
...
### [66] [AutoLexSteer: Automatic Contrast Construction for Lexical Activation Steering](https://arxiv.org/abs/2609.06879)
...
### [67] [Towards Bridging the Gap Between Offline and Iterative Alignment via Preference Distillation](https://arxiv.org/abs/2609.06893)
...
### [68] [Dynamic-Programming-Guided Hierarchical BPE and Empirical Analysis of Vocabulary Pruning](https://arxiv.org/abs/2609.06898)
*Kenny Shao*
...
### [69] [TurEngMix: A Text Corpus and Benchmark for Turkish-English Code-Mixed Language Identification and Named Entity Recognition](https://arxiv.org/abs/2609.06963)
...
### [70] [CantoneseLLM v2: Reasoning in a Low-Resource Language](https://arxiv.org/abs/2609.06970)
...
### [71] [Train Overcomplete, Deploy Compact: Scaling Recovery Capacity for Structured LLM Pruning](https://arxiv.org/abs/2609.06974)
...
### [72] [Aha-Flow Distillation: Flow Markers Matter in LLM Reasoning](https://arxiv.org/abs/2609.07036)
...
### [73] [A Hyperbolicity Atlas of Large Language Model Hidden States](https://arxiv.org/abs/2609.07053)
...
### [74] [Where to Look and What to Use: Retrieve-Localize-Generate for Long-Term Conversational Memory Question Answering](https://arxiv.org/abs/2609.07093)
...
### [75] [Revisiting Complete Reasoning Traces for Post-Training](https://arxiv.org/abs/2609.07103)
...
### [76] [The Illusion of Debiasing: Persona Steering Redistributes Rather Than Reduces Bias in LLMs](https://arxiv.org/abs/2609.07117)
...
### [77] [PTCG: Persona-guided Tree-based Counterargument Generation](https://arxiv.org/abs/2609.07120)
...
### [78] [Line-Coupled Language Model](https://arxiv.org/abs/2609.07129)
...
### [79] [Retrieval-Augmented Multi-Prompt Ensemble for Minor-Grain Breeding Information Extraction](https://arxiv.org/abs/2609.07134)
...
### [80] [Vishing-Tactics-Bench: Forecasting Exploitation Trajectories in Voice Phishing Calls](https://arxiv.org/abs/2609.07151)
...
### [81] [FreqBLiMP: Frequency-Controlled Minimal Pairs Reveal Robustness and Fragility of LLMs Under Lexical Rarity](https://arxiv.org/abs/2609.07153)
...
### [82] [In-Place Instruction Following in Diffusion Language Models](https://arxiv.org/abs/2609.07160)
...
### [83] [CircuitLens: Reasoning Circuits as Data Selection Signals for Reinforcement Learning with Verifiable Rewards](https://arxiv.org/abs/2609.07183)
...
### [84] [SIFTING: A Novel LLM-Based Framework for Structured and Transparent Information Extraction from Clinical Free-Text Reports, with Application to Tumor Staging in Lung Cancer](https://arxiv.org/abs/2609.07185)
...
### [85] [CEDAR: Error-Bounded Residual Routing for Efficient Long-Context Attention](https://arxiv.org/abs/2609.07237)
...
### [86] [Separating Stream Stability from Long-Term Recall in Language Models](https://arxiv.org/abs/2609.07282)
...
### [87] [Probing the Structure and Dynamics of LLM Value Expression through Value Conflicts](https://arxiv.org/abs/2609.07296)
...
### [88] [RouteRelay: Event-Triggered Cross-Layer Route Reuse for Efficient Dynamic Sparse Attention](https://arxiv.org/abs/2609.07306)
...
### [89] [SPARROW: Scalable Taxonomy Induction via Structure-Preserving Partitioning and Constraint-Guided Merging](https://arxiv.org/abs/2609.07307)
...
### [90] [LANTERN: Language Model Assessment on Noisy and Transformed Tasks for Understanding Error and Robustness Nuances](https://arxiv.org/abs/2609.07309)
...
### [91] [Content-Based Addressing for Long Context](https://arxiv.org/abs/2609.07314)
*Mahesh Godavarti*
...
### [92] [BlueprintAgent: Constraint-Triggered Targeted Revisits for Simulation-Ready Generation from Scanned Structural Blueprints](https://arxiv.org/abs/2609.07362)
...
### [93] [Beyond Fluent Generation: A CPU Reliability Benchmark for MCP-Style Tool Calling in Sub-2B Small Language Models for Edge Deployment](https://arxiv.org/abs/2609.07370)
...
### [94] [Beyond Single-Negative Preference: Multi-Negative DPO for LLM-Centric Historical Entity Linking](https://arxiv.org/abs/2609.07379)
...
### [95] [An LLM-Associated Register Shift in Korean Journal Abstracts: A Morphology-Aware Excess-Vocabulary Study, 2018-2026](https://arxiv.org/abs/2609.07447)
*Aron Lee*
...
### [96] [FramingQA: Does the Question Shape the Answer? Measuring the Compositional Framing Effect](https://arxiv.org/abs/2609.07448)
...
### [97] [MEMO: Multimodal Evidence Memory Organization for Long-Horizon LLM Agents](https://arxiv.org/abs/2609.07471)
...
### [98] [Where Should Language Sit in a Multimodal Model? Lessons from What Language Does to Human Perception and Cognition](https://arxiv.org/abs/2609.07474)
*Peng Xie*
...
### [99] [Qwen-Audio-3.0-ASR Technical Report](https://arxiv.org/abs/2609.07549)
...
### [100] [We're Cooked! - Probing LLM Political Alignment Via Conflict-Framed Recipe Translation](https://arxiv.org/abs/2609.07568)
...
### [101] [Validating DBpedia Triple Sets for Natural Language Generation](https://arxiv.org/abs/2609.07589)
...
### [102] [ObGynLongBench: Revealing the Evidence-to-EHR Gap in Longitudinal EHR Decision-Making](https://arxiv.org/abs/2609.07601)
...
### [103] [The Art of Hierarchical Competing Patterns: Gaussian Process Optimization of Hyphenation](https://arxiv.org/abs/2609.07638)
...
### [104] [Syntactic Patterns and Stylistic Functions in Narrative Prose: A Rule-Based and Machine-Learning Approach](https://arxiv.org/abs/2609.07651)
*Stefana Janicijevic*
...
### [105] [Perspectives on Cross-Lingual Consistency in LLMs for Medical Questions](https://arxiv.org/abs/2609.07687)
...
### [106] [Fine PT-PT Web: A High-Quality 41 Billion Tokens Data Collection of the European Portuguese Web](https://arxiv.org/abs/2609.07699)
...
### [107] [DeepTable: Structural Attention Biases and Tree Path Encoding for Hierarchical Table Understanding](https://arxiv.org/abs/2609.07707)
...
### [108] [Translation Indeterminacy and the Distributional Fallacy](https://arxiv.org/abs/2609.07717)
*Michael Carl*
...
### [109] [From Echo Chambers to Epistemic Monoculture: Large Language Models Present Temporally Contingent Partisan Alignments as Knowledge](https://arxiv.org/abs/2609.07735)
*Wend K. Tam*
...
### [110] [LLM Forensics: Where Do Backdoors Hide? Localizing and Controlling Trigger Mechanisms with Sparse Autoencoders](https://arxiv.org/abs/2609.07746)
...
### [111] [Replicating a Disjoint-Set Union Experiment over Various Notions of Micro Units to assess Translation Effort](https://arxiv.org/abs/2609.07748)
*Michael Carl*
...
### [112] [Bag of Tricks or Bag of Myths? Reducing Modeling Complexity with Task Knowledge in Explainable Suicide Risk Assessment](https://arxiv.org/abs/2609.07766)
...
### [113] [Signed Rescue Routing: Harm-Aware Cascades for Efficient LLM Inference](https://arxiv.org/abs/2609.07786)
...
### [114] [LLM Agents as Computational Typologists](https://arxiv.org/abs/2609.07791)
...
### [115] [Does Syntax Matter? A Graph-Augmented Variational Topic Model for Computational Social Sciences](https://arxiv.org/abs/2609.07797)
...
### [116] [Climate-ModernBERT: Revisiting Corpus Composition for Domain-Adaptive Continued Pretraining](https://arxiv.org/abs/2609.07798)
...
### [117] [You Can't Prefer Emotions You Don't Sample: Intensity Undershoot in DPO-Tuned LLMs](https://arxiv.org/abs/2609.07808)
...
### [118] [A*-Thought-V2: Efficient Latent Reasoning via Geometric Dynamics of LLM](https://arxiv.org/abs/2609.07821)
...
### [119] [LLM Layers Immediately Correct Each Other](https://arxiv.org/abs/2609.07876)
...
### [120] [Deadline-Aware Adaptive Prefill Chunking for Efficient Large Language Model Serving](https://arxiv.org/abs/2609.07883)
...
### [121] [Rethinking Sign Language Translation: The Impact of Signer Dependence on Model Evaluation](https://arxiv.org/abs/2609.07965)
...
### [122] [Reasoning Beyond Transcription: Audio Language Models on Child Stuttering Speech](https://arxiv.org/abs/2609.07968)
...
### [123] [MeRoTune: RoPE-Safe Merging with a Tunable Dial](https://arxiv.org/abs/2609.07971)
*Salman Faroz*
...
### [124] [BanglaMemeX: Advancing Cultural Metaphoric Image Interpretation in Bangla with a Multimodal Explainable Dataset](https://arxiv.org/abs/2609.08029)
...
### [125] [Popular Knowledge Propagates More Errors in LLM Knowledge Updating](https://arxiv.org/abs/2609.08067)
...
### [126] [Vectorizer: Vectorizing NumPy Programs with Shape-Guided Rewrite](https://arxiv.org/abs/2609.08088)
...
### [127] [Jacap: Robust KV Cache Eviction via Jacobian-Based Nonlinear Information Capacity Preservation](https://arxiv.org/abs/2609.08131)
...
### [128] [IGT @ FinMMEval 2026 Task 2: Question-Type Prompting with Targeted Extraction for Multilingual Financial QA](https://arxiv.org/abs/2609.08139)
*Yuwen Chiu*
...
### [129] [ConversationalVoice: Full-Duplex Speech Data from Real Conversations through Source-Faithful Reconstruction and Conversation-Grounded Expansion](https://arxiv.org/abs/2609.08147)
...
### [130] [When Metrics Reward the Worst Translations: Internalizing Cultural Reasoning for Social Media Translation Evaluation](https://arxiv.org/abs/2609.08156)
...
### [131] [Snugi-AI-v2 @ eRisk 2026 Task 2: Early Depression Detection via a Learned Stopping Policy with Sustained Confidence Gate](https://arxiv.org/abs/2609.08161)
*Yuwen Chiu*
...
### [132] [EviSI: An Evaluation Agent for Simultaneous Interpreting](https://arxiv.org/abs/2609.08171)
...
### [133] [NeoHorse-1: Towards Recursive Self-Improvement via Agentic Post-Training with Routing Harness](https://arxiv.org/abs/2609.08183)
...
### [134] [What Eviction Destroys: A Restore-Counterfactual Audit of Forgetting in Agent Memory](https://arxiv.org/abs/2609.08279)
*Chen Shen*
...
### [135] [Tracing Stereotypes from Representation to Output in Multilingual LLMs](https://arxiv.org/abs/2609.08322)
...
### [136] [SentryLine: Evidence-Grounded Question Answering over Evolving Documents in Oncology Care](https://arxiv.org/abs/2609.08364)
...
### [137] [Reading a Legal Question Word by Word: Embedding Trajectories of 2,144 Vietnamese Legal Headlines](https://arxiv.org/abs/2609.08372)
*Tran Minh Quan*
...
### [138] [Structural Jailbreaks Generalize but Do Not Compound: A cross-provider and multilingual study of Involuntary In-Context Learning](https://arxiv.org/abs/2609.08373)
*Tejasvi C. Addagada*
...
### [139] [Compositional Multilingual and Behavioral Attribute Steering](https://arxiv.org/abs/2609.08410)
...
### [140] [Detecting Authorship in Political Texts with Inductive Stylometry](https://arxiv.org/abs/2609.08459)
...
### [141] [Do Reviewers Still Reward Lexical Complexity? A Frozen-Rater Study of Preference Drift in 124K ICLR Reviews](https://arxiv.org/abs/2609.08475)
*Jiabin Zheng*
...
### [142] [Same Values, Different Languages? From Multilingual Probing to Steering LLMs Toward Chinese Social Values](https://arxiv.org/abs/2609.08515)
...
### [143] [CreaMem: A Scene-Aware Memory Architecture for Personalized Agents](https://arxiv.org/abs/2609.08550)
...
### [144] [Do New Attention Mechanisms Actually Fix Attention Sinks at Million-Token Context?](https://arxiv.org/abs/2609.08574)
...
### [145] [Which Forms of Caregiver Feedback Support Grammar Learning? A Reinforcement-Learning Study of Child-Like Language Models](https://arxiv.org/abs/2609.08576)
...
### [146] [Limitations of Automated Simulatability: LLM Simulators Can Bypass Explanations](https://arxiv.org/abs/2609.08585)
...
### [147] [Dynamics of meaning: Towards the Evaluation of Diachronic Semantic Change in Sinhala](https://arxiv.org/abs/2609.08609)
...
### [148] [Combating Instruction Conflict via Energy-Driven Latent Conflict Detection](https://arxiv.org/abs/2609.08646)
...
### [149] [When Victorian Becomes a Prompt: Literary Periodization as a Generative Constraint in 100 AI-Generated Novels](https://arxiv.org/abs/2609.08689)
...
### [150] [Global Divergence, Local Convergence: Representation Geometry in SSMs and Transformers](https://arxiv.org/abs/2609.08692)
...
### [151] [Record Grouping Controls Evidence Weight in Language Models](https://arxiv.org/abs/2609.08698)
...
### [152] [Improving Term Evaluation in Machine Translation: Variation Matters](https://arxiv.org/abs/2609.08779)
...
### [153] [Evolution of Multimodal Question Answering: From Modality-Adaptive Extraction to Unified Language Representation](https://arxiv.org/abs/2609.08896)
*Abdullah Al Shafi*
...
### [154] [Experience Funnel: A State-Policy Alternating Loop for Self-Evolving Agents](https://arxiv.org/abs/2609.08919)
...
### [155] [When Models Defer to Wrong Answers: A Robustness Audit of Source-Attributed Cues in Multiple-Choice QA](https://arxiv.org/abs/2609.08934)
...
### [156] [Evaluating and Improving Evidence-Grounded Fact-Checking in LLMs via Multi-Round Evidence Ablation](https://arxiv.org/abs/2609.08943)
...
### [157] [Evaluation of Contextual Understanding in Large Language Models](https://arxiv.org/abs/2609.09004)
...
### [163] [From Voice to Leverage in Data Governance. Building Enforceable Social License for Data ReUse](https://arxiv.org/abs/2609.05731)
*Stefaan G. Verhulst,Adam Zable,Begona Gonzalez Otero,Jacqueline Lu*
...
### [165] [Formalising Grassroots Social Contracts: From Legal Text to Grassroots Platforms](https://arxiv.org/abs/2609.06231)
...
### [166] [Ordinary, Reasonable Chatbots: Do AI Models Track Human Legal Judgments?](https://arxiv.org/abs/2609.06769)
...
### [167] [GreenPassport: Request-Level Carbon Accounting for Cross-Border AI Inference](https://arxiv.org/abs/2609.06784)
*Rui Lu*
...
### [168] [What a Model Refuses, a State Fears: How Authoritarian Information Control Reproduces in Language-Model Guardrails](https://arxiv.org/abs/2609.07507)
...
### [169] [Mapping the Emerging Social Science of Large Language Models](https://arxiv.org/abs/2609.07598)
...
### [170] [Near-Term Verification Methods for AI Chip Exports](https://arxiv.org/abs/2609.07637)
...
### [172] [An emancipatory vision for designing (generative) AI for learner flourishing](https://arxiv.org/abs/2609.07715)
...
### [173] [When Is Content "AI-Generated Enough"? Labelling Synthetic Media under the Digital Services Act and the AI Act](https://arxiv.org/abs/2609.07727)
...
### [174] [Silent Revision: Measuring Undisclosed Change in the Safety Frameworks of Frontier AI Developers](https://arxiv.org/abs/2609.08789)
*Louis Yiven Zhu*
...
### [175] [What AI Benchmarks Actually Measure: Adapting Convergent and Discriminant Validity to Interrogate Fifty-Six AI Benchmarks](https://arxiv.org/abs/2609.08812)
...
### [176] [Seeing Without Understanding: Large Language Model Evaluation of Mobile User Interface Quality, Failure Taxonomy, and Architectural Explanation](https://arxiv.org/abs/2609.05423)
...
### [177] [Companion AI and Ethical Design: Learning from System Failures and User Desires](https://arxiv.org/abs/2609.05432)
...
### [178] [From Sensor Data to Classroom Inquiry: GenAI-Supported Exploration of School Digital Twin Data](https://arxiv.org/abs/2609.05452)
...
### [179] [An Agent Model Abstraction for Human-AI Teaming Cognitive Coupling](https://arxiv.org/abs/2609.05552)
...
### [180] [Designing for Healthy, Affordable, and Sustainable Human-HVAC Interactions for Heating in Smart Homes](https://arxiv.org/abs/2609.07936)
*Delong Korus-Du*
...
### [181] [Will My Assistant Remember My Allergy? What Personal LLM Assistants Forget When Conversation Memory Is Compressed](https://arxiv.org/abs/2609.05767)
...
### [182] [Tactile Search: Enhancing Targeting in 3D Space](https://arxiv.org/abs/2609.05867)
...
### [183] [Art2Song: Enhancing Visual Art Appreciation with Contextual Music Generation](https://arxiv.org/abs/2609.06044)
...
### [184] [Flawed but Memorable: Student Critical Reception of Interest-Personalized GenAI Analogies in Computing Education](https://arxiv.org/abs/2609.06095)
...
### [185] [MM-SVGEdit: A Multimodal-Driven SVG Editing for UI Design](https://arxiv.org/abs/2609.06116)
...
### [186] [Adaptive Ecological Momentary Assessment with a Hybrid Language Model: Formative Expert Review and Retrospective Evaluation](https://arxiv.org/abs/2609.06269)
...
### [187] [FrankenReport: Early Exiting in Long-Form Generation Using Expected Value of Computation](https://arxiv.org/abs/2609.06320)
...
### [188] [Can People Distinguish Human and AI Agency in Humanoid Teleoperation? A Preliminary Study of Agency Perception](https://arxiv.org/abs/2609.06434)
...
### [189] [Disclosure and dissolution: explainability, AI power, and situated agency in understanding](https://arxiv.org/abs/2609.06495)
*Dee Matthews*
...
### [190] [The Effectiveness of Virtual Patient Simulation Versus Peer Simulation in Providing Sexual Counseling During Pregnancy: A Randomized Controlled Trial](https://arxiv.org/abs/2609.06662)
...
### [191] [The Interface of Theseus: The Rise of Just-In-Time Interfaces](https://arxiv.org/abs/2609.06770)
*Michael S. Bernstein*
...
### [192] [Adaptive Complementarity in Human-AI Systems: Architecture as a State-Shaping Choice](https://arxiv.org/abs/2609.07001)
*Babak Heydari*
...
### [193] [Living with AI Companions: Sustained AI Companionship Predicts Lower Well-Being Through Lower Human Interaction](https://arxiv.org/abs/2609.07243)
...
### [194] [From Human Factors to Human-Technology Factors: An HCI Perspective on Technology in Avalanche Safety](https://arxiv.org/abs/2609.07560)
...
### [195] [Large-Scale User Behavior Analysis in Multimodal AI-Assisted Manual Task Execution](https://arxiv.org/abs/2609.07594)
...
### [196] [Delusions and Harms Associated with AI Chatbot Use: Early Evidence from 185 Real-World Reports](https://arxiv.org/abs/2609.08027)
...
### [197] [JudgmentLens: Human-AI Sensemaking of Complex Legal Judgments](https://arxiv.org/abs/2609.07607)
...
### [198] [Situated Action in Pre-Hospital Critical Care Dispatch: Identifying where and how Algorithmic Assistance might be useful in the daily work of specialist Emergency Medical Dispatchers](https://arxiv.org/abs/2609.07705)
...
### [199] [Quantifying the Engagement Trap: Impact of Short-form Video Recommender Systems on Users with ADHD](https://arxiv.org/abs/2609.07795)
...
### [200] [Humans Introduce, Models Elaborate: Asymmetric Narrative Agency in Human-LLM Co-Writing](https://arxiv.org/abs/2609.07920)
...
### [201] [Representational Fidelity in Didactic Visualization: Toward a Multidimensional Design Space](https://arxiv.org/abs/2609.08037)
...
### [202] [StitchOver: Technical Embroidery on Seamed Fabrics](https://arxiv.org/abs/2609.08311)
...
### [203] ["Here Be Sharks!": Enhancing Scientific Communication and Analysis through Authoring Interactivity](https://arxiv.org/abs/2609.08386)
...
### [204] [Enhancing Communication in Speech Therapy: Exploring the Cognitive Synergy Between Gesture and Speech](https://arxiv.org/abs/2609.08486)
...
### [205] [Visualizing Colonial Regimes: A Multi-View Approach to (Historical) Political Transformation](https://arxiv.org/abs/2609.08518)
...
### [206] [Rescuing Performance from the Demo: Co-Designing Drum Gesture Mappings with a Percussionist](https://arxiv.org/abs/2609.08587)
...
### [207] [Healthcare Utilization, Chronic Condition Management, and Workplace Functioning Among Users of a Purpose-Built Mental Health AI (Ash): Cross-Sectional Study](https://arxiv.org/abs/2609.08890)
...
### [208] [To Stop or Not to Stop: Exploring the Intention-Behavior Gaps in Smartphone Usage](https://arxiv.org/abs/2609.08909)
...
### [209] [Embedded Human-Centered Data Science in a Graduate Programming Course: A Framework and Case Study](https://arxiv.org/abs/2609.08982)
...
### [210] [Location-Independent Robot-Assisted Finishing Using Digital Twins and Extended Reality](https://arxiv.org/abs/2609.09061)
...
### [211] [Travel Package Booking Application with API Bot](https://arxiv.org/abs/2609.09112)
...
### [212] [Reddit Community Interventions and Cross-Platform Response: Migration and Policy-Response Discourse on Voat](https://arxiv.org/abs/2609.05704)
*Shahan Ahmed*
...
### [213] [Polarity-Asymmetric Structural Calibration for Link Sign Prediction](https://arxiv.org/abs/2609.05896)
...
### [214] [Tracking and Predicting Evolution of Social Communities](https://arxiv.org/abs/2609.06713)
...
### [215] [How Well Do LLMs Simulate Survey Responses Following a Breast Cancer Screening Intervention?](https://arxiv.org/abs/2609.07141)
...
### [216] [Ex Ante Estimation of Payable Relief and Compensation Timing for Supplier Selection](https://arxiv.org/abs/2609.07293)
...
### [217] [LLMs for Social Network Modeling: From Network Generation to Dynamic Processes](https://arxiv.org/abs/2609.08049)
...
### [218] [The conservative turn in science: The changing character of knowledge recombination](https://arxiv.org/abs/2609.08468)
