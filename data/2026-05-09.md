...
### [9] [Cooperative Profiles Predict Multi-Agent LLM Team Performance in AI for Science Workflows](https://arxiv.org/abs/2604.20658)
...
### [14] [XL-SafetyBench: A Country-Grounded Cross-Cultural Benchmark for LLM Safety and Cultural Sensitivity](https://arxiv.org/abs/2605.05662)
...
### [18] [BioTool: A Comprehensive Tool-Calling Dataset for Enhancing Biomedical Capabilities of Large Language Models](https://arxiv.org/abs/2605.05758)
...
### [19] [Estimating the Black-box LLM Uncertainty with Distribution-Aligned Adversarial Distillation](https://arxiv.org/abs/2605.05777)
...
### [20] [Beyond Steering Vector: Flow-based Activation Steering for Inference-Time Intervention](https://arxiv.org/abs/2605.05892)
...
### [21] [Logic-Regularized Verifier Elicits Reasoning from LLMs](https://arxiv.org/abs/2605.05893)
...
### [22] [Minimizing Modality Gap from the Input Side: Your Speech LLM Can Be a Prosody-Aware Text LLM](https://arxiv.org/abs/2605.05927)
...
### [23] [Lightweight Stylistic Consistency Profiling: Robust Detection of LLM-Generated Textual Content for Multimedia Moderation](https://arxiv.org/abs/2605.05950)
...
### [24] [Hallucination as an Anomaly: Dynamic Intervention via Probabilistic Circuits](https://arxiv.org/abs/2605.05953)
...
### [25] [TableVista: Benchmarking Multimodal Table Reasoning under Visual and Structural Complexity](https://arxiv.org/abs/2605.05955)
...
### [26] [Tatarstan Toponyms: A Bilingual Dataset and Hybrid RAG System for Geospatial Question Answering](https://arxiv.org/abs/2605.05962)
...
### [27] [From Articles to Premises: Building PrimeFacts, an Extraction Methodology and Resource for Fact-Checking Evidence](https://arxiv.org/abs/2605.06006)
...
### [28] [More Aligned, Less Diverse? Analyzing the Grammar and Lexicon of Two Generations of LLMs](https://arxiv.org/abs/2605.06030)
...
### [29] [Navigating by Old Maps: The Pitfalls of Static Mechanistic Localization in LLM Post-Training](https://arxiv.org/abs/2605.06076)
...
### [30] [Milestone-Guided Policy Learning for Long-Horizon Language Agents](https://arxiv.org/abs/2605.06078)
...
### [31] [Uncovering Entity Identity Confusion in Multimodal Knowledge Editing](https://arxiv.org/abs/2605.06096)
...
### [32] [MemReranker: Reasoning-Aware Reranking for Agent Memory Retrieval](https://arxiv.org/abs/2605.06132)
...
### [33] [IRC-Bench: Recognizing Entities from Contextual Cues in First-Person Reminiscences](https://arxiv.org/abs/2605.06142)
...
### [34] [HNC: Leveraging Hard Negative Captions towards Models with Fine-Grained Visual-Linguistic Comprehension Capabilities](https://arxiv.org/abs/2605.06157)
...
### [35] [A$^2$TGPO: Agentic Turn-Group Policy Optimization with Adaptive Turn-level Clipping](https://arxiv.org/abs/2605.06200)
...
### [36] [TIDE: Every Layer Knows the Token Beneath the Context](https://arxiv.org/abs/2605.06216)
...
### [37] [UniPrefill: Universal Long-Context Prefill Acceleration via Block-wise Dynamic Sparsification](https://arxiv.org/abs/2605.06221)
...
### [38] [YEZE at SemEval-2026 Task 9: Detecting Multilingual, Multicultural and Multievent Online Polarization via Heterogeneous Ensembling](https://arxiv.org/abs/2605.06231)
...
### [39] [Rethinking RL for LLM Reasoning: It's Sparse Policy Selection, Not Capability Learning](https://arxiv.org/abs/2605.06241)
...
### [40] [Linear Semantic Segmentation for Low-Resource Spoken Dialects](https://arxiv.org/abs/2605.06276)
...
### [41] [Quantifying the Statistical Effect of Rubric Modifications on Human-Autorater Agreement](https://arxiv.org/abs/2605.06283)
...
### [42] [LatentRAG: Latent Reasoning and Retrieval for Efficient Agentic RAG](https://arxiv.org/abs/2605.06285)
...
### [43] [Log-Likelihood, Simpson's Paradox, and the Detection of Machine-Generated Text](https://arxiv.org/abs/2605.06294)
...
### [44] [MultiLinguahah : A New Unsupervised Multilingual Acoustic Laughter Segmentation Method](https://arxiv.org/abs/2605.06309)
...
### [67] [Making AI Drafts Count: A Quality Threshold in Audio Description Workflows](https://arxiv.org/abs/2605.05348)
...
### [68] [Every(bot) Makes Mistakes: Coding Big Five Personalities, Context, and Tone into an LLM Chatbot Recovery Code Framework](https://arxiv.org/abs/2605.05391)
...
### [69] [Why Someone Asked "Why": Foil Inference in Human and LLM Question Interpretation](https://arxiv.org/abs/2605.05401)
...
### [70] [The Ambivalent Experience of Eye Contact for People with Visual Impairments: Mechanisms and Design Challenges](https://arxiv.org/abs/2605.05437)
...
### [71] [Cross-individual generalizability of machine learning models for ball speed prediction in baseball pitching](https://arxiv.org/abs/2605.05487)
...
### [72] [Designing with Tensions: Older Adults' Emotional Support-Seeking Under System-Level Constraints in Conversational AI](https://arxiv.org/abs/2605.05552)
...
### [73] [UX in the Age of AI: Rethinking Evaluation Metrics Through a Statistical Lens](https://arxiv.org/abs/2605.05600)
*Harish Vijayakumar*
...
### [74] [The Capacity to Care: Designing Social Technology for Sustained Engagement With Societal Challenges](https://arxiv.org/abs/2605.05651)
...
### [75] [PersonaTeaming: Supporting Persona-Driven Red-Teaming for Generative AI](https://arxiv.org/abs/2605.05682)
...
### [76] [Priming, Path-dependence, and Plasticity: Understanding the molding of user-LLM interaction and its implications from (many) chat logs in the wild](https://arxiv.org/abs/2605.05767)
...
### [77] [GazeMind: A Gaze-Guided LLM Agent for Personalized Cognitive Load Assessment](https://arxiv.org/abs/2605.05790)
...
### [78] [Can providing feedback on gaze and mental-effort synchrony improve pair programming performance?](https://arxiv.org/abs/2605.05836)
...
### [79] [I see artifacts: ICA-based EEG artifact removal does not improve deep network decoding across three BCI tasks](https://arxiv.org/abs/2605.06018)
...
### [80] [EventColumn: Integrating Event Sequences into Tabular Visualizations](https://arxiv.org/abs/2605.06065)
...
### [81] [AffectGPT-RL: Revealing Roles of Reinforcement Learning in Open-Vocabulary Emotion Recognition](https://arxiv.org/abs/2605.06126)
...
### [82] [LearnMate^2: Design and Evaluation of an LLM-powered Personalized and Adaptive Support System for Online Learning](https://arxiv.org/abs/2605.06257)
...
### [83] [LLM-Based Educational Simulation: Evaluating Temporal Student Persona Stability Across ADHD Profiles](https://arxiv.org/abs/2605.06307)
...
### [84] [Human-AI Co-Evolution and Epistemic Collapse: A Dynamical Systems Perspective](https://arxiv.org/abs/2605.06347)
...
### [85] [SIGMA-ASL: Sensor-Integrated Multimodal Dataset for Sign Language Recognition](https://arxiv.org/abs/2605.06351)
...
### [86] [Predicting civil litigation outcomes and the evolution of case complexity and settlement dynamics](https://arxiv.org/abs/2605.06151)
...
### [87] [From Cradle to Cloud: A Life Cycle Review of AI's Environmental Footprint](https://arxiv.org/abs/2605.05416)
...
### [88] [LLMorphism: When humans come to see themselves as language models](https://arxiv.org/abs/2605.05419)
*Valerio Capraro*
...
### [89] [The Pedagogy of AI Mistakes: Fostering Higher-Order Thinking](https://arxiv.org/abs/2605.05472)
*Hadi Hosseini*
...
### [90] [Rigorous Interpretation Is a Form of Evaluation](https://arxiv.org/abs/2605.05508)
...
### [91] [The Missing Evaluation Axis: What 10,000 Student Submissions Reveal About AI Tutor Effectiveness](https://arxiv.org/abs/2605.05648)
...
### [92] [Breaking In and Reaching Out: Networking for Women in Computer Science](https://arxiv.org/abs/2605.06195)
*Shalini Chakraborty*
...
### [93] [A Benchmark for Strategic Auditee Gaming Under Continuous Compliance Monitoring](https://arxiv.org/abs/2605.06340)
*Florian A. D. Burnat,Brittany I. Davidson*
...
### [94] [From Review to Design: Ethical Multimodal Driver Monitoring Systems for Risk Mitigation, Incident Response, and Accountability in Automated Vehicles](https://arxiv.org/abs/2605.06439)
