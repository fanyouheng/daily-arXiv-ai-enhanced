...
### [9] [Most biomedical publications show signs of LLM-assisted writing](https://arxiv.org/abs/2608.10715)
...
### [10] [Multimodal Item Parameter Estimation using Simulated Response Probabilitie](https://arxiv.org/abs/2608.10154)
...
### [11] [Similarity Gates Approve Reversals: A Validity Audit of Embedding-Cosine Thresholds in Agent Systems](https://arxiv.org/abs/2608.10216)
*Scott E. Frias*
...
### [12] [Off-Axis, On Purpose: Where a Transformer Computes Concepts and Why it Does So](https://arxiv.org/abs/2608.10251)
*Mark Oskin*
...
### [13] [TAF-MED: Multi-Turn Safety Refusal Collapse in LLMs Under Declared Self-Treatment Intent](https://arxiv.org/abs/2608.10258)
...
### [14] [Locally Deployable Small Language Models for Emergency Department Decision Support: A Systematic Benchmark of Fine-Tuning Strategies](https://arxiv.org/abs/2608.10273)
...
### [15] [Cracks in the Foundation: Seemingly Minor Architectural Choices Impact Long Context Extension](https://arxiv.org/abs/2608.10296)
...
### [17] [Is This Your Final Answer? Cross-Contextual Consistency as a Measure of LLM Credibility](https://arxiv.org/abs/2608.10315)
...
### [18] [VisEditBench: Can Vision-Language Models Edit Visualization Code from Multimodal Feedback?](https://arxiv.org/abs/2608.10408)
...
### [19] [Templated or fully Synthetic? Prompt construction as a confound in measuring LLM political stance beyond writing assistance](https://arxiv.org/abs/2608.11008)
*Ilias Chalkidis*
...
### [20] [How Robust Are LLMs to Vietnamese Dialects?](https://arxiv.org/abs/2608.10414)
...
### [21] [From Interpretability to Control: Insights from Six Years of the TrustNLP Workshop](https://arxiv.org/abs/2608.11171)
...
### [27] [Leveraging Human Reading Behavior for Keyphrase Extraction: A Webcam-based Eye-tracking Corpus](https://arxiv.org/abs/2608.10688)
...
### [28] [Simplex Relaxation for Discrete Diffusion](https://arxiv.org/abs/2608.10615)
...
### [29] [Dual-Loop Self-Evolution via Verifiable Emotion Feedback for Multi-Turn Empathetic Dialogue](https://arxiv.org/abs/2608.10626)
...
### [30] [Decomposition-Induced Context-Memory Conflict: When Fact-Checking Pipelines Contradict Their Own Source Text](https://arxiv.org/abs/2608.10627)
*Yu-Feng Yen*
...
### [31] [Seeds Before Objectives: Rethinking Evaluation for Low-Resource Garhwali ASR](https://arxiv.org/abs/2608.10670)
...
### [32] [Auditing Chinese Web-scale Corpora via Sampled BPE Token Statistics](https://arxiv.org/abs/2608.10678)
...
### [59] [How to Dogfood Your AI Chat Agent: A Three-Layer Evaluation Framework with Goal-Directed NPC Simulation](https://arxiv.org/abs/2608.09939)
...
### [60] [The impact of design factors of virtual and augmented reality on tertiary students user experience in Metaverse](https://arxiv.org/abs/2608.09940)
...
### [61] [EweAcT: Ewe behaviour aligned to accelerometer data for activity monitoring in extensive grazing systems](https://arxiv.org/abs/2608.09943)
...
### [62] [Navigation Alone Is Not Enough: Evaluating Explanatory Assistive UI Agents](https://arxiv.org/abs/2608.09944)
*Santosh Patapati*
...
### [63] [Co-Lecturing With the DED: Explaining Circuit Design via the Draw Encode Display Loop](https://arxiv.org/abs/2608.09945)
...
### [64] [HoosierHelp: Benchmarking LLM Agents for Social Service Navigation](https://arxiv.org/abs/2608.09946)
...
### [65] [Mapping Multimodal Pilot Stress and Fatigue During Flight Sessions](https://arxiv.org/abs/2608.09947)
...
### [66] [Immersive Micromanipulation Integrating Pipette and Injector Operations with McKibben-Based Haptic Sensations for Workload Reduction](https://arxiv.org/abs/2608.10033)
...
### [67] [Outer Limits: An Experimental Approach to Controlled Content Manipulation within the Reddit Interface](https://arxiv.org/abs/2608.10115)
...
### [68] [Predicting affective connotation of visualizations from their constituent colors](https://arxiv.org/abs/2608.10169)
...
### [69] [Fine-Tuning Large Language Models for Codebook-Guided Coding of Students' Mathematics Metaphor Responses](https://arxiv.org/abs/2608.10276)
...
### [70] [Divided Attention Amplifies the Importance of Expectation-Aligned Visualization Design](https://arxiv.org/abs/2608.10320)
...
### [71] [Narrative Keyframing for Generative Creative Writing](https://arxiv.org/abs/2608.10337)
...
### [72] [ResonaVis: Visualizing Interactive Music Data to Support Reflective Music Composition for Therapeutic Contexts](https://arxiv.org/abs/2608.10338)
...
### [73] [MazzikaAI: A knowledge-based performance-to-prompt compiler for real-time Arabic maqam accompaniment with a streaming text-to-music model](https://arxiv.org/abs/2608.10360)
...
### [74] [Visual-to-Haptic Augmentation in XR: A Wearable Glove for Perceptual Grounding in Multimodal Interaction](https://arxiv.org/abs/2608.10368)
...
### [75] [Automatic Field-of-View Adjustment for a View-Expansive Microscope via LSTM-Based Gaze and Pipette Motion Interpretation](https://arxiv.org/abs/2608.10401)
...
### [76] [When the Interviewer Is a Bot: Behavior, Breakdowns, and Trust in MLLM-Led Interviews](https://arxiv.org/abs/2608.10412)
...
### [77] [Elbow Angle Guidance System Based on Surface Haptic Sensations Elicited by Lightweight Wearable Fabric Actuator](https://arxiv.org/abs/2608.10404)
...
### [78] [AI-Generated Interactive Fiction for Educational Use: A Pilot Study of Perceived Comprehensibility, Coherence, and Engagement](https://arxiv.org/abs/2608.10818)
...
### [79] [What We Know about Responsible AI Practices in Industry: A Half Decade of Empirical Research](https://arxiv.org/abs/2608.10431)
...
### [80] [Stay or Stray - A Dynamical Systems Viewpoint of Popularity Bias](https://arxiv.org/abs/2608.10474)
...
### [81] [ProtoGIB-Workload: Learning Workload-Specific Neural Topology Prototypes across Subjects](https://arxiv.org/abs/2608.10647)
...
### [82] [Longitudinal Evidence That General-Purpose Chatbots Actively Foster Relational Engagement](https://arxiv.org/abs/2608.10672)
...
### [83] [The Signal Rail: A Deterministic Motion Grammar for Communicating Conversational Agent State in Terminal Interfaces](https://arxiv.org/abs/2608.10689)
*Matteo Grella*
...
### [84] [Playable Pressure: Affective Dramaturgy and Selective Realism in the Design of a VR Emergency-Response Serious Game](https://arxiv.org/abs/2608.10763)
*Jan K. Argasiński*
...
### [85] [Context and Symmetry in Auditing: A Case Study of Skeleton Inference in Motion Capture](https://arxiv.org/abs/2608.10194)
...
### [86] [Who Gets Heeded? An Obligation-Level Audit of Responsiveness in EPA Rulemaking](https://arxiv.org/abs/2608.10329)
*Jianing Fan,Yue Yao*
...
### [87] [Inferential Capability Does Not Determine Legal Scope](https://arxiv.org/abs/2608.10601)
*Nicola Fabiano*
...
### [88] [Smart Enough to Go Extinct? An Evolutionary Challenge to the Value of General Intelligence and Its Ethical Implications for AGI](https://arxiv.org/abs/2608.10730)
*David Klotz*
...
### [89] [The GenAI Catch-22: Use of Generative Artificial Intelligence in Norwegian Newsrooms During the 2025 Parliamentary Election](https://arxiv.org/abs/2608.10773)
...
### [90] [Technology, education and critical media literacy: potential, challenges, and opportunities](https://arxiv.org/abs/2608.10778)
...
### [91] [Policy Convergence and Divergence Across National and Within Regional AI Strategies: A Policy Design Element Analysis](https://arxiv.org/abs/2608.11006)
...
### [92] [Who Uses Open-Weight Models? China and the Shifting Geography of AI in Science](https://arxiv.org/abs/2608.11090)
...
### [93] [Mediatised Participation: Citizen Journalism and the Decline in User-Generated Content in Online News Media](https://arxiv.org/abs/2608.11159)
...
### [94] [Ollivier's Ricci Curvature on Complex-weighted Graphs](https://arxiv.org/abs/2608.10132)
...
### [95] [FUBU-EPSTEIN: A Large-Scale Twitter Dataset on the Jeffrey Epstein Case and Its Global Public Discourse (2019-2023)](https://arxiv.org/abs/2608.10210)
...
### [96] [A Graph Approach to the Academic Publishing Network: A Heterogeneous Model and Structural Screening over OpenAlex Open Data](https://arxiv.org/abs/2608.10774)
...
### [97] [Shaping the notion of #wellbeing in the therapy culture context: an analysis through Instagram narratives](https://arxiv.org/abs/2608.10793)
...
### [98] [MARS: A framework for modelling register-based social networks](https://arxiv.org/abs/2608.10946)
