...
### [8] [Stance Labels Fail When They Matter Most: The Projection Problem in Stance Detection](https://arxiv.org/abs/2603.24231)
*Bowen Zhang*
...
### [9] [Berta: an open-source, modular tool for AI-enabled clinical documentation](https://arxiv.org/abs/2603.23513)
...
### [10] [DepthCharge: A Domain-Agnostic Framework for Measuring Depth-Dependent Knowledge in Large Language Models](https://arxiv.org/abs/2603.23514)
*Alexander Sheppert*
...
### [12] [MSA: Memory Sparse Attention for Efficient End-to-End Memory Model Scaling to 100M Tokens](https://arxiv.org/abs/2603.23516)
...
### [13] [Cluster-R1: Large Reasoning Models Are Instruction-following Clustering Agents](https://arxiv.org/abs/2603.23518)
...
### [16] [BeliefShift: Benchmarking Temporal Belief Consistency and Opinion Drift in LLM Agents](https://arxiv.org/abs/2603.23848)
...
### [18] [When AI Meets Early Childhood Education: Large Language Models as Assessment Teammates in Chinese Preschools](https://arxiv.org/abs/2603.24389)
...
### [20] [Representation Learning to Study Temporal Dynamics in Tutorial Scaffolding](https://arxiv.org/abs/2603.24535)
...
### [22] [Retrieval Improvements Do Not Guarantee Better Answers: A Study of RAG for AI Policy QA](https://arxiv.org/abs/2603.24580)
...
### [23] [Navigating the Concept Space of Language Models](https://arxiv.org/abs/2603.23524)
...
### [24] [Prompt Compression in Production Task Orchestration: A Pre-Registered Randomized Trial](https://arxiv.org/abs/2603.23525)
...
### [25] [Plato's Cave: A Human-Centered Research Verification System](https://arxiv.org/abs/2603.23526)
...
### [26] [Compression Method Matters: Benchmark-Dependent Output Dynamics in LLM Prompt Compression](https://arxiv.org/abs/2603.23527)
*Warren Johnson*
...
### [28] [Robust Multilingual Text-to-Pictogram Mapping for Scalable Reading Rehabilitation](https://arxiv.org/abs/2603.24536)
...
### [30] [MDKeyChunker: Single-Call LLM Enrichment with Rolling Keys and Key-Based Restructuring for High-Accuracy RAG](https://arxiv.org/abs/2603.23533)
*Bhavik Mangla*
...
### [31] [Not All Pretraining are Created Equal: Threshold Tuning and Class Weighting for Imbalanced Polarization Tasks in Low-Resource Settings](https://arxiv.org/abs/2603.23534)
*Abass Oguntade*
...
### [32] [Revisiting Real-Time Digging-In Effects: No Evidence from NP/Z Garden-Paths](https://arxiv.org/abs/2603.23624)
...
### [33] [Swiss-Bench SBP-002: A Frontier Model Comparison on Swiss Legal and Regulatory Tasks](https://arxiv.org/abs/2603.23646)
*Fatih Uenal*
...
### [34] [Ethio-ASR: Joint Multilingual Speech Recognition and Language Identification for Ethiopian Languages](https://arxiv.org/abs/2603.23654)
...
### [35] [Probing Ethical Framework Representations in Large Language Models: Structure, Entanglement, and Methodological Challenges](https://arxiv.org/abs/2603.23659)
...
### [36] [PLACID: Privacy-preserving Large language models for Acronym Clinical Inference and Disambiguation](https://arxiv.org/abs/2603.23678)
...
### [37] [The Diminishing Returns of Early-Exit Decoding in Modern LLMs](https://arxiv.org/abs/2603.23701)
...
### [39] [Infrequent Child-Directed Speech Is Bursty and May Draw Infant Vocalizations](https://arxiv.org/abs/2603.23797)
...
### [40] [Perturbation: A simple and efficient adversarial tracer for representation learning in language models](https://arxiv.org/abs/2603.23821)
...
### [41] [PoliticsBench: Benchmarking Political Values in Large Language Models with Multi-Turn Roleplay](https://arxiv.org/abs/2603.23841)
...
### [42] [Language Model Planners do not Scale, but do Formalizers?](https://arxiv.org/abs/2603.23844)
...
### [50] [CoCR-RAG: Enhancing Retrieval-Augmented Generation in Web Q&A via Concept-oriented Context Reconstruction](https://arxiv.org/abs/2603.23989)
...
### [51] [Sparse Growing Transformer: Training-Time Sparse Depth Allocation via Progressive Attention Looping](https://arxiv.org/abs/2603.23998)
...
### [52] [Thinking with Tables: Enhancing Multi-Modal Tabular Understanding via Neuro-Symbolic Reasoning](https://arxiv.org/abs/2603.24004)
...
### [53] [CVPD at QIAS 2026: RAG-Guided LLM Reasoning for Al-Mawarith Share Computation and Heir Allocation](https://arxiv.org/abs/2603.24012)
...
### [54] [Schema on the Inside: A Two-Phase Fine-Tuning Method for High-Efficiency Text-to-SQL at Scale](https://arxiv.org/abs/2603.24023)
...
### [55] [From Oracle to Noisy Context: Mitigating Contextual Exposure Bias in Speech-LLMs](https://arxiv.org/abs/2603.24034)
...
### [56] [FinToolSyn: A forward synthesis Framework for Financial Tool-Use Dialogue Data with Dynamic Tool Retrieval](https://arxiv.org/abs/2603.24051)
...
### [57] [ConceptKT: A Benchmark for Concept-Level Deficiency Prediction in Knowledge Tracing](https://arxiv.org/abs/2603.24073)
...
### [58] [LLMpedia: A Transparent Framework to Materialize an LLM's Encyclopedic Knowledge at Scale](https://arxiv.org/abs/2603.24080)
...
### [60] [MedAidDialog: A Multilingual Multi-Turn Medical Dialogue Dataset for Accessible Healthcare](https://arxiv.org/abs/2603.24132)
...
### [61] [A visual observation on the geometry of UMAP projections of the difference vectors of antonym and synonym word pair embeddings](https://arxiv.org/abs/2603.24150)
*Rami Luisto*
...
### [62] [Variation is the Norm: Embracing Sociolinguistics in NLP](https://arxiv.org/abs/2603.24222)
...
### [70] [PINGALA: Prosody-Aware Decoding for Sanskrit Poetry Generation](https://arxiv.org/abs/2603.24413)
...
### [71] [Mechanic: Sorrifier-Driven Formal Decomposition Workflow for Automated Theorem Proving](https://arxiv.org/abs/2603.24465)
...
### [72] [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](https://arxiv.org/abs/2603.24472)
...
### [73] [A Sociolinguistic Analysis of Automatic Speech Recognition Bias in Newcastle English](https://arxiv.org/abs/2603.24549)
...
### [75] [How are AI agents used? Evidence from 177,000 MCP tools](https://arxiv.org/abs/2603.23802)
*Merlin Stein*
...
### [76] [Generative AI User Experience: Developing Human--AI Epistemic Partnership](https://arxiv.org/abs/2603.23863)
*Xiaoming Zhai*
...
### [77] [From Untamed Black Box to Interpretable Pedagogical Orchestration: The Ensemble of Specialized LLMs Architecture for Adaptive Tutoring](https://arxiv.org/abs/2603.23990)
*Nizam Kadir*
...
### [78] [Integrating Mental Health, Well-Being, and Sustainability into Software Engineering Education](https://arxiv.org/abs/2603.24191)
...
### [79] [The First Generation of AI-Assisted Programming Learners: Gendered Patterns in Critical Thinking and AI Ethics of German Secondary School Students](https://arxiv.org/abs/2603.24197)
*Isabella Graßl*
...
### [80] [Usability Evaluation and Improvement of a Tool for Self-Service Learning Analytics](https://arxiv.org/abs/2603.24321)
...
### [81] [Generative Artificial Intelligence and the Knowledge Gap: Toward a New Form of Informational Inequality](https://arxiv.org/abs/2603.24335)
*Raphael Morisco*
...
### [82] [The enrichment paradox: critical capability thresholds and irreversible dependency in human-AI symbiosis](https://arxiv.org/abs/2603.24391)
...
### [83] [Real Talk, Virtual Faces: A Formal Concept Analysis of Personality and Sentiment in Influencer Audiences](https://arxiv.org/abs/2603.24410)
...
### [84] [Supporting Music Education through Visualizations of MIDI Recordings](https://arxiv.org/abs/2603.23631)
...
### [85] [Augmented Reality Visualization for Musical Instrument Learning](https://arxiv.org/abs/2603.23639)
*Frank Heyen,Michael Sedlmair*
...
### [86] [Assessment Design in the AI Era: A Method for Identifying Items Functioning Differentially for Humans and Chatbots](https://arxiv.org/abs/2603.23682)
...
### [87] [Exploring Self-Tracking Practices of Older Adults with CVD to Inform the Design of LLM-Enabled Health Data Sensemaking](https://arxiv.org/abs/2603.23733)
...
### [88] [AI Fortune-Teller: Juxtaposing Shaman and AI to Reveal Human Agency in the Age of AI](https://arxiv.org/abs/2603.23811)
...
### [89] [A Reproducible Reality-to-VR Pipeline for Ecologically Valid Aging-in-Place Research](https://arxiv.org/abs/2603.23812)
...
### [90] [Aesthetics of Robot-Mediated Applied Drama: A Case Study on REMind](https://arxiv.org/abs/2603.23816)
...
### [91] [CodeExemplar: Example-Based Scaffolding for Introductory Programming in the GenAI Era](https://arxiv.org/abs/2603.23830)
...
### [92] [General Intellectual Humility Is Malleable Through AI-Mediated Reflective Dialogue](https://arxiv.org/abs/2603.23855)
...
### [93] [Skewed Dual Normal Distribution Model: Predicting Touch Pointing Success Rates for Targets Near Screen Edges and Corners](https://arxiv.org/abs/2603.23865)
...
### [94] [Human Factors in Detecting AI-Generated Portraits: Age, Sex, Device, and Confidence](https://arxiv.org/abs/2603.24048)
...
### [95] [Honey, I shrunk the scientist -- Evaluating 2D, 3D, and VR interfaces for navigating samples under the microscope](https://arxiv.org/abs/2603.24337)
...
### [96] [A Neuro-Symbolic System for Interpretable Multimodal Physiological Signals Integration in Human Fatigue Detection](https://arxiv.org/abs/2603.24358)
...
### [97] [Integrating Causal Machine Learning into Clinical Decision Support Systems: Insights from Literature and Practice](https://arxiv.org/abs/2603.24448)
...
### [98] [Vibe Coding XR: Accelerating AI + XR Prototyping with XR Blocks and Gemini](https://arxiv.org/abs/2603.24591)
...
### [99] [Concurrent Streaming, Viewer Transfers, and Audience Loyalty in a Creator Ecosystem: A Minute-Level Longitudinal Study](https://arxiv.org/abs/2603.23773)
*Maxwell Shepherd*
...
### [100] [Human, AI, and Hybrid Ensembles for Detection of Adaptive, RL-based Social Bots](https://arxiv.org/abs/2603.23796)
...
### [101] [ProcureGym: A Multi-Agent Markov Game Framework for Modeling National Volume-based Drug Procurement](https://arxiv.org/abs/2603.23880)
