...
### [8] [Investigating first-language bias in LLM-based automated essay scoring: A cross-prompt evaluation of an open-weight AI-model on TOEFL essays](https://arxiv.org/abs/2607.14605)
*John Maurice Gayed*
...
### [10] [Grokipedia vs Wikipedia: An LLM-Based Audit of Political Neutrality along Ideologies](https://arxiv.org/abs/2607.15146)
...
### [12] [The Misclassification of Autistic Writing as AI-Generated](https://arxiv.org/abs/2607.14729)
...
### [13] [Eta Given Delta: Defining LLM Tool Efficiency With Marginal Tool Utility](https://arxiv.org/abs/2607.14108)
*Nyx Iskandar*
...
### [14] [Simplicity Paradox: Debunking myths about prompting and datasets for LLM evaluation](https://arxiv.org/abs/2607.14109)
...
### [15] [MAPS: Modeling Co-Existing Subjective Perspectives and Shared Meaning in Multi-Agent Cognitive Dialogue](https://arxiv.org/abs/2607.14110)
...
### [16] [Introspection Fine-Tuning (IFT): Training Small LLMs to Introspect](https://arxiv.org/abs/2607.14111)
...
### [17] [Information-Theoretic Limits of Reliability and Scaling in Language Models](https://arxiv.org/abs/2607.14112)
*Subhabrata Majumdar*
...
### [18] [T5-CSBoost: Adversarial Perturbation Resistant LLM Fingerprinting](https://arxiv.org/abs/2607.14113)
...
### [19] [CoEvoT: Co-Evolving Chain-of-Thought Prompting for Graph-LLM Reasoning](https://arxiv.org/abs/2607.14114)
...
### [20] [ReportMedSAM: Guiding Segmentation Through Radiology Reports](https://arxiv.org/abs/2607.14116)
...
### [21] [Heterogeneous Element-Aware Cross-Version Differencing of Scientific Documents via Layout-Aware Alignment and Structure-Aware Reasoning](https://arxiv.org/abs/2607.14117)
...
### [22] [Budgeted Subset Refinement for Execution-Aware LLM Research Ideation](https://arxiv.org/abs/2607.14118)
*Micah Zhang*
...
### [24] [Cross-Dataset Generalization in Urdu Fake News Detection: An Empirical Study with XLM-RoBERTa and a Length Confound Analysis](https://arxiv.org/abs/2607.14131)
...
### [25] [Breaking Refusal in the First Half: A Mechanistic Study of the Prefill Jailbreak](https://arxiv.org/abs/2607.14147)
*Alex Kwon*
...
### [26] [Implicit Reasoning Steering via Concept Chaining](https://arxiv.org/abs/2607.14242)
...
### [29] [PReM: Learning What to Preserve and When to Refresh for Context Compression](https://arxiv.org/abs/2607.14327)
...
### [30] [HABIB_TAZ at SemEval-2026 Task 11: Disentangling Formal Logic from Content via Synthetic Training and Multi-Objective Optimization](https://arxiv.org/abs/2607.14349)
...
### [31] [MamaBench: Benchmarking LLM Robustness in Maternal and Child Health Diagnosis through Counterfactual Clinical Perturbation](https://arxiv.org/abs/2607.14385)
...
### [32] [DS@GT ARC at LongEval: Citation Integrity and Factual Grounding in Scientific QA](https://arxiv.org/abs/2607.14400)
...
### [33] [Smarter and Cheaper at Once: Byte-Exact KV-Cache Grafting Turns a Frozen Small Model into a Verified-Knowledge Flywheel](https://arxiv.org/abs/2607.14431)
*Sietse Schelpe*
...
### [34] [LLM Evaluators are Biased across Languages](https://arxiv.org/abs/2607.14480)
...
### [35] [Controlled Reformulation Testing for Logical Consistency in Large Language Models](https://arxiv.org/abs/2607.14528)
...
### [36] [CityLLM: A framework for natural-language querying of semantic 3D city models](https://arxiv.org/abs/2607.14542)
...
### [37] [Answer-Conditioned Chains of Thought Degrade Verifiable-Reasoning Distillation in Large Language Models](https://arxiv.org/abs/2607.14552)
...
### [38] [MARS: Multi-hop Adaptive Retrieval and SPARQL Generation for KGQA](https://arxiv.org/abs/2607.14561)
...
### [39] [How Well Does AI-Generated Feedback Work? Intrinsic and Extrinsic Evaluation across more than 20,000 EFL Essay Drafts](https://arxiv.org/abs/2607.14591)
...
### [62] ["Trust Junk" Leads to Unjustified Support for Highly Discriminatory Predictive Models](https://arxiv.org/abs/2607.14152)
...
### [63] [From Product-Centred Retrieval to Experience-Led Commerce:Twelve Candidate Design Principles for Fashion E-Commerce User Experience](https://arxiv.org/abs/2607.14429)
...
### [64] [Not Just Pockets: Understanding Phone-Carrying Behaviors of Wheelchair Users for Mobile Context-Awareness](https://arxiv.org/abs/2607.14437)
...
### [65] [Skeleton: Visual Authoring of Non-visual Data Experiences](https://arxiv.org/abs/2607.14579)
...
### [66] [Conversational Tactile Data Interfaces: Co-Designing Accessible Data Experiences with Blind Users Using Refreshable Tactile Displays and Conversational AI](https://arxiv.org/abs/2607.14588)
...
### [67] [Memory-Driven Self-Disclosure and Relational Turning Points: A Longitudinal Multimodal Study of Human-AI Interaction](https://arxiv.org/abs/2607.14593)
...
### [68] [Dendrite: A Real-Time Python Application for Online Brain-Computer Interface Research and Development](https://arxiv.org/abs/2607.14655)
...
### [69] [Understanding of Task-specific and Subject-specific Components in Surface EMG](https://arxiv.org/abs/2607.14744)
...
### [70] [Authoring Narrative Visualization in Motion: Visual Storytelling in Swimming Videos](https://arxiv.org/abs/2607.14924)
...
### [71] [When AI Blurs the Boundaries of Contribution: An Empirical Study of Authorship Calibration](https://arxiv.org/abs/2607.15006)
...
### [72] [Unsafe at any AUC: Unlearned Lessons from Sociotechnical Disasters for Responsible AI](https://arxiv.org/abs/2607.14353)
...
### [73] [Do Generative AI Assistants Respect robots.txt? Tracing Web Access Beyond Visible Answers](https://arxiv.org/abs/2607.14447)
...
### [74] [BioTIER: A Refusal Benchmark for Targeted Biological Risk Mitigation](https://arxiv.org/abs/2607.14479)
...
### [75] [Probabilistic "Copies" in Generative AI Models](https://arxiv.org/abs/2607.14532)
...
### [76] [Penny: Transition Network Analysis of Learner-Chatbot Interactions in Scaffolded EFL Writing](https://arxiv.org/abs/2607.14575)
...
### [77] [SCITUS: A Multi-Jurisdictional Framework for Adapting NIST AI RMF to the Canadian Regulatory Context](https://arxiv.org/abs/2607.15051)
*Mohammad Etemad*
...
### [78] [Platform Choice, Trust, and Privacy in the Consumer AI Assistant Market](https://arxiv.org/abs/2607.15134)
*Jennifer Zou*
...
### [79] [Majority Correctness in Social Networks: From Well-Mixed Electorates to Complex Networks](https://arxiv.org/abs/2607.14288)
...
### [80] [Prices, Probabilities, and Parlays: Systematic Bias in Sports Prediction Markets](https://arxiv.org/abs/2607.14430)
*Niusha Moshrefi*
...
### [81] [Manufactured Divisiveness: Decomposing the Hostile Content of Seven Social Media Influence Operations](https://arxiv.org/abs/2607.14491)
*Emilio Ferrara*
...
### [82] [Overlapping Network Community Detection Using Sparse Backbones](https://arxiv.org/abs/2607.14531)
...
### [83] [All Polarized but Still Different: a Multi-factorial Metric to Discriminate between Polarization Behaviors on Social Media](https://arxiv.org/abs/2312.04603)
