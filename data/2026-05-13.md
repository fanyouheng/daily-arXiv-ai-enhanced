...
### [1] [Large Language Models for Causal Relations Extraction in Social Media: A Validation Framework for Disaster Intelligence](https://arxiv.org/abs/2605.11348)
...
### [2] [Sampling More, Getting Less: Calibration is the Diversity Bottleneck in LLMs](https://arxiv.org/abs/2605.11128)
...
### [3] [Latent Causal Void: Explicit Missing-Context Reconstruction for Misinformation Detection](https://arxiv.org/abs/2605.12156)
...
### [9] [ReVision: Scaling Computer-Use Agents via Temporal Visual Redundancy Reduction](https://arxiv.org/abs/2605.11212)
...
### [10] [RETUYT-INCO at BEA 2026 Shared Task 2: Meta-prompting in Rubric-based Scoring for German](https://arxiv.org/abs/2605.11242)
...
### [11] [Metaphor Is Not All Attention Needs](https://arxiv.org/abs/2605.12128)
...
### [12] [Predicting Disagreement with Human Raters in LLM-as-a-Judge Difficulty Assessment without Using Generation-Time Probability Signals](https://arxiv.org/abs/2605.12422)
*Yo Ehara*
...
### [13] [ReAD: Reinforcement-Guided Capability Distillation for Large Language Models](https://arxiv.org/abs/2605.11290)
...
### [14] [The Algorithmic Caricature: Auditing LLM-Generated Political Discourse Across Crisis Events](https://arxiv.org/abs/2605.12452)
...
### [15] [Predicting Psychological Well-Being from Spontaneous Speech using LLMs](https://arxiv.org/abs/2605.11303)
...
### [17] [An Empirical Study of Automating Agent Evaluation](https://arxiv.org/abs/2605.11378)
...
### [31] [When Emotion Becomes Trigger: Emotion-style dynamic Backdoor Attack Parasitising Large Language Models](https://arxiv.org/abs/2605.11612)
...
### [33] [Enhancing Multilingual Counterfactual Generation through Alignment-as-Preference Optimization](https://arxiv.org/abs/2605.11632)
...
### [34] [Human-Grounded Multimodal Benchmark with 900K-Scale Aggregated Student Response Distributions from Japan's National Assessment of Academic Ability](https://arxiv.org/abs/2605.11663)
...
### [35] [Robust LLM Unlearning Against Relearning Attacks: The Minor Components in Representations Matter](https://arxiv.org/abs/2605.11685)
...
### [36] [Learning to Foresee: Unveiling the Unlocking Efficiency of On-Policy Distillation](https://arxiv.org/abs/2605.11739)
...
### [37] [Training-Inference Consistent Segmented Execution for Long-Context LLMs](https://arxiv.org/abs/2605.11744)
...
### [38] [Safety-Oriented Evaluation of Language Understanding Systems for Air Traffic Control](https://arxiv.org/abs/2605.11769)
...
### [39] [From Token to Token Pair: Efficient Prompt Compression for Large Language Models in Clinical Prediction](https://arxiv.org/abs/2605.11774)
...
### [40] [Choosing features for classifying multiword expressions](https://arxiv.org/abs/2605.11779)
*Eric Laporte*
...
### [41] [Probabilistic Calibration Is a Trainable Capability in Language Models](https://arxiv.org/abs/2605.11845)
...
### [42] [Self-Distilled Trajectory-Aware Boltzmann Modeling: Bridging the Training-Inference Discrepancy in Diffusion Language Models](https://arxiv.org/abs/2605.11854)
...
### [43] [Concordance Comparison as a Means of Assembling Local Grammars](https://arxiv.org/abs/2605.11862)
...
### [44] [Qwen-Scope: Turning Sparse Features into Development Tools for Large Language Models](https://arxiv.org/abs/2605.11887)
...
### [48] [Learning Agentic Policy from Action Guidance](https://arxiv.org/abs/2605.12004)
...
### [49] [SAGE: Scalable Automated Robustness Augmentation for LLM Knowledge Evaluation](https://arxiv.org/abs/2605.12022)
...
### [50] [Caraman at SemEval-2026 Task 8: Three-Stage Multi-Turn Retrieval with Query Rewriting, Hybrid Search, and Cross-Encoder Reranking](https://arxiv.org/abs/2605.12028)
...
### [51] [SkillGraph: Skill-Augmented Reinforcement Learning for Agents via Evolving Skill Graphs](https://arxiv.org/abs/2605.12039)
...
### [52] [Is Child-Directed Language Optimized for Word Learning? A Computational Study of Verb Meaning Acquisition](https://arxiv.org/abs/2605.12047)
...
### [53] [Do Language Models Encode Knowledge of Linguistic Constraint Violations?](https://arxiv.org/abs/2605.12055)
...
### [54] [Sign Language Recognition and Translation for Low-Resource Languages: Challenges and Pathways Forward](https://arxiv.org/abs/2605.12096)
...
### [55] [Correcting Selection Bias in Sparse User Feedback for Large Language Model Quality Estimation: A Multi-Agent Hierarchical Bayesian Approach](https://arxiv.org/abs/2605.12177)
...
### [56] [Mitigating Context-Memory Conflicts in LLMs through Dynamic Cognitive Reconciliation Decoding](https://arxiv.org/abs/2605.12185)
...
### [57] [Mechanistic Interpretability of ASR models using Sparse Autoencoders](https://arxiv.org/abs/2605.12225)
...
### [58] [Combining On-Policy Optimization and Distillation for Long-Context Reasoning in Large Language Models](https://arxiv.org/abs/2605.12227)
...
### [59] [Mind the Pause: Disfluency-Aware Objective Tuning for Multilingual Speech Correction with LLMs](https://arxiv.org/abs/2605.12242)
...
### [60] [PreScam: A Benchmark for Predicting Scam Progression from Early Conversations](https://arxiv.org/abs/2605.12243)
...
### [61] [What makes a word hard to learn? Modeling L1 influence on English vocabulary difficulty](https://arxiv.org/abs/2605.12281)
...
### [62] [TokenRatio: Principled Token-Level Preference Optimization via Ratio Matching](https://arxiv.org/abs/2605.12288)
...
### [63] [GKnow: Measuring the Entanglement of Gender Bias and Factual Gender](https://arxiv.org/abs/2605.12299)
...
### [64] [Overview of the MedHopQA track at BioCreative IX: track description, participation and evaluation of systems for multi-hop medical question answering](https://arxiv.org/abs/2605.12313)
...
### [65] [Output Composability of QLoRA PEFT Modules for Plug-and-Play Attribute-Controlled Text Generation](https://arxiv.org/abs/2605.12345)
...
### [66] [MedHopQA: A Disease-Centered Multi-Hop Reasoning Benchmark and Evaluation Framework for LLM-Based Biomedical Question Answering](https://arxiv.org/abs/2605.12361)
...
### [67] [Context Convergence Improves Answering Inferential Questions](https://arxiv.org/abs/2605.12370)
...
### [68] [Pretraining Exposure Explains Popularity Judgments in Large Language Models](https://arxiv.org/abs/2605.12382)
*Jamshid Mozafari,Bhawna Piryani,Adam Jatowt*
...
### [69] [Scalable Token-Level Hallucination Detection in Large Language Models](https://arxiv.org/abs/2605.12384)
...
### [70] [A Comparative Study of Controlled Text Generation Systems Using Level-Playing-Field Evaluation Principles](https://arxiv.org/abs/2605.12395)
*Michela Lorandi,Anya Belz*
...
### [71] [Question Difficulty Estimation for Large Language Models via Answer Plausibility Scoring](https://arxiv.org/abs/2605.12398)
*Jamshid Mozafari,Bhawna Piryani,Adam Jatowt*
...
### [72] [Stories in Space: In-Context Learning Trajectories in Conceptual Belief Space](https://arxiv.org/abs/2605.12412)
...
### [73] [ORBIT: Preserving Foundational Language Capabilities in GenRetrieval via Origin-Regulated Merging](https://arxiv.org/abs/2605.12419)
...
### [74] [Geometric Factual Recall in Transformers](https://arxiv.org/abs/2605.12426)
...
### [75] [A Causal Language Modeling Detour Improves Encoder Continued Pretraining](https://arxiv.org/abs/2605.12438)
...
### [78] [Conversational Customization of Productivity Systems: A Design Probe of Malleable AI Interfaces](https://arxiv.org/abs/2605.11149)
...
### [79] [Making Abstraction Concrete: A Design Space and Interaction Model of Abstraction in Interactive Systems](https://arxiv.org/abs/2605.11344)
...
### [80] [Modelling Expert Cognition Beyond Behaviour: towardss Interpretation, Tension, and Value Structures](https://arxiv.org/abs/2605.11393)
*Annie Yuan*
...
### [81] [Hedwig: Dynamic Autonomy for Coding Agents Under Local Oversight](https://arxiv.org/abs/2605.11495)
...
### [82] [UNIPO: Unified Interactive Visual Explanation for RL Fine-Tuning Policy Optimization](https://arxiv.org/abs/2605.11549)
...
### [83] [A Generative AI Driven Interactive Narrative Serious Fame for Stress Relief and Its Randomized Controlled Pilot Study](https://arxiv.org/abs/2605.11562)
*Ting-Chen Hsu*
...
### [84] [A Cross-Cultural Analysis of Animated Representations of Emotions for Wearable Interfaces](https://arxiv.org/abs/2605.11668)
...
### [85] [Psychological Benefits and Costs of Diversifying Algorithmic Recourse](https://arxiv.org/abs/2605.11793)
...
### [86] [Ink Spiral: Symbolic Transformation from The Thinker to the Four Gentlemen](https://arxiv.org/abs/2605.11816)
...
### [87] [COSMIC 1001: Engaging Future Speculation on Space Exploration with Generative AI](https://arxiv.org/abs/2605.11827)
...
### [88] [RoboBlockly Studio: Conversational Block Programming with Embodied Robot Feedback for Computational Thinking](https://arxiv.org/abs/2605.12059)
...
### [89] [From Model Uncertainty to Human Attention: Localization-Aware Visual Cues for Scalable Annotation Review](https://arxiv.org/abs/2605.12303)
...
### [90] [Journalists, media and influencers: An analysis of the conversation in the digital public sphere during the Qatar 2022 World Cup](https://arxiv.org/abs/2605.11331)
...
### [91] [Fuzzy k-anonymity in complex networks](https://arxiv.org/abs/2605.12062)
...
### [92] [NPAP: Network Partitioning and Aggregation Package for Python](https://arxiv.org/abs/2605.12137)
