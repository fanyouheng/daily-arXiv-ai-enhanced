...
### [12] [When Evidence Conflicts: Uncertainty and Order Effects in Retrieval-Augmented Biomedical Question Answering](https://arxiv.org/abs/2605.14115)
...
### [13] [Generative Floor Plan Design with LLMs via Reinforcement Learning with Verifiable Rewards](https://arxiv.org/abs/2605.14117)
...
### [14] [AI Knows When It's Being Watched: Functional Strategic Action and Contextual Register Modulation in Large Language Models](https://arxiv.org/abs/2605.15034)
...
### [15] [Polar probe linearly decodes semantic structures from LLMs](https://arxiv.org/abs/2605.14125)
...
### [16] [BOOKMARKS: Efficient Active Storyline Memory for Role-playing](https://arxiv.org/abs/2605.14169)
...
### [17] [Why Retrieval-Augmented Generation Fails: A Graph Perspective](https://arxiv.org/abs/2605.14192)
...
### [18] [GradShield: Alignment Preserving Finetuning](https://arxiv.org/abs/2605.14194)
...
### [19] [What Makes Words Hard? Sakura at BEA 2026 Shared Task on Vocabulary Difficulty Prediction](https://arxiv.org/abs/2605.14257)
...
### [38] [Video2GUI: Synthesizing Large-Scale Interaction Trajectories for Generalized GUI Agent Pretraining](https://arxiv.org/abs/2605.14747)
...
### [39] [Non-linear Interventions on Large Language Models](https://arxiv.org/abs/2605.14749)
*Sangwoo Kim*
...
### [40] [Streaming Speech-to-Text Translation with a SpeechLLM](https://arxiv.org/abs/2605.14766)
...
### [41] [Graphs of Research: Citation Evolution Graphs as Supervision for Research Idea Generation](https://arxiv.org/abs/2605.14790)
...
### [42] [Conversion of Lexicon-Grammar tables to LMF. Application to French](https://arxiv.org/abs/2605.14816)
...
### [43] [Tokenizer Fertility and Zero-Shot Performance of Foundation Models on Ukrainian Legal Text: A Comparative Study](https://arxiv.org/abs/2605.14890)
*Volodymyr Ovcharov*
...
### [44] [Chain-of-Procedure: Hierarchical Visual-Language Reasoning for Procedural QA](https://arxiv.org/abs/2605.14928)
...
### [45] [Performance-Driven Policy Optimization for Speculative Decoding with Adaptive Windowing](https://arxiv.org/abs/2605.14978)
*Jie Jiang,Xing Sun*
...
### [46] [Quantifying and Mitigating Premature Closure in Frontier LLMs](https://arxiv.org/abs/2605.15000)
...
### [47] [The Scientific Contribution Graph: Automated Literature-based Technological Roadmapping at Scale](https://arxiv.org/abs/2605.15011)
*Peter A. Jansen*
...
### [48] [COTCAgent: Preventive Consultation via Probabilistic Chain-of-Thought Completion](https://arxiv.org/abs/2605.15016)
...
### [49] [From Scenes to Elements: Multi-Granularity Evidence Retrieval for Verifiable Multimodal RAG](https://arxiv.org/abs/2605.15019)
...
### [57] [AI Alignment Amplifies the Role of Race, Gender, and Disability in Hiring Decisions](https://arxiv.org/abs/2605.13866)
...
### [58] [Modeling AI-TPACK in Practice Insights from Teachers Multi-Agent Workflow Design](https://arxiv.org/abs/2605.13906)
...
### [59] [Measuring Google AI Overviews: Activation, Source Quality, Claim Fidelity, and Publisher Impact](https://arxiv.org/abs/2605.14021)
...
### [60] [Synthetic Sociality: How Generative Models Privatize the Social Fabric](https://arxiv.org/abs/2605.14090)
...
### [61] [Computational Thinking Development in AI Agent Creation_A Mixed-Methods Study](https://arxiv.org/abs/2605.14330)
...
### [62] [The Racial Character of Computer Graphics Research](https://arxiv.org/abs/2605.14835)
...
### [63] [Tradeoffs are Domain Dependent: Improving Accuracy and Fairness in Property Tax Assessments](https://arxiv.org/abs/2605.15020)
...
### [64] [Due Process on Hold: A Queueing Framework for Improving Access in SNAP](https://arxiv.org/abs/2605.15165)
...
### [65] [The Moltbook Observatory Archive: an incremental dataset of agent-only social network activity](https://arxiv.org/abs/2605.13860)
...
### [66] [Spectral Analysis of Fake News Propagation](https://arxiv.org/abs/2605.13861)
...
### [67] [Betweenness Central Nodes Under Uncertainty: An Absorbing Markov Chain Approach](https://arxiv.org/abs/2605.14743)
...
### [68] [Static and Dynamic Strategies for Influencing Opinions in Social Networks](https://arxiv.org/abs/2605.14918)
...
### [69] [On the Limits of PAC Learning of Networks from Opinion Dynamics](https://arxiv.org/abs/2605.15033)
...
### [70] [Real-Time Group Dynamics with LLM Facilitation: Evidence from a Charity Allocation Task](https://arxiv.org/abs/2605.14097)
...
### [71] [Pluot: Towards 'write once, run everywhere' visualization software](https://arxiv.org/abs/2605.14118)
...
### [72] [What Should Explanations Contain? A Human-Centered Explanation Content Model for Local, Post-Hoc Explanations](https://arxiv.org/abs/2605.14207)
*Helmut Degen*
...
### [73] [Self-Regulated Learning in Essay Writing: Consistency of Strategies and Impact on Outcomes](https://arxiv.org/abs/2605.14228)
...
### [74] [A Formative Study of Brief Affective Text as a Complement to Wearable Sensing for Longitudinal Student Health Monitoring](https://arxiv.org/abs/2605.14360)
...
### [75] [SmartWalkCoach: An AI Companion for End-to-End Walking Guidance, Motivation, and Reflection](https://arxiv.org/abs/2605.14628)
...
### [76] [Agentic AI and Human-in-the-Loop Interventions: Field Experimental Evidence from Alibaba's Customer Service Operations](https://arxiv.org/abs/2605.14830)
...
### [77] [Beliefs and Misconceptions around Integrated Conversational AI](https://arxiv.org/abs/2605.14849)
...
### [78] [Towards Gaze-Informed AI Disclosure Interfaces: Eye-Tracking Attentional and Cognitive Load While Reading AI-Assisted News](https://arxiv.org/abs/2605.14999)
...
### [79] [Deceptive Cookies: Consent by Design -- A Mixed Methods Study](https://arxiv.org/abs/2605.15056)
...
### [80] [After the Interface: Relocating Human Agency in the Age of Conversational AI](https://arxiv.org/abs/2605.15064)
*Mengke Wu,Mike Yao*
...
### [81] [Usable but Conventional: An Empirical Study on the UX of AI-Generated Interface Prototypes](https://arxiv.org/abs/2605.15124)
...
### [82] [Understanding How International Students in the U.S. Are Using Conversational AI to Support Cross-Cultural Adaptation](https://arxiv.org/abs/2605.15127)
