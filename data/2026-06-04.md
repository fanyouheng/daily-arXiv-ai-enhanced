...
### [11] [Long Live Fine-Tuning: Task-Specific Transformers Outperform Zero-Shot LLMs for Misinformation Response Classification on Reddit](https://arxiv.org/abs/2606.04274)
...
### [13] [Listening to the Workforce: Measuring Construction Worker Safety Attitudes from Social Media Discourse Using LLMs](https://arxiv.org/abs/2606.04450)
...
### [15] [GlossAssist -- A Tool to Simplify Corpus Creation and Study the Effect of NLP Models in Low-Resource Documentation Settings](https://arxiv.org/abs/2606.04367)
...
### [16] [Probing Outcome-Level Resemblance and Mechanism-Level Alignment in LLM Risk Decisions: Evidence from the St. Petersburg Game](https://arxiv.org/abs/2606.04978)
...
### [18] [DeliChess: A Multi-party Dialogue Dataset for Deliberation in Chess Puzzle Solving](https://arxiv.org/abs/2606.04987)
...
### [19] [LazyAttention: Efficient Retrieval-Augmented Generation with Deferred Positional Encoding](https://arxiv.org/abs/2606.04302)
...
### [20] [Arithmetic Pedagogy for Language Models](https://arxiv.org/abs/2606.05106)
...
### [21] [Parameter-Efficient Fine-Tuning with Learnable Rank](https://arxiv.org/abs/2606.04325)
...
### [22] [Noisy memory encoding explains negative polarity illusions](https://arxiv.org/abs/2606.04340)
...
### [23] [Deliberate Evolution: Agentic Reasoning for Sample-Efficient Symbolic Regression with LLMs](https://arxiv.org/abs/2606.04360)
...
### [24] [DLLG: Dynamic Logit-Level Gating of LLM Experts](https://arxiv.org/abs/2606.04378)
...
### [25] [When Clients Stop Following: A Cognitive Conceptualization Diagram-driven Framework for Strategic Counseling](https://arxiv.org/abs/2606.04389)
...
### [40] [Cartridges at Scale: Training Modular KV Caches over Large Document Collections](https://arxiv.org/abs/2606.04557)
...
### [46] [CYGNET: Cypher Gate for Neural Execution Triage and Cost Containment](https://arxiv.org/abs/2606.04645)
*Nikodem Tomczak*
...
### [47] [QO-Bench: Diagnosing Query-Operator-Preserving Retrieval over Typed Event Tuples](https://arxiv.org/abs/2606.04646)
...
### [48] [LifeSide: Benchmarking Agents as Lifelong Digital Companions](https://arxiv.org/abs/2606.04660)
...
### [49] [CRAFT: Cost-aware Refinement And Front-aware Tuning of Prompts](https://arxiv.org/abs/2606.04661)
...
### [50] [SMADE-IE: Sparse Multi-Agent Framework with Evidence-Driven Debate for Zero-Shot Information Extraction](https://arxiv.org/abs/2606.04691)
...
### [51] [DuDi: Dual-Signal Distillation with Cross-Lingual Verbalizer](https://arxiv.org/abs/2606.04694)
...
### [52] [Rethinking Continual Experience Internalization for Self-Evolving LLM Agents](https://arxiv.org/abs/2606.04703)
...
### [53] [Query-based Cross-Modal Projector Bolstering Mamba Multimodal LLM](https://arxiv.org/abs/2606.04719)
...
### [54] [Multilingual Long-Form Speech Instruction Following: KIT's Submission to IWSLT 2026](https://arxiv.org/abs/2606.04730)
...
### [55] [TIDE: Proactive Multi-Problem Discovery via Template-Guided Iteration](https://arxiv.org/abs/2606.04743)
...
### [56] [PersonaTree: Structured Lifecycle Memory for Person Understanding in LLM Agents](https://arxiv.org/abs/2606.04780)
...
### [57] [A French Corpus Annotated for Multiword Expressions with Adverbial Function](https://arxiv.org/abs/2606.04828)
...
### [58] [Large Language Models in K-12 Education: Alignment with State Curriculum Standards and Student Personas](https://arxiv.org/abs/2606.04846)
...
### [61] [GRAIL: Gradient-Reweighted Advantages for Reinforcement Learning with Verifiable Rewards](https://arxiv.org/abs/2606.04889)
...
### [63] [Caliper: Probing Lexical Anchors versus Causal Structure in LLMs](https://arxiv.org/abs/2606.04915)
...
### [80] [SocialCoach: Personalized Social Skill Learning with RL-based Agentic Tutoring and Practice](https://arxiv.org/abs/2606.04155)
...
### [81] [Behavioral and Performance Indicators of Depression and Anxiety in Electronic Learning Systems](https://arxiv.org/abs/2606.04254)
...
### [82] [Creative Reading: Scaffolding Reading for Transformation](https://arxiv.org/abs/2606.04308)
...
### [83] [When Chatbots Accommodate: What AI Companions Optimize for in Vulnerable Conversations](https://arxiv.org/abs/2606.04431)
...
### [84] [Speculating the Impacts of Mediated Social Touch Technology](https://arxiv.org/abs/2606.04489)
...
### [85] [Addressing Negative Commons Governance with Positive Commons Principles](https://arxiv.org/abs/2606.04563)
...
### [86] [CapSenseBand: Sustaining Cross-Disciplinary Creativity When Stitches Must Meet Signals](https://arxiv.org/abs/2606.04609)
...
### [87] [Clinical Assistant for Remote Engagement Link (CARE-link): A Web-Based Electronic Health Records Software for Managing Diabetes](https://arxiv.org/abs/2606.04952)
...
### [88] [Stories and Systems: Educational Interactive Storytelling to Teach Media Literacy and Systemic Thinking](https://arxiv.org/abs/2508.11059)
...
### [89] [What Can Eye Gaze Teach Us About Real-World Cycling? Insights From the Oxford RobotCycle Project](https://arxiv.org/abs/2606.04989)
...
### [90] [PhysDox: Benchmarking LLMs on Physical Feasibility Auditing of Physiological Sensing Protocols](https://arxiv.org/abs/2606.05003)
...
### [91] [Scaling Expert Feedback with Reflective Edit Propagation in Compositional Knowledge Bases](https://arxiv.org/abs/2606.05023)
...
### [92] ["A Glimpse, Not a Gaze": Using Generative AI to Balance Privacy and Awareness in Inter-generational Caregiving](https://arxiv.org/abs/2606.05055)
...
### [93] [Plateau That Never Comes: When Efficiency Claims in Datacenters and AI Become Greenwashing](https://arxiv.org/abs/2606.04214)
...
### [94] [Prioritization of Risks from Artificial Intelligence: A Delphi Study of 272 International Experts](https://arxiv.org/abs/2606.04490)
...
### [95] [Agentic AI and Pedagogical Best Practice: The Tension Between Automation and Learning](https://arxiv.org/abs/2606.04543)
...
### [96] [Synthetic Personalities: How Well Can LLMs Mimic Individual Respondents Using Socio-Economic Microdata?](https://arxiv.org/abs/2606.04592)
...
### [97] [When Firms Learn to Game the Rules](https://arxiv.org/abs/2606.04617)
*Xufeng He*
...
### [98] [Dark Path: An Analysis of the Belt & Road Initiative in El Salvador](https://arxiv.org/abs/2606.04832)
...
### [99] [Does Artificial Intelligence Advance Science?](https://arxiv.org/abs/2606.05118)
...
### [100] [Network node immunization: improving Netshield algorithm through random rooted forests](https://arxiv.org/abs/2606.04131)
...
### [101] [Structural properties of the implicit function defined by an integral self-consistency equation](https://arxiv.org/abs/2606.04243)
*Ivan Viakhirev*
...
### [102] [Characterizing Online Criticism of Partisan News Media Using Weakly Supervised Learning](https://arxiv.org/abs/2606.04289)
...
### [103] [Forecasting Political News Engagement on Social Media](https://arxiv.org/abs/2606.04293)
*Karthik Shivaram,Mustafa Bilgic,Matthew Shapiro,Aron Culotta*
...
### [104] [Modeling and Interpreting Teamwork Dynamics in Cancer Care Outcome Prediction](https://arxiv.org/abs/2606.04499)
...
### [105] [Federating Governance: How Community Rules Scale with Mastodon Instances](https://arxiv.org/abs/2606.05069)
