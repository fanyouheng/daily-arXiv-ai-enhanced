...
### [13] [Negative Before Positive: Asymmetric Valence Processing in Large Language Models](https://arxiv.org/abs/2605.05653)
*Sohan Venkatesh*
...
### [14] [Who and What? Using Linguistic Features and Annotator Characteristics to Analyze Annotation Variation](https://arxiv.org/abs/2605.06318)
...
### [17] [Decomposing the Basic Abilities of Large Language Models: Mitigating Cross-Task Interference in Multi-Task Instruct-Tuning](https://arxiv.org/abs/2605.05676)
...
### [67] [From Cradle to Cloud: A Life Cycle Review of AI's Environmental Footprint](https://arxiv.org/abs/2605.05416)
...
### [72] [Breaking In and Reaching Out: Networking for Women in Computer Science](https://arxiv.org/abs/2605.06195)
*Shalini Chakraborty*
...
### [73] [A Benchmark for Strategic Auditee Gaming Under Continuous Compliance Monitoring](https://arxiv.org/abs/2605.06340)
*Florian A. D. Burnat,Brittany I. Davidson*
...
### [74] [From Review to Design: Ethical Multimodal Driver Monitoring Systems for Risk Mitigation, Incident Response, and Accountability in Automated Vehicles](https://arxiv.org/abs/2605.06439)
...
### [75] [Predicting civil litigation outcomes and the evolution of case complexity and settlement dynamics](https://arxiv.org/abs/2605.06151)
...
### [76] [Making AI Drafts Count: A Quality Threshold in Audio Description Workflows](https://arxiv.org/abs/2605.05348)
...
### [77] [Every(bot) Makes Mistakes: Coding Big Five Personalities, Context, and Tone into an LLM Chatbot Recovery Code Framework](https://arxiv.org/abs/2605.05391)
...
### [78] [Why Someone Asked "Why": Foil Inference in Human and LLM Question Interpretation](https://arxiv.org/abs/2605.05401)
...
### [79] [The Ambivalent Experience of Eye Contact for People with Visual Impairments: Mechanisms and Design Challenges](https://arxiv.org/abs/2605.05437)
...
### [80] [Cross-individual generalizability of machine learning models for ball speed prediction in baseball pitching](https://arxiv.org/abs/2605.05487)
...
### [81] [Designing with Tensions: Older Adults' Emotional Support-Seeking Under System-Level Constraints in Conversational AI](https://arxiv.org/abs/2605.05552)
...
### [82] [UX in the Age of AI: Rethinking Evaluation Metrics Through a Statistical Lens](https://arxiv.org/abs/2605.05600)
*Harish Vijayakumar*
...
### [83] [The Capacity to Care: Designing Social Technology for Sustained Engagement With Societal Challenges](https://arxiv.org/abs/2605.05651)
...
### [84] [PersonaTeaming: Supporting Persona-Driven Red-Teaming for Generative AI](https://arxiv.org/abs/2605.05682)
...
### [85] [Priming, Path-dependence, and Plasticity: Understanding the molding of user-LLM interaction and its implications from (many) chat logs in the wild](https://arxiv.org/abs/2605.05767)
...
### [86] [GazeMind: A Gaze-Guided LLM Agent for Personalized Cognitive Load Assessment](https://arxiv.org/abs/2605.05790)
...
### [87] [Can providing feedback on gaze and mental-effort synchrony improve pair programming performance?](https://arxiv.org/abs/2605.05836)
...
### [88] [I see artifacts: ICA-based EEG artifact removal does not improve deep network decoding across three BCI tasks](https://arxiv.org/abs/2605.06018)
...
### [89] [EventColumn: Integrating Event Sequences into Tabular Visualizations](https://arxiv.org/abs/2605.06065)
...
### [90] [AffectGPT-RL: Revealing Roles of Reinforcement Learning in Open-Vocabulary Emotion Recognition](https://arxiv.org/abs/2605.06126)
...
### [91] [LearnMate^2: Design and Evaluation of an LLM-powered Personalized and Adaptive Support System for Online Learning](https://arxiv.org/abs/2605.06257)
...
### [92] [LLM-Based Educational Simulation: Evaluating Temporal Student Persona Stability Across ADHD Profiles](https://arxiv.org/abs/2605.06307)
...
### [93] [Human-AI Co-Evolution and Epistemic Collapse: A Dynamical Systems Perspective](https://arxiv.org/abs/2605.06347)
...
### [94] [SIGMA-ASL: Sensor-Integrated Multimodal Dataset for Sign Language Recognition](https://arxiv.org/abs/2605.06351)
