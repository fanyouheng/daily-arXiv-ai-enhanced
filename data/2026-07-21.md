...
### [16] [Real-World Evaluation of an AI Agent Drafting Translational Impact Summaries](https://arxiv.org/abs/2607.16989)
...
### [17] [Trace-Based On-Policy Distillation for Masked Diffusion Language Models](https://arxiv.org/abs/2607.16872)
...
### [18] [Safety That Does Not Transfer: Cross-Lingual Clinical Correctness Drift in Deployable Medical Language Models](https://arxiv.org/abs/2607.17270)
...
### [19] [Learning from Synthetic Data without Model Collapse in Iterative Instruction Tuning](https://arxiv.org/abs/2607.17043)
...
### [20] [BLAD: A Historically Contextualized, Multilingual Dataset of Bangladeshi Legal Acts (1799 to 2025)](https://arxiv.org/abs/2607.17111)
*Adib Sakhawat*
...
### [21] [Scope3Trace: Evidence-Based Identification and Extraction of Scope 3 GHG Emissions from Sustainability Reports](https://arxiv.org/abs/2607.17122)
...
### [22] [KyrgyzLLM-Bench: Benchmarking Kyrgyz Language Understanding](https://arxiv.org/abs/2607.17173)
...
### [23] [Auditing Question-Order Effects in Large Language Models with the QQ Equality: Mechanism Characterization and a Saturation Caveat](https://arxiv.org/abs/2607.17219)
*Pilsung Kang*
...
### [24] [Literary Non-Style in LLM-Generated Text](https://arxiv.org/abs/2607.17228)
*Cory Massaro*
...
### [25] [Robust Summarization of Doctor-Patient Conversations: TalTech Systems for the Beyond Transcription Challenge](https://arxiv.org/abs/2607.17230)
...
### [26] [AI_LectureNote: A Retrospective Pilot Study of a Post-ASR Workflow for English-Script Rendering and Semantic Drift in Korean-English Medical Lectures](https://arxiv.org/abs/2607.17237)
...
### [27] [EvolvingWorld: An Open-Schema Framework for Co-Evolving Role-Play Agents and World Model in Interactive Literary World](https://arxiv.org/abs/2607.17250)
...
### [28] [Should Missing Modalities Always Be Necessary to Repair for Multi-modal Sentiment Analysis?](https://arxiv.org/abs/2607.17262)
...
### [29] [Debate-on-Graph: Reliable and Adaptive Reasoning of Large Language Model on Uncertain Knowledge Graph](https://arxiv.org/abs/2607.17266)
...
### [56] [Mapping the DAG-ness Landscape: Structural Archetypes in Complex Networks](https://arxiv.org/abs/2607.16464)
*Erik Csikos*
...
### [57] [Auditing Differential Visibility of Political Content on TikTok](https://arxiv.org/abs/2607.17356)
...
### [58] [Dynamical system for PageRank with a time-dependent memory](https://arxiv.org/abs/2607.17953)
...
### [59] [A Fuzzy Logic Framework for Community-Aware Crime Hotspot Detection: Prototype Application Architecture and Exploratory Validation for an Urban Computing Platform](https://arxiv.org/abs/2607.16218)
...
### [60] [MDAF: A Multi-Dimensional Annotation Framework for Automated Foreign Policy Analysis](https://arxiv.org/abs/2607.16219)
...
### [62] [Students' Perceptions of Peer Grading](https://arxiv.org/abs/2607.16221)
...
### [64] [International Agreements to Limit Frontier AI: Objectives and Exit](https://arxiv.org/abs/2607.16224)
*Lennart Finke*
...
### [65] [To Police or to Guide: How Higher Education Computer Science Instructors Design and Implement Generative AI Policies](https://arxiv.org/abs/2607.16475)
*Xingjian,Gu,Wells Lucas Santo,James M. Zumel Dumlao,Barbara Ericson*
...
### [66] [How Formerly Incarcerated People Envision Technologies for Prison Parole](https://arxiv.org/abs/2607.16513)
...
### [67] [Translating AI into scientific impact: Field context, career position, and institutional capability in AI-enabled research](https://arxiv.org/abs/2607.16780)
...
### [68] [A Method for Learning Value Systems in Generative AI](https://arxiv.org/abs/2607.16903)
...
### [69] [Who Will Become the Next Senior? How Generative AI Erodes the Development Pathway in Software Engineering](https://arxiv.org/abs/2607.17067)
...
### [70] [A study of GenAI usage by Design Students Analysis of Survey Results and Journals of AI practices at the Politecnico di Milano in 2025/2026](https://arxiv.org/abs/2607.17094)
*Stefana Broadbent*
...
### [71] [Measuring Computational Thinking Self-Efficacy (CT-SEI): Instrument development and preliminary evaluation](https://arxiv.org/abs/2607.17704)
...
### [73] [An approach to systemic risks of AI through the lens of emergence, collective action problems, and externalities](https://arxiv.org/abs/2607.18170)
...
### [74] [Algorithmic Accuracy as a Motivational Driver in Robot-Mediated Learning: A Comparative Study of Cross-Correlation and CNN-Based Sound Detection in an Interactive Quiz Game](https://arxiv.org/abs/2607.16299)
...
### [76] [Hindsight: Similarity-Based Analytics for Mars Rover Drive Retrieval](https://arxiv.org/abs/2607.16537)
...
### [77] [AlterAtlas: Shifting Travel Planning from AI Generation to Validation via Persona-Driven Simulations](https://arxiv.org/abs/2607.16565)
...
### [78] [Retrofitting Existing 3D Objects with Surface-Conforming Capacitive Sensing](https://arxiv.org/abs/2607.16739)
...
### [79] [SAVEstate: A Method for Documenting Player Reflection in Digital Games](https://arxiv.org/abs/2607.17128)
...
### [80] [Strategic Gaze: Attention Allocation and Transition Patterns Across Functional Areas of Interest by Gameplay Outcome](https://arxiv.org/abs/2607.17151)
...
### [81] [PocketPPD: Screening for Postpartum Depression Risk Using Passive Smartphone Sensing](https://arxiv.org/abs/2607.17185)
...
### [82] [TaskArtisan: Designing Composable Generative Widgets for LLM-Assisted Analysis](https://arxiv.org/abs/2607.17394)
*Meng Chen,Amy Pavel*
...
### [83] [Sidekick: Designing Communication for Effective Multitasking with Computer Use Agents](https://arxiv.org/abs/2607.17527)
...
### [84] [Human-in-the-Loop User Feedback Affects Perceived Accuracy and Trust, but Task Subjectivity Matters](https://arxiv.org/abs/2607.17548)
...
### [85] [It Matters How You Say It: Exploring Rhetorical Patterns for AI-Assisted Information Evaluation](https://arxiv.org/abs/2607.17627)
...
### [86] [Informal Learning Emerges in Everyday Human-LLM Interaction](https://arxiv.org/abs/2607.17643)
...
### [87] [I wanted it to feel more personal: Customization of social AI as AI individualism in practice](https://arxiv.org/abs/2607.17826)
...
### [88] [AlphaOracle: Oracle bone script decipherment via human-workflow-inspired deep learning](https://arxiv.org/abs/2607.17849)
