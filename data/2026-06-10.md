...
### [22] [Detecting Knowledge Gaps from Conversational AI Interactions Using Curriculum Prerequisite Graphs](https://arxiv.org/abs/2606.10736)
...
### [24] [Who Brought Easter Eggs to Eid? Auditing Cultural Translation of Math Word Problems Across Diverse Languages and Regions](https://arxiv.org/abs/2606.11009)
...
### [25] [KCSAT-ML: Probing Reasoning Models with Nationwide-Cohort Human Difficulty](https://arxiv.org/abs/2606.10403)
...
### [26] [The Shibboleth Effect: Auditing the Cross-Lingual Distributional Skew of Large Language Models](https://arxiv.org/abs/2606.11082)
*Hakan Mehmetcik*
...
### [65] [AI-Driven Analytics of Team-Teaching Talk: Acoustic Patterns across Experience, Cohorts and the Learning Design](https://arxiv.org/abs/2606.09831)
...
### [66] [Agentic Social Affordance Framework (ASAF): Agent Identity Design as a Collaboration Interface in Multi-Agent Systems](https://arxiv.org/abs/2606.09832)
*Meng-Han Lee*
...
### [67] [CollabSkill: Evaluating Human-Agent Collaboration On Real-World Tasks](https://arxiv.org/abs/2606.09833)
...
### [68] [Weather Synchronization in Digital Twin Environments for Shared VR Experience Using Commercial Metaverse Platforms](https://arxiv.org/abs/2606.09834)
...
### [69] [Thinking Inside the Box: Considerations for Putting Data Physicalization Workshops in a Box](https://arxiv.org/abs/2606.09835)
...
### [70] [Equanimity in HRI: Applying Calm Technology Principles to Human-Robot Interaction](https://arxiv.org/abs/2606.09836)
...
### [71] [Self-EmoQ: Plutchik-Guided Value-based Planning to Drive Streaming Emotional TTS](https://arxiv.org/abs/2606.09837)
...
### [72] [Popularity Without Legitimacy? Comparing Trust in Television Meteorologists and YouTube Weatherfluencers](https://arxiv.org/abs/2606.09838)
...
### [73] [Aesthetic Perspectives in Information Systems Research: A Hermeneutic Analysis](https://arxiv.org/abs/2606.09839)
...
### [74] [Envisioning Sensemaking in Multi-Human, Multi-Agent Collaborative Knowledge Work](https://arxiv.org/abs/2606.09840)
...
### [75] [Human-Centered AI for Safe Shuttle Car Routing in Underground Room-and-Pillar Coal Mines Using Graph Neural Networks](https://arxiv.org/abs/2606.09841)
*Bryant Pollard*
...
### [76] [Integrated Real-Time Motion Tracking and AI Analysis for Athletic Performance Optimization](https://arxiv.org/abs/2606.09842)
...
### [77] [An LLM-Native Psychometric Instrument Does Not Predict LLM Behavior: Evidence Across 25 Models](https://arxiv.org/abs/2606.09843)
...
### [78] [Full Disclosure, Less Trust? How the Level of Detail about AI Use in News Writing Affects Readers' Trust](https://arxiv.org/abs/2601.09620)
...
### [79] [The Interlocutor Effect: Why LLMs Leak More Personal Data to Agents Than Humans](https://arxiv.org/abs/2606.09844)
...
### [80] [More Human or More AI? Visualizing Human-AI Collaboration Disclosures in Journalistic News Production](https://arxiv.org/abs/2601.11072)
...
### [81] [Tutor, Not Solver: Designing a Guardrailed AI Assistant for Learning in Higher Education: A Design Case of PeteChat](https://arxiv.org/abs/2606.09845)
...
### [82] [Towards Gaze-Informed AI Disclosure Interfaces: Eye-Tracking Attentional and Cognitive Load While Reading AI-Assisted News](https://arxiv.org/abs/2605.14999)
...
### [83] [CANVAS: Captioning Art with Narrative Visual-Audio AI Systems](https://arxiv.org/abs/2606.09846)
*Vignesh Nagarajan*
...
### [84] [Designing Vibes in a Science Museum: from @Science to @hugging_face](https://arxiv.org/abs/2606.09847)
...
### [85] [Human-AI Coordination Zones: A Framework for Designing Human-in-the-Loop Experiences with Agentic AI](https://arxiv.org/abs/2606.09848)
...
### [86] [Sketch-to-Layout: A Human-Centric Computational Agent for Constraint-Aware Synthesis of Modular Photobioreactors](https://arxiv.org/abs/2606.09849)
...
### [87] [ECHO: Explainable Co-editing with Human-in-the-loop Operations for Presentation Refinement](https://arxiv.org/abs/2606.09851)
...
### [88] [LLM-Based Code Documentation Generation and Multi-Judge Evaluation](https://arxiv.org/abs/2606.09852)
...
### [89] [LLM-Based Visualization Evaluation: How Well Do Literacy-Stratified Personas Approximate Human Judgments?](https://arxiv.org/abs/2606.10095)
*Swaroop Panda*
...
### [90] [VArify: A Visual Analytics System for Verifying Knowledge Enhanced Large Language Model Responses in Food Science](https://arxiv.org/abs/2606.10177)
...
### [91] [Creativity in the BioFoundry: Supporting scientific creativity in the age of automation](https://arxiv.org/abs/2606.10182)
...
### [92] [Profiling cognitive offloading in LLM-mediated synthesis writing: Volume vs. content](https://arxiv.org/abs/2606.10434)
...
### [93] [Profy: Interpretable Visualization of Expertise-Dependent Motor Skills Toward Supporting Piano Practice](https://arxiv.org/abs/2606.10627)
...
### [94] [Being and Time in XR: Other-Presentness Beyond Co-Presence](https://arxiv.org/abs/2606.10786)
*Koichi Toida*
...
### [95] [A Case Study Reexamining the Cold-Start Problem in Knowledge Tracing Models and Implications for SafeInsights, an Education Research Infrastructure](https://arxiv.org/abs/2606.11004)
...
### [96] [The Empirically Grounded Adaptive Virtual Patient for Psychotherapy Training: Disclosure That Responds to Therapist Micro-Skills](https://arxiv.org/abs/2606.10051)
...
### [97] ["Where is this coming from?" Uncovering Trustworthiness Ideals in AI-powered Peripartum Information Seeking](https://arxiv.org/abs/2606.10158)
...
### [98] [AnnotateThis: Analyzing a human-LLM system for annotating social media data with the concept of climate change mitigation pessimism](https://arxiv.org/abs/2606.10210)
...
### [99] [Accounting for AI Inference in Corporate GHG Inventories: A Four-Tier Methodology for Scope 3 Category 1 Reporting](https://arxiv.org/abs/2606.10660)
*Guillermo Llopis*
...
### [100] [The Agentic Web Requires New Normative Infrastructure](https://arxiv.org/abs/2606.10711)
...
### [101] [Gender-based discrepancies in the algorithmic delivery of political ads on social media](https://arxiv.org/abs/2606.10834)
...
### [102] [From Prompt to Purchase: How AI Brand Recommendations Move Consumers on the Open Web](https://arxiv.org/abs/2606.10907)
...
### [103] [Dismantle and Dissolve, (Re)build, Remix: A Research-creation Inquiry into the Political Economy of Graphics Cards](https://arxiv.org/abs/2606.10958)
*Cyrus Khalatbari*
...
### [104] [Designed by Journalists, but Is It for Readers? Rethinking AI Disclosures and Transparency in News](https://arxiv.org/abs/2606.11116)
*Pooja Prajod*
...
### [105] [Culturally-Aware AI for Cross-Boundary Community Learning: Undergraduate Innovation at the Intersection of Computation and Design](https://arxiv.org/abs/2606.09041)
...
### [106] [Leveraging Social Media Data for COVID-19 Studies](https://arxiv.org/abs/2606.10459)
...
### [107] [From Stacks to Circuits: A Regenerative Socio-Technical Roadmap for AI Infrastructure within Planetary Boundaries](https://arxiv.org/abs/2606.10544)
...
### [108] [Platform Sorting Drives Ideological Fragmentation in the Social Media Ecosystem](https://arxiv.org/abs/2606.10575)
